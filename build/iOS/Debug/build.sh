#!/bin/bash
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.38.2/targets/ios/build.sh.
...
##else
    xcodebuild -project "com.maxted.fusetest.xcodeproj" "$@" | tee >(checkForError)
##endif
