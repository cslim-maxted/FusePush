...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/platform/$.uno
// ----------------------------------------------------------------------
...
static void Window_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof());
    ::TYPES[3] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::PointerEventArgs_typeof());
