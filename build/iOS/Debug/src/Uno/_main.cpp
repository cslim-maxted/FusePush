...
namespace g{namespace Fuse{namespace iOS{namespace Bindings{uStructType* CGFontRef_typeof();}}}}
...
namespace g{namespace Fuse{namespace Reactive{uType* EventBinding__CallClosure_typeof();}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::Fuse::iOS::Bindings::CGFontRef_typeof,
