...
// public sealed extern class ScrollView :1719
// {
...
// public ScrollView(Fuse.Controls.Native.IScrollViewHost host) :1771
void ScrollView__ctor_2_fn(ScrollView* __this, uObject* host)
{
    __this->ctor_2(host);
}

// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle) :1816
void ScrollView__Add_fn(uObject* parentHandle, uObject* childHandle)
{
    ScrollView::Add(parentHandle, childHandle);
}

// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) :1793
...
// private void Fuse.Controls.Native.IViewGroup.Add(Fuse.Controls.Native.IView child) :1721
...
// private void Fuse.Controls.Native.IViewGroup.Add(Fuse.Controls.Native.IView child, int index) :1726
void ScrollView__FuseControlsNativeIViewGroupAdd1_fn(ScrollView* __this, uObject* child, int* index)
{
    __this->Content(uCast< ::g::Fuse::Controls::Native::iOS::View*>(child, ::TYPES[1/*Fuse.Controls.Native.iOS.View*/]));
}

// private void Fuse.Controls.Native.IViewGroup.Remove(Fuse.Controls.Native.IView child) :1731
void ScrollView__FuseControlsNativeIViewGroupRemove_fn(ScrollView* __this, uObject* child)
{
    __this->Content(NULL);
}

// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) :1841
void ScrollView__GetContentOffset_fn(uObject* handle, float* x, float* y)
{
    ScrollView::GetContentOffset(handle, x, y);
}

// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) :1771
void ScrollView__New1_fn(uObject* host, ScrollView** __retval)
{
    *__retval = ScrollView::New1(host);
}

// public override sealed void NotifyChildNewSize(Fuse.Controls.Native.iOS.View child, float2 size) :1810
...
// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) :1802
...
// public void set_AllowedScrollDirections(Fuse.Controls.ScrollDirections value) [instance] :1763
void ScrollView::AllowedScrollDirections(int value)
{
}

// public Fuse.Controls.Native.iOS.View get_Content() [instance] :1739
::g::Fuse::Controls::Native::iOS::View* ScrollView::Content()
{
    return _content;
}

// public void set_Content(Fuse.Controls.Native.iOS.View value) [instance] :1740
...
// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) [instance] :1802
...
// public void set_ScrollPosition(float2 value) [instance] :1768
void ScrollView::ScrollPosition(::g::Uno::Float2 value)
{
    ScrollView::SetContentOffset(Handle(), value.X, value.Y);
}

// private static void Add(ObjC.Object parentHandle, ObjC.Object childHandle) [static] :1816
...
// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) [static] :1793
...
// private static ObjC.Object Create() [static] :1784
...
// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) [static] :1841
...
// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) [static] :1771
...
// private static void Remove(ObjC.Object childHandle) [static] :1824
...
// private static void SetContentOffset(ObjC.Object handle, float x, float y) [static] :1831
...
// private static void SetContentSize(ObjC.Object handle, float w, float h) [static] :1850
