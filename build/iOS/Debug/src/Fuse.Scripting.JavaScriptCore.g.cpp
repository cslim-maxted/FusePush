...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/0.38.6/$.uno
// ------------------------------------------------------------------------
...
static void JSValueRef_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/0.38.6/$.uno");
    ::TYPES[16] = uObject_typeof()->Array();
    ::TYPES[18] = ::g::Uno::IDisposable_typeof();
