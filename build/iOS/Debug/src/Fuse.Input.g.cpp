...
uType* CustomPointerEventArgs_typeof()
{
    ...
    options.TypeSize = sizeof(uType);
    type = uClassType::New("Fuse.Input.CustomPointerEventArgs", options);
...
{
    ::TYPES[36] = ::g::Fuse::HitTestCallback_typeof();
    type->SetFields(0,
...
{
    ::g::Fuse::HitTestContext* args = ::g::Fuse::HitTestContext::New1(point, uDelegate::New(::TYPES[36/*Fuse.HitTestCallback*/], (void*)SelectionQuery__Select_fn, this));
