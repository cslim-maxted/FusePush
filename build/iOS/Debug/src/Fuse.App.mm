...
// private void PropagateBackground() :172
...
void App::ctor_2()
{
    ...
    ::g::Fuse::AppRoot::Set(uPtr(uCast< ::g::Fuse::Controls::Native::iOS::View*>(uPtr(_graphicsView)->NativeViewGroup(), ::TYPES[4/*Fuse.Controls.Native.iOS.View*/]))->Handle());
...
// private void CheckFocus() [instance] :186
void App::CheckFocus()
{
...
// private void CheckStatusBarOrientation() [instance] :217
void App::CheckStatusBarOrientation()
{
    ...
    if (_prevStatusBarOrientation != o)
    {
        ...
        ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)::g::Fuse::Visual__InvalidateVisual_fn, uPtr(_rootPanel)), 0);
    }
}

// private void OnTick(object sender, Uno.Platform.TimerEventArgs args) [instance] :150
...
// private void PropagateBackground() [instance] :172
void App::PropagateBackground()
{
    ::g::Fuse::AppRoot::ClearColor(Background());
}

// private static bool Compare(ObjC.Object x, ObjC.Object y) [static] :204
...
// private static ObjC.Object GetFontFromFile(Uno.UX.FileSource file, float fontSize) [static] :135
uObject* App::GetFontFromFile(::g::Uno::UX::FileSource* file, float fontSize)
{
    return ::g::Fuse::iOS::Bindings::FontCache::GetFontFromFile(file, fontSize);
}

// private static bool IsNull(ObjC.Object x) [static] :211
