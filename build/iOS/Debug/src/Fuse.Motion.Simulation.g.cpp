...
// /usr/local/share/uno/Packages/Fuse.Motion/0.38.6/simulation/$.uno
// -----------------------------------------------------------------
...
{
    ::TYPES[4] = ::g::Fuse::Motion::Simulation::Friction_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[5] = ::g::Fuse::Motion::Simulation::SmoothSnap_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[2] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[7] = ::g::Fuse::Motion::Simulation::DestinationSimulation_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetInterfaces(
...
static void EasingMotion_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Fuse::Internal::BlenderMap_typeof();
    ::TYPES[8] = ::g::Fuse::Animations::EasingFunction_typeof();
    type->SetPrecalc(
        ::g::Fuse::Internal::BlenderMap_typeof()->MakeMethod(1, type->T(0)));
    type->SetInterfaces(
...
void EasingMotion::ctor_()
{
    ...
    _isDirty = true;
    _isStatic = true;
    _easingFunc = uDelegate::New(::TYPES[8/*Fuse.Animations.EasingFunction*/], (void*)::g::Fuse::Animations::EasingFunctions__Linear_fn);
    _progress = 1.0;
    _progressSpeed = 0.0;
    _transitionTime = 1.0;
