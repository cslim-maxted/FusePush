...
// /usr/local/share/uno/Packages/Uno.Threading/0.38.2/$.uno
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.38.2/tasks/$.uno
// --------------------------------------------------------------
...
static void Future1_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof()));
    ::TYPES[6] = ::g::Uno::Collections::Queue_typeof();
    ...
    type->SetPrecalc(
        ...
        Future1__Closure_typeof()->MakeType(type->T(0), type->U(0)),
...
{
    uType* __types[] = {
        __type->Precalced(4/*Uno.Threading.Future<T>.Closure<T1>*/),
    };
...
{
    uType* __types[] = {
        __type->GetBase(Future1_typeof())->Precalced(5/*Uno.Threading.Promise<T>*/),
...
static void IDispatcherExtensions_build(uType* type)
{
    ...
    type->SetPrecalc(
        IDispatcherExtensions__Arg1InvokeFunc_typeof()->MakeType(type->U(0), type->U(1)));
}
...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/threading/$.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Threading/0.38.2/implementation/cpp/$.uno
// ---------------------------------------------------------------------------
...
{
    ::TYPES[14] = ::g::Uno::Threading::TaskFuture_typeof();
...
{
    ::TYPES[8] = ::g::Uno::Exception_typeof();
    ::TYPES[15] = ::g::Uno::Exception_typeof()->Array();
    ::TYPES[16] = ::g::Uno::Threading::ITaskScheduler_typeof();
    type->SetInterfaces(
...
{
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            Status(1);
            Exception(::g::Uno::AggregateException::New7(uArray::Init< ::g::Uno::Exception*>(::TYPES[15/*Uno.Exception[]*/], 1, e)));
        }
    }
}
...
Task* Task::Run1(uDelegate* taskDelegate, uObject* scheduler)
{
    ...
    ::g::Uno::Threading::ITaskScheduler::ScheduleTask(uInterface(uPtr(scheduler), ::TYPES[16/*Uno.Threading.ITaskScheduler*/]), task);
    return task;
}
// }
...
{
    ::TYPES[17] = ::g::Uno::Threading::TaskDelegate_typeof();
    ::TYPES[8] = ::g::Uno::Exception_typeof();
    type->SetBase(::g::Uno::Threading::Future1_typeof()->MakeType(type->T(0)));
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::Threading::Future_type, interface0));
...
void TaskFuture::ctor_3(uDelegate* func)
{
    ctor_1();
    _func = func;
    _task = ::g::Uno::Threading::Task::Run(uDelegate::New(::TYPES[17/*Uno.Threading.TaskDelegate*/], (void*)TaskFuture__Invoke1_fn, this));
}
...
{
    ::TYPES[18] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(ThreadPool__WorkItem_typeof());
    ::TYPES[19] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Threading::Thread_typeof());
    ::TYPES[10] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
...
void ThreadPool::ctor_(int poolSize)
{
    ...
    _taskQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[18/*Uno.Threading.ConcurrentQueue<Uno.Threading.ThreadPool.WorkItem>*/]));
    _running = true;
    _disposeQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[19/*Uno.Threading.ConcurrentQueue<Uno.Threading.Thread>*/]));
    _poolSize = poolSize;
...
ThreadPoolTaskScheduler* ThreadPoolTaskScheduler::Default()
{
    if (ThreadPoolTaskScheduler::_default_ == NULL)
    {
        ...
        uPtr(uPtr(::g::Uno::Application::Current())->Window())->add_Closed(uDelegate::New(::TYPES[20/*Uno.EventHandler*/], (void*)ThreadPoolTaskScheduler__OnWindowClosed_fn));
    }
