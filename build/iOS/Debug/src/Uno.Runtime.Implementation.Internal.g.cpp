...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/runtime/implementation/internal/$.uno
// ---------------------------------------------------------------------------------------------
...
static void FormatStringTokenizer_build(uType* type)
{
    ...
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Runtime::Implementation::Internal::FormatStringToken_typeof());
    type->SetFields(0,
