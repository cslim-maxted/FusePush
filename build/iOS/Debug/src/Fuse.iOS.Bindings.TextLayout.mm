...
// public sealed extern class TextLayout :687
// {
...
// public TextLayout() :706
void TextLayout__ctor__fn(TextLayout* __this)
{
    __this->ctor_();
}

// public static void AddNSTextContainer(ObjC.Object layoutManager, ObjC.Object textContainer) :837
...
// public static void ClearTextContainers(ObjC.Object layoutManager) :771
void TextLayout__ClearTextContainers_fn(uObject* layoutManager)
{
    TextLayout::ClearTextContainers(layoutManager);
}

// public static ObjC.Object CreateNSTextContainer(float width, float height) :779
...
// public static ObjC.Object CreateNSTextStorage(string value, ObjC.Object font, ObjC.Object color, ObjC.Object style) :820
...
// private static Uno.Rect CreateRect(float2 pos, float2 size) :842
...
// public void Invalidate() :700
void TextLayout__Invalidate_fn(TextLayout* __this)
{
    __this->Invalidate();
}

// public TextLayout New() :706
void TextLayout__New1_fn(TextLayout** __retval)
{
    *__retval = TextLayout::New1();
}

// public static void SetNSParagraphStyleProperties(ObjC.Object style, Fuse.Controls.TextAlignment alignment, Fuse.Controls.TextWrapping wrapping, float lineSpacing) :787
...
// public static void SetNSTextStorage(ObjC.Object layoutManager, ObjC.Object textStorage) :831
...
// public static ObjC.Object ToUIColor(float4 color) :762
void TextLayout__ToUIColor_fn(::g::Uno::Float4* color, uObject** __retval)
{
    *__retval = TextLayout::ToUIColor(*color);
}

// public bool UpdateLayout(Fuse.Controls.TextControl control, float2 size, [bool useMin]) :715
...
// public static Uno.Rect UsedRectForTextContainer(ObjC.Object layoutManager, ObjC.Object textContainer) :848
...
// public TextLayout() [instance] :706
...
// public void Invalidate() [instance] :700
void TextLayout::Invalidate()
{
    _layoutValid = false;
}

// public bool UpdateLayout(Fuse.Controls.TextControl control, float2 size, [bool useMin]) [instance] :715
bool TextLayout::UpdateLayout(::g::Fuse::Controls::TextControl* control, ::g::Uno::Float2 size, bool useMin)
{
    ...
    _font = ((control->Font() != ::g::Fuse::Font::PlatformDefault()) ? (uObject*)::g::Fuse::iOS::Bindings::FontCache::GetFontFromFile(uPtr(control->Font())->File(), control->FontSize() * ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(control->Viewport()), ::TYPES[0/*Fuse.ICommonViewport*/]))) : (uObject*)::g::Fuse::iOS::Bindings::FontCache::GetDefaultFont(control->FontSize() * ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(control->Viewport()), ::TYPES[0/*Fuse.ICommonViewport*/]))));
...
// public static void AddNSTextContainer(ObjC.Object layoutManager, ObjC.Object textContainer) [static] :837
...
// public static void ClearTextContainers(ObjC.Object layoutManager) [static] :771
...
// public static ObjC.Object CreateNSTextContainer(float width, float height) [static] :779
...
// public static ObjC.Object CreateNSTextStorage(string value, ObjC.Object font, ObjC.Object color, ObjC.Object style) [static] :820
...
// private static Uno.Rect CreateRect(float2 pos, float2 size) [static] :842
::g::Uno::Rect TextLayout::CreateRect(::g::Uno::Float2 pos, ::g::Uno::Float2 size)
{
    return ::g::Uno::Rect__New2(pos, size);
}

// public TextLayout New() [static] :706
...
// public static void SetNSParagraphStyleProperties(ObjC.Object style, Fuse.Controls.TextAlignment alignment, Fuse.Controls.TextWrapping wrapping, float lineSpacing) [static] :787
...
// public static void SetNSTextStorage(ObjC.Object layoutManager, ObjC.Object textStorage) [static] :831
...
// public static ObjC.Object ToUIColor(float4 color) [static] :762
...
// public static Uno.Rect UsedRectForTextContainer(ObjC.Object layoutManager, ObjC.Object textContainer) [static] :848
