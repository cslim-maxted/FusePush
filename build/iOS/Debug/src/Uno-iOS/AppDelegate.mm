...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken {
    ...
    uString* token = uPlatform2::iOS::ToUno(hexToken);
    ::g::Uno::Platform::iOS::Application::OnNotificationRegistrationSucceeded(token);
}

- (void)application:(UIApplication *)application didFailToRegisterForRemoteNotificationsWithError:(NSError *)error {
    uAutoReleasePool pool;
    uString* errorReason = uPlatform2::iOS::ToUno(error.localizedDescription);
    ::g::Uno::Platform::iOS::Application::OnNotificationRegistrationFailed(errorReason);
}
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo{
    ...
    if (jsonData)
    {
        ...
        uString* jsonPayload = uPlatform2::iOS::ToUno(nsJsonPayload);
        ::g::Uno::Platform::iOS::Application::OnReceivedNotification(jsonPayload);
    }
}
//#endif
