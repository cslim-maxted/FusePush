...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/time/$.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/time/utilities/$.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/time/timezones/$.uno
// ----------------------------------------------------------------------------
...
{
    ::STRINGS[1] = uString::Const("UTC");
    ::TYPES[0] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    type->SetFields(4);
}
...
{
    ::STRINGS[1] = uString::Const("UTC");
    ::TYPES[2] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Offset_typeof());
    ::TYPES[0] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    type->SetFields(4,
...
static void LocalDateTime_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::CalendarSystem_typeof());
    ::TYPES[4] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Instant_typeof());
    ::TYPES[5] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::CalendarSystem_typeof());
    type->SetFields(0,
...
static void ZonedDateTime_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("calendar");
    ::TYPES[7] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::DateTimeZone_typeof());
    ::TYPES[3] = ::g::Uno::Time::Preconditions_typeof()->MakeMethod(1, ::g::Uno::Time::CalendarSystem_typeof());
    ::TYPES[8] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::LocalDateTime_typeof());
    ::TYPES[2] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::Offset_typeof());
    ::TYPES[9] = ::g::Uno::Time::HashCodeHelper_typeof()->MakeMethod(1, ::g::Uno::Time::DateTimeZone_typeof());
