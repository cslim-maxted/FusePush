...
// public abstract extern class LeafView :1350
// {
...
// protected LeafView(ObjC.Object handle) :1353
void LeafView__ctor_1_fn(LeafView* __this, uObject* handle)
{
    __this->ctor_1(handle);
}

// public float2 Measure(Fuse.LayoutParams lp, float density) :1355
...
// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) :1374
...
// protected LeafView(ObjC.Object handle) [instance] :1353
void LeafView::ctor_1(uObject* handle)
{
    ctor_(handle);
}

// public float2 Measure(Fuse.LayoutParams lp, float density) [instance] :1355
...
// private static void SizeThatFits(ObjC.Object handle, float w, float h, float& resW, float& resH) [static] :1374
