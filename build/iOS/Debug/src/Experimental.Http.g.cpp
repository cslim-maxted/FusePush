...
// /usr/local/share/uno/Packages/Experimental.Http/0.38.6/$.uno
// ------------------------------------------------------------
...
static void HttpResponseHeader_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[5] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[6] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/Experimental.Http/0.38.6/$.uno");
    ...
    ::TYPES[0] = ::g::Experimental::Cache::ICacheReader_typeof();
    ::TYPES[10] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof());
