...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/ux/$.uno
// ----------------------------------------------------------------
...
static void NameTable_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::Property_typeof());
    type->SetFields(0,
...
{
    ::TYPES[6] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::IPropertyListener_typeof());
...
{
    ::TYPES[8] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof()));
    ::TYPES[9] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof()));
    ::TYPES[10] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof()));
    ::TYPES[11] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof()));
    ::TYPES[12] = ::g::Uno::Collections::List_typeof();
    ::TYPES[13] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof()));
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    type->SetPrecalc(
...
// public static void RemoveGlobalKeyListener(Uno.Action<string> listener) :558
void Resource__RemoveGlobalKeyListener_fn(uDelegate* listener)
{
    Resource::RemoveGlobalKeyListener(listener);
}

// public static void SetGlobalKey(object obj, string key) :575
void Resource__SetGlobalKey_fn(uObject* obj, uString* key)
{
    Resource::SetGlobalKey(obj, key);
}

// public static bool TryFindGlobal(string key, Uno.Predicate<object> acceptor, object& res) :638
...
// public static void AddGlobalKeyListener(Uno.Action<string> listener) [static] :548
...
// public static string GetGlobalKey(object obj) [static] :605
uString* Resource::GetGlobalKey(uObject* obj)
{
    Resource_typeof()->Init();
    ::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong< ::g::Uno::Collections::List*> > ret7;
    bool ret8;
...

    {
        ...
        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong< ::g::Uno::Collections::List*> > enum5 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(Resource::_globals()), &ret7), ret7); enum5.MoveNext(::TYPES[10/*Uno.Collections.Dictionary<string, Uno.Collections.List<object>>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong< ::g::Uno::Collections::List*> > list = enum5.Current(::TYPES[10/*Uno.Collections.Dictionary<string, Uno.Collections.List<object>>.Enumerator*/]);

            if ((::g::Uno::Collections::List__Contains_fn(uPtr(list.Value(::TYPES[11/*Uno.Collections.KeyValuePair<string, Uno.Collections.List<object>>*/])), obj, &ret8), ret8))
...
// public static Uno.Collections.IEnumerable<T> GetGlobalsOfType<T>() [static] :617
uObject* Resource::GetGlobalsOfType(uType* __type)
{
    ...
    Resource_typeof()->Init();
    ::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong< ::g::Uno::Collections::List*> > ret9;
    uObject* ret10;
...

    {
        ...
        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(Resource::_globals()), &ret9), ret9); enum1.MoveNext(::TYPES[10/*Uno.Collections.Dictionary<string, Uno.Collections.List<object>>.Enumerator*/]); )
        {
            ...
            {
                uObject* v = (::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret10), ret10);
...
{
    Resource* obj6 = (Resource*)uNew(Resource_typeof());
    obj6->ctor_(key, value);
    return obj6;
}

// public static void RemoveGlobalKeyListener(Uno.Action<string> listener) [static] :558
void Resource::RemoveGlobalKeyListener(uDelegate* listener)
{
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::List__Remove_fn(uPtr(Resource::_listeners()), listener, &ret11);
    }
}

// public static void SetGlobalKey(object obj, string key) [static] :575
void Resource::SetGlobalKey(uObject* obj, uString* key)
{
    Resource_typeof()->Init();
    ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > ret12;
    bool ret13;
    bool ret14;
    bool ret15;
    ::g::Uno::Threading::Monitor::Enter(Resource::_globals());

    {
        ...
        for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(Resource::_globals())->Values()), &ret12), ret12); enum1.MoveNext(::TYPES[13/*Uno.Collections.Dictionary<string, Uno.Collections.List<object>>.ValueCollection.Enumerator*/]); )
        {
            ::g::Uno::Collections::List* list = enum1.Current(::TYPES[13/*Uno.Collections.Dictionary<string, Uno.Collections.List<object>>.ValueCollection.Enumerator*/]);

            if ((::g::Uno::Collections::List__Contains_fn(uPtr(list), obj, &ret13), ret13))
            {
                ::g::Uno::Collections::List__Remove_fn(uPtr(list), obj, &ret14);
                break;
            }
        }
        ...
        if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Resource::_globals()), key, (void**)(&objs), &ret15), ret15))
        {
    ...
    for (int index3 = 0, length4 = uPtr(listeners)->Length(); index3 < length4; ++index3)
    {
        uDelegate* listener = uPtr(listeners)->Strong<uDelegate*>(index3);
        uPtr(listener)->InvokeVoid(key);
    }
}

// public static bool TryFindGlobal(string key, Uno.Predicate<object> acceptor, object& res) [static] :638
bool Resource::TryFindGlobal(uString* key, uDelegate* acceptor, uObject** res)
{
...

    {
        ...
        if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Resource::_globals()), key, (void**)(&list), &ret16), ret16))

            for (int i = uPtr(list)->Count(); (i--) > 0; )
            {
                uObject* v = (::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret17), ret17);

                if ((uPtr(acceptor)->Invoke(&ret18, 1, v), ret18))
                {
                    *res = v;
                    return true;
                }
...
{
    ::TYPES[15] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[16] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
// public override sealed int GetHashCode() :814
...
void Size__ToString_fn(Size* __this, uType* __type, uString** __retval)
{
    ...
    switch (__this->Unit)
    {
        ...
        default:
            return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Float::ToString((ind5 = __this->Value, ind5), ::TYPES[17/*float*/]), ::STRINGS[6/*" ("*/]), ::g::Uno::Int::ToString((ind6 = __this->Unit, ind6), ::TYPES[18/*int*/])), ::STRINGS[7/*")"*/]), void();
    }
}

// public Size(float value, Uno.UX.Unit unit) [instance] :699
...
// public Uno.UX.Unit DetermineUnit() [instance] :728
...
// public bool get_IsAuto() [instance] :766
bool Size::IsAuto()
{
    return Unit == 0;
}

// private static Uno.UX.Unit Combine(Uno.UX.Unit a, Uno.UX.Unit b) [static] :720
...
// public Size New(float value, Uno.UX.Unit unit) [static] :699
...
// public static operator +(Uno.UX.Size a, Uno.UX.Size b) [static] :734
Size Size__op_Addition(Size a, Size b)
{
    return Size__New1(a.Value + b.Value, Size::Combine(a.Unit, b.Unit));
}

// public static explicit operator float(Uno.UX.Size s) [static] :715
float Size__op_Explicit(Size s)
{
    return s.Value;
}

// public static implicit operator Uno.UX.Size(float unspecifiedUnits) [static] :705
Size Size__op_Implicit(float unspecifiedUnits)
{
    return Size__New1(unspecifiedUnits, 1);
}

// public static implicit operator Uno.UX.Size(int unspecifiedUnits) [static] :710
Size Size__op_Implicit1(int unspecifiedUnits)
{
    return Size__New1((float)unspecifiedUnits, 1);
}

// public static operator !=(Uno.UX.Size a, Uno.UX.Size b) [static] :759
bool Size__op_Inequality(Size a, Size b)
{
    return (a.Value != b.Value) || (a.Unit != b.Unit);
}

// public static operator *(Uno.UX.Size a, float b) [static] :744
Size Size__op_Multiply(Size a, float b)
{
    return Size__New1(a.Value * b, a.Unit);
}

// public static operator -(Uno.UX.Size a, Uno.UX.Size b) [static] :739
Size Size__op_Subtraction(Size a, Size b)
{
    return Size__New1(a.Value - b.Value, Size::Combine(a.Unit, b.Unit));
}

// public static Uno.UX.Size Percent(float value) [static] :778
Size Size__Percent(float value)
{
    return Size__New1(value, 4);
}

// public static Uno.UX.Size Pixels(float value) [static] :773
Size Size__Pixels(float value)
{
    return Size__New1(value, 3);
}

// public static Uno.UX.Size Points(float value) [static] :768
Size Size__Points(float value)
{
    return Size__New1(value, 2);
}

// public static Uno.UX.Size get_Auto() [static] :764
Size Size__Auto()
{
...
// public Size2(Uno.UX.Size x, Uno.UX.Size y) :837
void Size2__ctor__fn(Size2* __this, ::g::Uno::UX::Size* x, ::g::Uno::UX::Size* y)
{
    __this->ctor_(*x, *y);
}

// public static Uno.UX.Size2 get_Auto() :892
void Size2__get_Auto_fn(Size2* __retval)
{
    *__retval = Size2__Auto();
}

// public override sealed bool Equals(object obj) :915
...
// public override sealed int GetHashCode() :927
...
// public static operator !=(Uno.UX.Size2 a, Uno.UX.Size2 b) :885
void Size2__op_Inequality_fn(Size2* a, Size2* b, bool* __retval)
{
    *__retval = Size2__op_Inequality(*a, *b);
}

// public static operator *(Uno.UX.Size2 a, float b) :870
void Size2__op_Multiply_fn(Size2* a, float* b, Size2* __retval)
{
    *__retval = Size2__op_Multiply(*a, *b);
}

// public static operator -(Uno.UX.Size2 a, Uno.UX.Size2 b) :865
void Size2__op_Subtraction_fn(Size2* a, Size2* b, Size2* __retval)
{
    *__retval = Size2__op_Subtraction(*a, *b);
}

// public override sealed string ToString() :910
void Size2__ToString_fn(Size2* __this, uType* __type, uString** __retval)
{
    ::g::Uno::UX::Size ind1;
    ::g::Uno::UX::Size ind2;
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((ind1 = __this->X, (&ind1))->ToString(::TYPES[19/*Uno.UX.Size*/]), ::STRINGS[8/*", "*/]), (ind2 = __this->Y, (&ind2))->ToString(::TYPES[19/*Uno.UX.Size*/])), void();
}

// public Size2(Uno.UX.Size x, Uno.UX.Size y) [instance] :837
...
// public Size2 New(Uno.UX.Size x, Uno.UX.Size y) [static] :837
...
// public static operator +(Uno.UX.Size2 a, Uno.UX.Size2 b) [static] :860
...
// public static explicit operator float2(Uno.UX.Size2 v) [static] :853
...
// public static implicit operator Uno.UX.Size2(float2 unspecifiedUnitsVector) [static] :843
...
// public static operator !=(Uno.UX.Size2 a, Uno.UX.Size2 b) [static] :885
...
// public static operator *(Uno.UX.Size2 a, float b) [static] :870
...
// public static operator -(Uno.UX.Size2 a, Uno.UX.Size2 b) [static] :865
...
// public static Uno.UX.Size2 get_Auto() [static] :892
Size2 Size2__Auto()
{
