...
// /usr/local/share/uno/Packages/Fuse.Controls.Video/0.38.6/ios/$.uno
// ------------------------------------------------------------------
...
static void VideoPlayer_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Exception_typeof());
...
// private sealed class VideoLoader.VideoPromise :204
// {
...
// private void DoDispose() [instance] :243
...
// private void OnLoaded() [instance] :213
...
// private void OnLoadError() [instance] :220
...
// private void ScheduleDispose() [instance] :234
...
// public VideoPromise New(string url) [static] :208
