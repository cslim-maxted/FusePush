...
// internal abstract extern class Shape :1886
// {
static void Shape_build(uType* type)
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/0.38.6/ios/$.uno");
    ...
    ::TYPES[4] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[5] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[6] = ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), ::g::Fuse::Drawing::GradientStop_typeof(), ::g::Uno::Int_typeof());
...
// protected Shape(Fuse.Visual visual) :1891
void Shape__ctor_1_fn(Shape* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_1(visual);
}

// private static ObjC.Object Create() :2131
...
// private void Fuse.Controls.Native.IShapeView.Update(Fuse.Drawing.Brush[] fills, Fuse.Drawing.Stroke[] strokes, float pixelsPerPoint) :1927
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) :2115
void Shape__MakeLayers_fn(uObject* handle, int* layerCount)
{
    Shape::MakeLayers(handle, *layerCount);
}

// protected void OnShapeChanged() :1933
void Shape__OnShapeChanged_fn(Shape* __this)
{
    __this->OnShapeChanged();
}

// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) :1985
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) :1961
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) :2093
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) :1990
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) :2022
...
// public override sealed void set_Transform(float4x4 value) :1906
...
// protected Shape(Fuse.Visual visual) [instance] :1891
...
// protected void OnShapeChanged() [instance] :1933
...
// private void SetBrush(Fuse.Drawing.Brush brush, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :1961
void Shape::SetBrush(::g::Fuse::Drawing::Brush* brush, int layer, uObject* path, bool isLine, float strokeWidth)
{
    ...
    else
    {
        ...
        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/usr/local/...*/], 1978, ::STRINGS[2/*"SetBrush"*/]);
...
// private void SetLinearGradient(Fuse.Drawing.LinearGradient gradient, int layer, ObjC.Object path, bool isLine, float strokeWidth) [instance] :1990
...
// protected generated float2 get_ShapePosition() [instance] :1903
::g::Uno::Float2 Shape::ShapePosition()
{
    return _ShapePosition;
}

// private generated void set_ShapePosition(float2 value) [instance] :1903
void Shape::ShapePosition(::g::Uno::Float2 value)
{
    _ShapePosition = value;
}

// protected generated float2 get_ShapeSize() [instance] :1914
::g::Uno::Float2 Shape::ShapeSize()
{
    return _ShapeSize;
}

// private generated void set_ShapeSize(float2 value) [instance] :1914
void Shape::ShapeSize(::g::Uno::Float2 value)
{
    _ShapeSize = value;
}

// private static ObjC.Object Create() [static] :2131
...
// private static void MakeLayers(ObjC.Object handle, int layerCount) [static] :2115
...
// private static int SelectOffset(Fuse.Drawing.GradientStop a, Fuse.Drawing.GradientStop b) [static] :1985
...
// private static void SetBrush(ObjC.Object handle, float r, float g, float b, float a, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float opacity) [static] :2093
...
// private static void SetLinearGradient(ObjC.Object handle, int layerIndex, ObjC.Object pathHandle, bool isLine, float strokeWidth, float startX, float startY, float endX, float endY, float[] colors, float[] offsets, float width, float height) [static] :2022
