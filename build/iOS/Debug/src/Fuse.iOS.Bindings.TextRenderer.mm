...
// public sealed extern class TextRenderer :866
// {
// static TextRenderer() :866
...
// public TextRenderer(Fuse.Controls.TextControl control) :881
void TextRenderer__ctor__fn(TextRenderer* __this, ::g::Fuse::Controls::TextControl* control)
{
    __this->ctor_(control);
}

// public void Arrange(float2 position, float2 size) :975
void TextRenderer__Arrange_fn(TextRenderer* __this, ::g::Uno::Float2* position, ::g::Uno::Float2* size)
{
    __this->Arrange(*position, *size);
}

// private static Fuse.iOS.Bindings.CGContextRef CGBitmapContextCreate(Uno.IntPtr textureBuffer, int width, int height, Fuse.iOS.Bindings.CGColorSpaceRef colorSpace) :947
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() :870
...
// private static void CGContextRelease(Fuse.iOS.Bindings.CGContextRef context) :953
void TextRenderer__CGContextRelease_fn(::CGContextRef* context)
{
    TextRenderer::CGContextRelease(*context);
}

// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) :872
void TextRenderer__Create_fn(::g::Fuse::Controls::TextControl* control, uObject** __retval)
{
    *__retval = TextRenderer::Create(control);
}

// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) :902
void TextRenderer__Draw_fn(TextRenderer* __this, ::g::Fuse::DrawContext* dc, ::g::Fuse::Visual* where)
{
    __this->Draw(dc, where);
}

// private static void DrawGlyphs(Fuse.iOS.Bindings.CGContextRef context, float x, float y, int width, int height, ObjC.Object layoutManager, ObjC.Object textContainer) :956
...
// public float2 GetContentSize(Fuse.LayoutParams lp) :886
...
// public TextRenderer(Fuse.Controls.TextControl control) [instance] :881
...
// public void Arrange(float2 position, float2 size) [instance] :975
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :902
...
// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :886
...
// public Uno.Rect GetRenderBounds() [instance] :1007
...
// public void Invalidate() [instance] :985
...
// private void InvalidateTexture() [instance] :998
...
// public void SoftDispose() [instance] :993
void TextRenderer::SoftDispose()
{
    InvalidateTexture();
}

// private static Fuse.iOS.Bindings.CGContextRef CGBitmapContextCreate(Uno.IntPtr textureBuffer, int width, int height, Fuse.iOS.Bindings.CGColorSpaceRef colorSpace) [static] :947
...
// private static Fuse.iOS.Bindings.CGColorSpaceRef CGColorSpaceCreateDeviceRGB() [static] :870
...
// private static void CGContextRelease(Fuse.iOS.Bindings.CGContextRef context) [static] :953
...
// internal static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) [static] :872
...
// private static void DrawGlyphs(Fuse.iOS.Bindings.CGContextRef context, float x, float y, int width, int height, ObjC.Object layoutManager, ObjC.Object textContainer) [static] :956
...
// public TextRenderer New(Fuse.Controls.TextControl control) [static] :881
