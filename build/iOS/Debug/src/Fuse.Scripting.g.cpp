...
{
    ::STRINGS[2] = uString::Const("_tempMethod");
    ::TYPES[5] = ::g::Fuse::Node_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[7] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Property_typeof(), ::g::Fuse::Scripting::ObservableProperty_typeof());
    ::TYPES[8] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[9] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Property_typeof());
    ::TYPES[10] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Property_typeof());
    ::TYPES[11] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::UX::Property_typeof(), ::g::Fuse::Scripting::ObservableProperty_typeof());
    type->SetFields(0,
...
{
    uPtr(_self)->Item(::STRINGS[2/*"_tempMethod"*/], method);
    uPtr(_self)->CallMethod(::STRINGS[2/*"_tempMethod"*/], args);
}

// private void DispatchUnroot() [instance] :117
void ClassInstance::DispatchUnroot()
{
    ::g::Fuse::Node* n = uCast< ::g::Fuse::Node*>(uPtr(_rootTable)->This(), ::TYPES[5/*Fuse.Node*/]);
...
{
    if (_properties == NULL)
        _properties = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[7/*Uno.Collections.Dictionary<Uno.UX.Property, Fuse.Scripting.ObservableProperty>*/]));
}
...
void ClassInstance::EnsureRooted()
{
    ...
    ::g::Fuse::Node* n = uAs< ::g::Fuse::Node*>(_obj, ::TYPES[5/*Fuse.Node*/]);

    if (n != NULL)
        uPtr(n)->add_Unrooted(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)ClassInstance__DispatchUnroot_fn, this));

    _self = uAs< ::g::Fuse::Scripting::Object*>(uPtr(_context)->Unwrap(_obj), ::TYPES[8/*Fuse.Scripting.Object*/]);
    ...
    if (_properties == NULL)
    {
        if (_rootTable != NULL)
        {
            ...
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(_rootTable)->Properties()), ::TYPES[9/*Uno.Collections.ICollection<Uno.UX.Property>*/])); i++)
            {
                ::g::Uno::UX::Property* p = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(_rootTable)->Properties()), ::TYPES[10/*Uno.Collections.IList<Uno.UX.Property>*/]), uCRef<int>(i), &ret4), ret4);
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(uObject_typeof(), uArray::New(::TYPES[12/*Fuse.Scripting.ScriptMember[]*/], 0));
}
...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly.");
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/scripting/$.uno");
    ::STRINGS[7] = uString::Const("CreateMirror");
    ::STRINGS[8] = uString::Const("Cannot use object of type '");
    ::STRINGS[9] = uString::Const("' as 'this' in JavaScript module; must be 'Node' or 'App'");
    ...
    ::STRINGS[18] = uString::Const("external_object");
    ::STRINGS[19] = uString::Const(" (ScriptClass)");
    ::STRINGS[20] = uString::Const("(function(external_object) { this.external_object = external_object; })");
    ::STRINGS[21] = uString::Const("(set-superclass)");
    ::STRINGS[22] = uString::Const("(function(cl, superclass) { cl.prototype = new superclass(); cl.prototype.constructor = cl; })");
    ::STRINGS[23] = uString::Const(".");
    ::STRINGS[24] = uString::Const(" (ScriptMethod)");
    ::STRINGS[25] = uString::Const("(function(cl, Observable) { cl.prototype.");
    ::STRINGS[26] = uString::Const(" = ");
    ::STRINGS[27] = uString::Const("; })");
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[12] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::Observable__Operation_typeof());
    ::TYPES[14] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Scripting::ScriptClass_typeof(), ::g::Fuse::Scripting::Function_typeof());
    ::TYPES[15] = ::g::Uno::Threading::ConcurrentDictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Fuse::Scripting::ModuleResult_typeof());
    ::TYPES[16] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[17] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[18] = ::g::Uno::IDisposable_typeof();
    ::TYPES[5] = ::g::Fuse::Node_typeof();
    ::TYPES[19] = ::g::Fuse::Scripting::ClassInstance_typeof();
    ::TYPES[20] = ::g::Fuse::AppBase_typeof();
    ::TYPES[21] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[22] = ::g::Fuse::Scripting::IThreadWorker_typeof();
    ::TYPES[23] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[24] = ::g::Fuse::Scripting::ScriptMethodInline_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::ScriptProperty_typeof();
    ::TYPES[27] = ::g::Uno::String_typeof();
    ::TYPES[4] = ::g::Fuse::Scripting::ValueMirror_typeof();
    ::TYPES[28] = ::g::Uno::Float2_typeof();
    ::TYPES[29] = ::g::Uno::Float3_typeof();
    ::TYPES[30] = ::g::Uno::Float4_typeof();
    ::TYPES[31] = ::g::Uno::Int2_typeof();
    ::TYPES[32] = ::g::Uno::Int3_typeof();
    ::TYPES[33] = ::g::Uno::Int4_typeof();
    ::TYPES[34] = ::g::Uno::Float_typeof();
    ::TYPES[35] = ::g::Uno::Int_typeof();
    ::TYPES[36] = ::g::Uno::UInt_typeof();
    ::TYPES[37] = ::g::Fuse::Scripting::IScriptObject_typeof();
    type->SetInterfaces(
...
{
    _messages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[13/*Uno.Collections.List<Fuse.Scripting.Observable.Operation>*/]));
    _messagesMutex = ::g::Uno::Threading::Mutex::Create();
    _registeredClasses = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[14/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/]));
    _classInstanceProperty = ::g::Fuse::Properties::CreateHandle();
    _moduleResults = ((::g::Uno::Threading::ConcurrentDictionary*)::g::Uno::Threading::ConcurrentDictionary::New1(::TYPES[15/*Uno.Threading.ConcurrentDictionary<string, Fuse.Scripting.ModuleResult>*/]));
    _worker = worker;
}
...
{
    if (_identity == NULL)
        _identity = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(Context)"*/], ::STRINGS[4/*"(function(x...*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);

    return uCast< ::g::Fuse::Scripting::Function*>(uPtr(_identity)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, c)), ::TYPES[16/*Fuse.Scripting.Function*/]);
}
...
::g::Fuse::Scripting::ValueMirror* Context::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[5/*"JavaScript ...*/], this, ::STRINGS[6/*"/usr/local/...*/], 228, ::STRINGS[7/*"CreateMirror"*/]);
        return NULL;
    }

    ::g::Fuse::Scripting::Array* a = uAs< ::g::Fuse::Scripting::Array*>(obj, ::TYPES[17/*Fuse.Scripting.Array*/]);

    if (a != NULL)
        return ::g::Fuse::Scripting::ArrayMirror::New1(this, a);

    ::g::Fuse::Scripting::Object* o = uAs< ::g::Fuse::Scripting::Object*>(obj, ::TYPES[8/*Fuse.Scripting.Object*/]);
...
{
    return ::g::Fuse::Scripting::IThreadWorker::Dispatcher(uInterface(uPtr(_worker), ::TYPES[22/*Fuse.Scripting.IThreadWorker*/]));
}
...
{
    ::g::Fuse::Node* n = uAs< ::g::Fuse::Node*>(obj, ::TYPES[5/*Fuse.Node*/]);

    if (n != NULL)
    {
        ::g::Fuse::Scripting::ClassInstance* ni = uAs< ::g::Fuse::Scripting::ClassInstance*>(uPtr(uPtr(n)->Properties())->Get(_classInstanceProperty), ::TYPES[19/*Fuse.Scripting.ClassInstance*/]);
    ...
    ::g::Fuse::AppBase* app = uAs< ::g::Fuse::AppBase*>(obj, ::TYPES[20/*Fuse.AppBase*/]);
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[8/*"Cannot use ...*/], ::g::Uno::Type::FullName(uPtr(::g::Uno::Object::GetType(uPtr(uPtr(rootTable)->This()))))), ::STRINGS[9/*"' as 'this'...*/])));
}
...
{
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(::g::Fuse::Scripting::IThreadWorker::Dispatcher(uInterface(uPtr(_worker), ::TYPES[22/*Fuse.Scripting.IThreadWorker*/]))), ::TYPES[21/*Uno.Threading.IDispatcher*/]), action);
}
...
{
    if (_newArray == NULL)
        _newArray = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(Context)"*/], ::STRINGS[10/*"(function(c...*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);

    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(uPtr(_newArray)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[35/*int*/], uPtr(values)->Length()))), ::TYPES[17/*Fuse.Scripting.Array*/]);
...
{
    if (_newObject == NULL)
        _newObject = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(Context)"*/], ::STRINGS[11/*"(function()...*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);

    return uCast< ::g::Fuse::Scripting::Object*>(uPtr(_newObject)->Call(uArray::New(::TYPES[3/*object[]*/], 0)), ::TYPES[8/*Fuse.Scripting.Object*/]);
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[12/*"(function(o...*/], ::g::Uno::Delegate::op_Inequality(setProperty, NULL) ? ::STRINGS[13/*" set: setCa...*/] : ::STRINGS[14/*""*/]), ::STRINGS[15/*" enumerable...*/])), ::TYPES[16/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 6, obj, name, getProperty, setProperty, uBox(::TYPES[52/*bool*/], enumerable), uBox(::TYPES[52/*bool*/], configurable)));
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::STRINGS[16/*"(function(o...*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 5, obj, name, value, uBox(::TYPES[52/*bool*/], enumerable), uBox(::TYPES[52/*bool*/], configurable)));
}

// public Fuse.Scripting.Function get_Observable() [instance] :556
::g::Fuse::Scripting::Function* Context::Observable()
{
    return ::g::Fuse::Scripting::IThreadWorker::Observable(uInterface(uPtr(_worker), ::TYPES[22/*Fuse.Scripting.IThreadWorker*/]));
}
...
{
    if (_parseJson == NULL)
        _parseJson = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(Context)"*/], ::STRINGS[17/*"JSON.parse"*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::External* e = uAs< ::g::Fuse::Scripting::External*>(obj, ::TYPES[23/*Fuse.Scripting.External*/]);

    if (e != NULL)
        return uPtr(e)->Object;

    ::g::Fuse::Scripting::Object* sobj = uAs< ::g::Fuse::Scripting::Object*>(obj, ::TYPES[8/*Fuse.Scripting.Object*/]);

    if (sobj != NULL)
    {
        if (uPtr(sobj)->ContainsKey(::STRINGS[18/*"external_ob...*/]))
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[18/*"external_ob...*/]), ::TYPES[23/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[19/*" (ScriptCla...*/]), ::STRINGS[20/*"(function(e...*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[21/*"(set-superc...*/], ::STRINGS[22/*"(function(c...*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);
    ...
    {
        ::g::Fuse::Scripting::ScriptMethodInline* inlineMethod = uAs< ::g::Fuse::Scripting::ScriptMethodInline*>(uPtr(uPtr(sc)->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[24/*Fuse.Scripting.ScriptMethodInline*/]);

        if (inlineMethod != NULL)
        {
            ::g::Fuse::Scripting::Function* m = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[23/*"."*/]), uPtr(inlineMethod)->Name), ::STRINGS[24/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[25/*"(function(c...*/], uPtr(inlineMethod)->Name), ::STRINGS[26/*" = "*/]), uPtr(inlineMethod)->Code), ::STRINGS[27/*"; })"*/])), ::TYPES[16/*Fuse.Scripting.Function*/]);
            uPtr(m)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, (::g::Fuse::Scripting::Function*)Observable()));
            continue;
        }

        ::g::Fuse::Scripting::ScriptMethod* method = uAs< ::g::Fuse::Scripting::ScriptMethod*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[25/*Fuse.Scripting.ScriptMethod*/]);
        ...
        ::g::Fuse::Scripting::ScriptProperty* property = uAs< ::g::Fuse::Scripting::ScriptProperty*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[26/*Fuse.Scripting.ScriptProperty*/]);
...
{
    return NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, uBox(::TYPES[51/*double*/], (double)v.X), uBox(::TYPES[51/*double*/], (double)v.Y)));
}

// private Fuse.Scripting.Array ToArray(float3 v) [instance] :680
::g::Fuse::Scripting::Array* Context::ToArray1(::g::Uno::Float3 v)
{
    return NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 3, uBox(::TYPES[51/*double*/], (double)v.X), uBox(::TYPES[51/*double*/], (double)v.Y), uBox(::TYPES[51/*double*/], (double)v.Z)));
}

// private Fuse.Scripting.Array ToArray(float4 v) [instance] :685
::g::Fuse::Scripting::Array* Context::ToArray2(::g::Uno::Float4 v)
{
    return NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 4, uBox(::TYPES[51/*double*/], (double)v.X), uBox(::TYPES[51/*double*/], (double)v.Y), uBox(::TYPES[51/*double*/], (double)v.Z), uBox(::TYPES[51/*double*/], (double)v.W)));
}
...
uObject* Context::Unwrap(uObject* dc)
{
    if (dc == NULL)
        return NULL;
    else if (uIs(dc, ::TYPES[27/*string*/]))
        return dc;
        ...
        return dc;
    else if (uIs(dc, ::TYPES[28/*float2*/]))
        return ToArray(uUnbox< ::g::Uno::Float2>(::TYPES[28/*float2*/], dc));
    else if (uIs(dc, ::TYPES[29/*float3*/]))
        return ToArray1(uUnbox< ::g::Uno::Float3>(::TYPES[29/*float3*/], dc));
    else if (uIs(dc, ::TYPES[30/*float4*/]))
        return ToArray2(uUnbox< ::g::Uno::Float4>(::TYPES[30/*float4*/], dc));
    else if (uIs(dc, ::TYPES[31/*int2*/]))
        return ToArray3(uUnbox< ::g::Uno::Int2>(::TYPES[31/*int2*/], dc));
    else if (uIs(dc, ::TYPES[32/*int3*/]))
        return ToArray4(uUnbox< ::g::Uno::Int3>(::TYPES[32/*int3*/], dc));
    else if (uIs(dc, ::TYPES[33/*int4*/]))
        return ToArray5(uUnbox< ::g::Uno::Int4>(::TYPES[33/*int4*/], dc));
...
{
    uObject* so = uAs<uObject*>(obj, ::TYPES[37/*Fuse.Scripting.IScriptObject*/]);

    if ((so != NULL) && (::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[37/*Fuse.Scripting.IScriptObject*/])) != NULL))
        return ::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[37/*Fuse.Scripting.IScriptObject*/]));
    ...
    if (so != NULL)
        ::g::Fuse::Scripting::IScriptObject::SetScriptObject(uInterface(uPtr(so), ::TYPES[37/*Fuse.Scripting.IScriptObject*/]), res, this);
...
uObject* Context::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[23/*Fuse.Scripting.External*/]))
        return uPtr(uCast< ::g::Fuse::Scripting::External*>(obj, ::TYPES[23/*Fuse.Scripting.External*/]))->Object;
    else if (uIs(obj, ::TYPES[8/*Fuse.Scripting.Object*/]))
    {
        ::g::Fuse::Scripting::Object* sobj = uCast< ::g::Fuse::Scripting::Object*>(obj, ::TYPES[8/*Fuse.Scripting.Object*/]);
    ...
    if (uIs(obj, ::TYPES[34/*float*/]))
        return uBox(::TYPES[51/*double*/], (double)uUnbox<float>(::TYPES[34/*float*/], obj));

    if (uIs(obj, ::TYPES[35/*int*/]))
        return uBox(::TYPES[51/*double*/], (double)uUnbox<int>(::TYPES[35/*int*/], obj));

    if (uIs(obj, ::TYPES[36/*uint*/]))
        return uBox(::TYPES[51/*double*/], (double)uUnbox<uint32_t>(::TYPES[36/*uint*/], obj));
...
{
    ::STRINGS[28] = uString::Const("Promise");
    ::TYPES[16] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[39] = ::g::Fuse::Scripting::NativePromise__PromiseClosure_typeof();
    type->SetPrecalc(
...
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[28/*"Promise"*/]), ::TYPES[16/*Fuse.Scripting.Function*/]);
    ::g::Uno::Threading::Future1* future = (::g::Uno::Threading::Future1*)uPtr(_factory)->Invoke(1, args);
    return uPtr(promise)->Construct(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)::g::Fuse::Scripting::NativePromise__PromiseClosure__Run_fn, ::g::Fuse::Scripting::NativePromise__PromiseClosure::New1(__types[0], _c, future, _converter))));
}
...
{
    ::STRINGS[29] = uString::Const("path");
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[27] = ::g::Uno::String_typeof();
    ::TYPES[41] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[42] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[43] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[44] = ::g::Fuse::Scripting::IObject_typeof();
    type->SetInterfaces(
...
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[27/*string*/]))
    {
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[41/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[42/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[43/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret3), ret3);

            if (::g::Uno::String::op_Equality(uPtr(f)->SourcePath(), path))
                return ::g::Uno::UX::BundleFileSource::New1(f);
        }

        return ::g::Fuse::Scripting::JSFileSource::New1(uCast<uString*>(obj, ::TYPES[27/*string*/]));
    }
    else if (uIs(obj, ::TYPES[44/*Fuse.Scripting.IObject*/]))
        return ::g::Fuse::Scripting::JSFileSource::New1(uAs<uString*>(::g::Fuse::Scripting::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[44/*Fuse.Scripting.IObject*/]), ::STRINGS[29/*"path"*/]), ::TYPES[27/*string*/]));
...
{
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[45] = JSCallback__ActionClosure1_typeof();
    ::TYPES[46] = JSCallback__ActionClosure2_typeof();
    ::TYPES[47] = JSCallback__FuncClosure_typeof();
    ::TYPES[48] = JSCallback__FuncClosure1_typeof();
    ::TYPES[49] = JSCallback__NumberConverter_typeof();
    type->SetPrecalc(
...
{
    uType* __types[] = {
        __type->Precalced(4/*Fuse.Scripting.JSCallback.NumberConverter.TryConvert<T>*/),
    };
    int index_ = *index;
    bool ret1;
...
{
    return uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)JSCallback__ActionClosure__Run_fn, JSCallback__ActionClosure::New1(action));
}
...
uDelegate* JSCallback::FromAction1(uType* __type, uDelegate* action)
{
    ...
    return uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)JSCallback__ActionClosure1__Run_fn, (JSCallback__ActionClosure1*)JSCallback__ActionClosure1::New1(__types[0], action));
}
...
uDelegate* JSCallback::FromAction2(uType* __type, uDelegate* action)
{
    ...
    return uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)JSCallback__ActionClosure2__Run_fn, (JSCallback__ActionClosure2*)JSCallback__ActionClosure2::New1(__types[0], action));
}
...
uDelegate* JSCallback::FromFunc(uType* __type, uDelegate* func)
{
    ...
    return uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)JSCallback__FuncClosure__Run_fn, (JSCallback__FuncClosure*)JSCallback__FuncClosure::New1(__types[0], func));
}
...
uDelegate* JSCallback::FromFunc1(uType* __type, uDelegate* func)
{
    ...
    return uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)JSCallback__FuncClosure1__Run_fn, (JSCallback__FuncClosure1*)JSCallback__FuncClosure1::New1(__types[0], func));
}
// }
...
static void Json_build(uType* type)
{
    ...
    ::STRINGS[33] = uString::Const("Json.Stringify(): object can not contain cycles");
    ...
    ::STRINGS[40] = uString::Const("null");
    ::STRINGS[41] = uString::Const("true");
    ::STRINGS[42] = uString::Const("false");
    ::STRINGS[43] = uString::Const("\"");
    ::TYPES[50] = ::g::Uno::Collections::HashSet_typeof()->MakeType(uObject_typeof());
    ::TYPES[27] = ::g::Uno::String_typeof();
    ::TYPES[51] = ::g::Uno::Double_typeof();
    ::TYPES[34] = ::g::Uno::Float_typeof();
    ::TYPES[35] = ::g::Uno::Int_typeof();
    ::TYPES[52] = ::g::Uno::Bool_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[53] = ::g::Uno::String_typeof()->Array();
    ::TYPES[54] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[55] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[56] = ::g::Uno::Comparison_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[17] = ::g::Fuse::Scripting::Array_typeof();
}
...
uString* Json::Stringify(uObject* value, bool normalized)
{
    ...
    Json::Stringify1(value, normalized, sb, (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[50/*Uno.Collections.HashSet<object>*/]));
    return sb->ToString();
}
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    else if (uIs(value, ::TYPES[51/*double*/]))
        uPtr(sb)->Append2(Json::ToLiteral1(uUnbox<double>(::TYPES[51/*double*/], value)));
    else if (uIs(value, ::TYPES[34/*float*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<float>(::TYPES[34/*float*/], value)));
    else if (uIs(value, ::TYPES[35/*int*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<int>(::TYPES[35/*int*/], value)));
    else if (uIs(value, ::TYPES[52/*bool*/]))
        uPtr(sb)->Append2(Json::ToLiteral(uUnbox<bool>(::TYPES[52/*bool*/], value)));
    else if (uIs(value, ::TYPES[8/*Fuse.Scripting.Object*/]))
    {
        if ((::g::Uno::Collections::HashSet__Contains_fn(uPtr(visitedSet), value, &ret1), ret1))
            U_THROW(::g::Uno::Exception::New2(::STRINGS[33/*"Json.String...*/]));
        ...
        uPtr(sb)->Append2(::STRINGS[34/*"{"*/]);
        uArray* keys = uArray::New(::TYPES[53/*string[]*/], uPtr(uPtr(obj)->Keys())->Length());
        ::g::Uno::Array::Copy1(::TYPES[54/*Uno.Array.Copy<string>*/], obj->Keys(), keys, uPtr(obj->Keys())->Length());

        if (normalized)
            ::g::Uno::Array::Sort1(::TYPES[55/*Uno.Array.Sort<string>*/], keys, uDelegate::New(::TYPES[56/*Uno.Comparison<string>*/], (void*)::g::Uno::String__Compare_fn));
    ...
    else if (uIs(value, ::TYPES[17/*Fuse.Scripting.Array*/]))
    {
        ...
        ::g::Fuse::Scripting::Array* arr = uAs< ::g::Fuse::Scripting::Array*>(value, ::TYPES[17/*Fuse.Scripting.Array*/]);
        ...
        sb->Append2(::STRINGS[39/*"]"*/]);
    }
    else
        uPtr(sb)->Append2(::STRINGS[40/*"null"*/]);
}
...
{
    if (b)
        return ::STRINGS[41/*"true"*/];
    else
        return ::STRINGS[42/*"false"*/];
}
...
{
    if ((double)(int)s == s)
        return ::g::Uno::Int::ToString((int)s, ::TYPES[35/*int*/]);

    return ::g::Uno::Double::ToString(s, ::TYPES[51/*double*/]);
}
...
{
    ::TYPES[57] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    type->SetInterfaces(
...
{
    ctor_(c, obj, p);
    uPtr(c)->ObjectDefineProperty(obj, uPtr(p)->Name().ToString(::TYPES[57/*Uno.UX.Selector*/]), uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)LazyObservableProperty__Get_fn, this), NULL, false, false);
}
...
{
    Marshal::_converters_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[58/*Uno.Collections.List<Fuse.Scripting.Marshal.IConverter>*/]));
    Marshal::AddConverter((uObject*)::g::Fuse::Scripting::FileSourceConverter::New1());
}

static void Marshal_build(uType* type)
{
    ::STRINGS[44] = uString::Const("Unable to convert ");
    ::STRINGS[45] = uString::Const(" to bool");
    ::STRINGS[46] = uString::Const("Expected number was ");
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/scripting/$.uno");
    ::STRINGS[47] = uString::Const("#");
    ::STRINGS[48] = uString::Const(" to float4");
    ::STRINGS[49] = uString::Const("Unable to parse selector value: ");
    ::STRINGS[50] = uString::Const("%");
    ::STRINGS[51] = uString::Const("px");
    ::STRINGS[52] = uString::Const("pt");
    ::STRINGS[53] = uString::Const("Unable to parse size value: ");
    ::STRINGS[54] = uString::Const("Unable to parse size vector: ");
    ::STRINGS[55] = uString::Const("Unable to convert '");
    ::STRINGS[56] = uString::Const("' to type ");
    ::TYPES[58] = ::g::Uno::Collections::List_typeof()->MakeType(Marshal__IConverter_typeof());
    ...
    ::TYPES[34] = ::g::Uno::Float_typeof();
    ::TYPES[35] = ::g::Uno::Int_typeof();
    ::TYPES[60] = ::g::Fuse::Scripting::IArray_typeof();
    ::TYPES[57] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[61] = ::g::Uno::UX::Size_typeof();
    ::TYPES[62] = ::g::Uno::UX::Size2_typeof();
    ::TYPES[63] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[1] = ::g::Uno::Type_typeof();
    type->SetPrecalc(
...
void Marshal__ToType_fn(uType* __type, uObject* o, uTRef __retval)
{
    ...
    if ((Marshal__TryConvertTo1_fn(__types[1], o, &value, &ret4), ret4))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[55/*"Unable to c...*/], o), ::STRINGS[56/*"' to type "*/]), __types[0])));
}
...
bool Marshal::CanConvertClass(uType* t)
{
    ...
    for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        if (Marshal__IConverter::CanConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret3), ret3)), ::TYPES[59/*Fuse.Scripting.Marshal.IConverter*/]), t))
            return true;
...
bool Marshal::ToBool(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[52/*bool*/]))
        return uUnbox<bool>(::TYPES[52/*bool*/], obj);
    else if (uIs(obj, ::TYPES[27/*string*/]))
        return ::g::Uno::Bool::Parse(uCast<uString*>(obj, ::TYPES[27/*string*/]));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[44/*"Unable to c...*/], obj), ::STRINGS[45/*" to bool"*/])));
}
...
double Marshal::ToDouble(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[51/*double*/]))
        return uUnbox<double>(::TYPES[51/*double*/], o);
        ...
        return ::g::Uno::Double::Parse(uCast<uString*>(o, ::TYPES[27/*string*/]));
    else
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[46/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[6/*"/usr/local/...*/], 1016);
        return 0.0;
    }
}
...
{
    Marshal_typeof()->Init();
    float r = (::g::Fuse::Scripting::IArray::Length(uInterface(uPtr(values), ::TYPES[60/*Fuse.Scripting.IArray*/])) > 0) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(values), ::TYPES[60/*Fuse.Scripting.IArray*/]), 0)) : 0.0f;
    float g = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[60/*Fuse.Scripting.IArray*/])) > 1) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[60/*Fuse.Scripting.IArray*/]), 1)) : r;
    float b = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[60/*Fuse.Scripting.IArray*/])) > 2) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[60/*Fuse.Scripting.IArray*/]), 2)) : r;
    float a = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[60/*Fuse.Scripting.IArray*/])) > 3) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[60/*Fuse.Scripting.IArray*/]), 3)) : 1.0f;
...
{
    Marshal_typeof()->Init();
    uObject* aa = uAs<uObject*>(o, ::TYPES[60/*Fuse.Scripting.IArray*/]);
    ...
    if (uIs(o, ::TYPES[27/*string*/]))
    {
        ...
        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[47/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[44/*"Unable to c...*/], o), ::STRINGS[48/*" to float4"*/])));
}
...
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[57/*Uno.UX.Selector*/]))
        return uUnbox< ::g::Uno::UX::Selector>(::TYPES[57/*Uno.UX.Selector*/], o);
    else if (uIs(o, ::TYPES[27/*string*/]))
        return ::g::Uno::UX::Selector__op_Implicit(uCast<uString*>(o, ::TYPES[27/*string*/]));

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[49/*"Unable to p...*/], o)));
}
...
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[62/*Uno.UX.Size2*/]))
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[62/*Uno.UX.Size2*/], o);
    ...
    if (uIs(o, ::TYPES[27/*string*/]))
    {
        ...
        uArray* parts = ::g::Uno::String::Split(uPtr(s), uArray::Init<int>(::TYPES[63/*char[]*/], 1, ','));
    ...
    if (uIs(o, ::TYPES[60/*Fuse.Scripting.IArray*/]))
    {
        uObject* a = (uObject*)o;
        return ::g::Uno::UX::Size2__New1(Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[60/*Fuse.Scripting.IArray*/]), 0)), Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[60/*Fuse.Scripting.IArray*/]), 1)));
    }
...
uObject* Marshal::TryConvertTo(uType* t, uObject* o)
{
    ...
    if (o == NULL)
        return NULL;
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[52/*bool*/]))
        return uBox(::TYPES[52/*bool*/], Marshal::ToBool(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[34/*float*/]))
        return uBox(::TYPES[34/*float*/], Marshal::ToFloat(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[51/*double*/]))
        return uBox(::TYPES[51/*double*/], Marshal::ToDouble(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[35/*int*/]))
        return uBox<int>(::TYPES[35/*int*/], Marshal::ToInt(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[27/*string*/]))
        return ::g::Uno::Object::ToString(uPtr(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[57/*Uno.UX.Selector*/]))
        return uBox(::TYPES[57/*Uno.UX.Selector*/], Marshal::ToSelector(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[30/*float4*/]))
        return uBox(::TYPES[30/*float4*/], Marshal::ToFloat41(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[29/*float3*/]))
        return uBox(::TYPES[29/*float3*/], (ind1 = Marshal::ToFloat41(o), ::g::Uno::Float3__New2(ind1.X, ind1.Y, ind1.Z)));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[28/*float2*/]))
        return uBox(::TYPES[28/*float2*/], (ind2 = Marshal::ToFloat41(o), ::g::Uno::Float2__New2(ind2.X, ind2.Y)));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[61/*Uno.UX.Size*/]))
        return uBox(::TYPES[61/*Uno.UX.Size*/], Marshal::ToSize(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[62/*Uno.UX.Size2*/]))
        return uBox(::TYPES[62/*Uno.UX.Size2*/], Marshal::ToSize2(o));
    else if (::g::Uno::Type::IsEnum(uPtr(t)) && uIs(o, ::TYPES[27/*string*/]))
        return ::g::Uno::Enum::Parse(t, uCast<uString*>(o, ::TYPES[27/*string*/]));
    else

        for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        {
            uObject* res = Marshal__IConverter::TryConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret5), ret5)), ::TYPES[59/*Fuse.Scripting.Marshal.IConverter*/]), t, o);
...
{
    ::STRINGS[24] = uString::Const(" (ScriptMethod)");
    ::STRINGS[57] = uString::Const("(function (cl, callback) { cl.prototype.");
    ::STRINGS[58] = uString::Const(" = function() { callback(this.external_object, Array.prototype.slice.call(arguments)); }})");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[16] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[23] = ::g::Fuse::Scripting::External_typeof();
...
void Context__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Scripting::Context* context)
{
    _m = m;
    _context = context;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(_context)->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[24/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[57/*"(function (...*/], uPtr(m)->Name), ::STRINGS[58/*" = function...*/])), ::TYPES[16/*Fuse.Scripting.Function*/]);
    uPtr(factory)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)Context__MethodClosure__Callback_fn, this)));
}

// private object Callback(object[] args) [instance] :406
uObject* Context__MethodClosure::Callback(uArray* args)
{
    uObject* self = uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[23/*Fuse.Scripting.External*/]))->Object;
    uArray* realArgs = Context__MethodClosure::CopyArgs(uCast< ::g::Fuse::Scripting::Array*>(args->Strong<uObject*>(1), ::TYPES[17/*Fuse.Scripting.Array*/]));
...
{
    ::STRINGS[59] = uString::Const("exports");
    ::STRINGS[60] = uString::Const("disposed");
    ::STRINGS[61] = uString::Const("id");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[64] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetInterfaces(
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[59/*"exports"*/], c->NewObject());
    module->Item(::STRINGS[60/*"disposed"*/], c->NewArray(uArray::New(::TYPES[3/*object[]*/], 0)));
    ...
    {
        if (uIs(__t.Exception, ::TYPES[64/*Fuse.Scripting.ScriptException*/]))
        {
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[61/*"id"*/], id);
...
{
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[59/*"exports"*/]);
    return r;
}
// }
...
{
    ::STRINGS[60] = uString::Const("disposed");
    ::STRINGS[62] = uString::Const("(unknown module)");
    ::TYPES[65] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[66] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[62/*"(unknown mo...*/], void();
}
...
{
    _invalidateCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[65/*Uno.Collections.List<Uno.Action>*/]));
    Context = context;
    Module = mod;
    Object = obj;
    Id = id;
    ...
    if (::g::Uno::String::op_Inequality(Id, NULL))
    {
        ...
        ::g::Uno::UX::Resource::AddGlobalKeyListener(uDelegate::New(::TYPES[66/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
    }

    if (uPtr(Module)->GetFile() != NULL)
    {
        uPtr(uPtr(Module)->GetFile())->add_DataChanged(uDelegate::New(::TYPES[67/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = true;
    }
}
...
void ModuleResult::Dispose()
{
    if (_fileListening)
    {
        uPtr(uPtr(Module)->GetFile())->remove_DataChanged(uDelegate::New(::TYPES[67/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = false;
    }

    if (_globalKeyListening)
    {
        ::g::Uno::UX::Resource::RemoveGlobalKeyListener(uDelegate::New(::TYPES[66/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
...
{
    if (uPtr(Object)->ContainsKey(::STRINGS[60/*"disposed"*/]))
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[60/*"disposed"*/]), ::TYPES[17/*Fuse.Scripting.Array*/]);

        if (disposed != NULL)

            for (int i = 0; i < uPtr(disposed)->Length(); i++)
            {
                ::g::Fuse::Scripting::Function* func = uCast< ::g::Fuse::Scripting::Function*>(uPtr(disposed)->Item(i), ::TYPES[16/*Fuse.Scripting.Function*/]);
...
{
    ::TYPES[68] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array());
    ::TYPES[69] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2, uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[70] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof());
...
{
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[68/*Uno.Collections.Queue<object[]>*/]));
...
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[69/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[70/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}
...
{
    return uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)NativeFunction__NativeFunctionClosure__Callback_fn, NativeFunction__NativeFunctionClosure::New1(_nativeCallback, Context()));
}
...
{
    ::STRINGS[63] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[59] = uString::Const("exports");
    ::TYPES[71] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
    ::TYPES[8] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[72] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[59/*"exports"*/]), ::TYPES[8/*Fuse.Scripting.Object*/]);

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[72/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
    {
        ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[72/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
        uPtr(m)->Create(obj, c);
    }

    if (__this->_func != NULL)
        uPtr(module)->Item(::STRINGS[59/*"exports"*/], uPtr(__this->_func)->CreateCallback());
...
{
    _members = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[71/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/]));
    ctor_();
}
...
{
    if (_isEvaluated)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[63/*"NativeModul...*/]));
...
void NativeModule::add_Evaluated(uDelegate* value)
{
    if (_isEvaluated)
        ...
        _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_evaluated, value), ::TYPES[73/*Uno.EventHandler*/]);
}

// public void remove_Evaluated(Uno.EventHandler value) [instance] :384
void NativeModule::remove_Evaluated(uDelegate* value)
{
    _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_evaluated, value), ::TYPES[73/*Uno.EventHandler*/]);
}
...
{
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_reset, value), ::TYPES[73/*Uno.EventHandler*/]);
}

// public void remove_Reset(Uno.EventHandler value) [instance] :393
void NativeModule::remove_Reset(uDelegate* value)
{
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_reset, value), ::TYPES[73/*Uno.EventHandler*/]);
}
...
{
    ::TYPES[74] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[75] = NativePromise__ContextClosure_typeof();
    ::TYPES[76] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[77] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    type->SetPrecalc(
...
void NativePromise__CreateObject_fn(NativePromise* __this, uObject** __retval)
{
    ...
    return *__retval = uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)NativePromise__ContextClosure__CreatePromise_fn, NativePromise__ContextClosure::New1(__types[0], __this->Context(), __this->_futureFactory, __this->_resultConverter)), void();
}
...
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    uPtr(::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[1], _func, args, future))))->Start();
    return future;
}
...
{
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[78] = ::g::Uno::Func_typeof();
    ::TYPES[79] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
...
void NativeProperty__CreateObject_fn(NativeProperty* __this, uObject** __retval)
{
    if (__this->_isReadonly)
        ...
        uPtr(__this->Context())->ObjectDefineProperty(__this->ModuleObject(), __this->Name(), uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)NativeProperty__GetProperty1_fn, __this), uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)NativeProperty__SetProperty_fn, __this), false, false);
...
{
    ::TYPES[80] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof());
    ::TYPES[2] = ::g::Fuse::Scripting::IObserver_typeof();
    type->SetFields(2,
...
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this)
{
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[80/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
}
...
{
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[81] = ::g::Uno::Short_typeof();
    ::TYPES[35] = ::g::Uno::Int_typeof();
    ::TYPES[82] = ::g::Uno::Long_typeof();
    ::TYPES[34] = ::g::Uno::Float_typeof();
    ::TYPES[51] = ::g::Uno::Double_typeof();
    ::TYPES[40] = ::g::Uno::Exception_typeof();
    type->SetPrecalc(
...
{
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[81/*short*/]))
        return uBox<int16_t>(::TYPES[81/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[35/*int*/]))
        return uBox<int>(::TYPES[35/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[82/*long*/]))
        return uBox<int64_t>(::TYPES[82/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[34/*float*/]))
        return uBox(::TYPES[34/*float*/], (float)value);

    return uBox(::TYPES[51/*double*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[51/*double*/]))
        return uBox(::TYPES[51/*double*/], (double)value);
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[82/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[81/*short*/], value);
}
...
{
    if (uIs(value, ::TYPES[81/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[81/*short*/], value), targetType);

    if (uIs(value, ::TYPES[35/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[35/*int*/], value), targetType);

    if (uIs(value, ::TYPES[82/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[82/*long*/], value), targetType);

    if (uIs(value, ::TYPES[34/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[34/*float*/], value), targetType);

    if (uIs(value, ::TYPES[51/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[51/*double*/], value), targetType);
...
{
    ::TYPES[83] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
...
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_props), &ret4), ret4); enum1.MoveNext(::TYPES[84/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[84/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
        ::g::Fuse::Scripting::ValueMirror* d = uAs< ::g::Fuse::Scripting::ValueMirror*>(p.Value(::TYPES[85/*Uno.Collections.KeyValuePair<string, object>*/]), ::TYPES[4/*Fuse.Scripting.ValueMirror*/]);
...
{
    _props = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[83/*Uno.Collections.Dictionary<string, object>*/]));
    ctor_(obj);
...
{
    ::STRINGS[64] = uString::Const("addSubscriber");
    ::STRINGS[65] = uString::Const("set");
    ::STRINGS[66] = uString::Const("clear");
    ::STRINGS[67] = uString::Const("newAt");
    ::STRINGS[68] = uString::Const("newAll");
    ::STRINGS[69] = uString::Const("add");
    ::STRINGS[70] = uString::Const("removeAt");
    ::STRINGS[71] = uString::Const("insertAt");
    ::STRINGS[72] = uString::Const("removeRange");
    ::STRINGS[73] = uString::Const("insertAll");
    ::STRINGS[74] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[75] = uString::Const("removeSubscriber");
    ::TYPES[86] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[87] = ::g::Uno::Collections::List_typeof()->MakeType(Observable__Subscription_typeof());
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[8] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[27] = ::g::Uno::String_typeof();
    ::TYPES[88] = ::g::Fuse::Scripting::ArrayMirror_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[4] = ::g::Fuse::Scripting::ValueMirror_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::IArray_typeof(), offsetof(::g::Fuse::Scripting::ListMirror_type, interface0));
...
{
    _values = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[86/*Uno.Collections.List<object>*/]));
    _observers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[87/*Uno.Collections.List<Fuse.Scripting.Observable.Subscription>*/]));
    ctor_1(obj);
    _context = context;
    _observable = obj;
    _observeChange = uPtr(context)->CallbackToFunction(uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)Observable__ObserveChange_fn, this));
    uPtr(obj)->CallMethod(::STRINGS[64/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[52/*bool*/], supressCallback)));
}
...
{
    uString* op = uAs<uString*>(uPtr(args)->Strong<uObject*>(1), ::TYPES[27/*string*/]);

    if (::g::Uno::String::op_Equality(op, ::STRINGS[65/*"set"*/]))
    {
        int origin = -1;
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[66/*"clear"*/]))
    {
        int origin1 = -1;
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[67/*"newAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[68/*"newAll"*/]))
    {
        int origin2 = -1;
        ...
        uPtr(_context)->Enqueue(Observable__NewAll::New1(this, uCast< ::g::Fuse::Scripting::ArrayMirror*>(uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(2)), ::TYPES[88/*Fuse.Scripting.ArrayMirror*/]), origin2));
    }
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[69/*"add"*/]))
        uPtr(_context)->Enqueue(Observable__Add::New1(this, uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(2))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[70/*"removeAt"*/]))
        uPtr(_context)->Enqueue(Observable__RemoveAt::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(2))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[71/*"insertAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[72/*"removeRange"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[73/*"insertAll"*/]))
        uPtr(_context)->Enqueue(Observable__InsertAll::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(2)), uCast< ::g::Fuse::Scripting::ArrayMirror*>(uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(3)), ::TYPES[88/*Fuse.Scripting.ArrayMirror*/])));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[74/*"Unhandled o...*/], op)));
...
{
    uPtr(_observable)->CallMethod(::STRINGS[75/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
{
    return Observable::New1(context, uCast< ::g::Fuse::Scripting::Object*>(uPtr(uPtr(context)->Observable())->Call(uArray::New(::TYPES[3/*object[]*/], 0)), ::TYPES[8/*Fuse.Scripting.Object*/]), true);
}
...
{
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[89] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof());
    type->SetInterfaces(
...
void ObservableProperty__UnoUXIPropertyListenerOnPropertyChanged_fn(ObservableProperty* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    uPtr(__this->_context)->Invoke(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)ObservableProperty__PushCapture__Run_fn, ObservableProperty__PushCapture::New1(uDelegate::New(::TYPES[89/*Uno.Action<object>*/], (void*)ObservableProperty__PushValue_fn, __this), uPtr(__this->_property)->GetAsObject())));
}
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[16] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[79] = ::g::Uno::Action1_typeof();
    ::TYPES[90] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetPrecalc(
...
void NativePromise__PromiseClosure__Resolve_fn(NativePromise__PromiseClosure* __this, void* result)
{
    ...
    if (__this->_resolve != NULL)
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(__this->_c)->Dispatcher()), ::TYPES[21/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)NativePromise__PromiseClosure__InternalResolve_fn, __this));
}
...
void NativePromise__PromiseClosure::Reject(::g::Uno::Exception* reason)
{
    ...
    if (_reject != NULL)
        ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(_c)->Dispatcher()), ::TYPES[21/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)NativePromise__PromiseClosure__InternalReject_fn, this));
}
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    if (uPtr(args)->Length() > 0)
        _resolve = uAs< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[16/*Fuse.Scripting.Function*/]);

    if (uPtr(args)->Length() > 1)
        _reject = uAs< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(1), ::TYPES[16/*Fuse.Scripting.Function*/]);

    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[90/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
{
    ::STRINGS[76] = uString::Const("this._raw_");
    ::STRINGS[77] = uString::Const("this._");
    ::STRINGS[78] = uString::Const(" (ScriptProperty)");
    ::STRINGS[79] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[80] = uString::Const("', ");
    ::STRINGS[34] = uString::Const("{");
    ::STRINGS[81] = uString::Const("get: function() { ");
    ::STRINGS[82] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[83] = uString::Const("if (");
    ::STRINGS[84] = uString::Const(" != obs) {");
    ::STRINGS[85] = uString::Const(" = obs;");
    ::STRINGS[86] = uString::Const(" = obs");
    ::STRINGS[87] = uString::Const(";");
    ::STRINGS[37] = uString::Const("}");
    ::STRINGS[88] = uString::Const("return ");
    ::STRINGS[89] = uString::Const("})");
    ::TYPES[16] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[91] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetFields(0,
...
void Context__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Scripting::Context* context)
{
    _context = context;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[76/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[77/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[78/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[79/*"(function(c...*/], p->Name), ::STRINGS[80/*"', "*/]), ::STRINGS[34/*"{"*/]), ::STRINGS[81/*"get: functi...*/]), ::STRINGS[82/*"var obs = g...*/]), ::STRINGS[83/*"if ("*/]), rawField), ::STRINGS[84/*" != obs) {"*/]), rawField), ::STRINGS[85/*" = obs;"*/]), propField), ::STRINGS[86/*" = obs"*/]), p->Modifier), ::STRINGS[87/*";"*/]), ::STRINGS[37/*"}"*/]), ::STRINGS[88/*"return "*/]), propField), ::STRINGS[37/*"}"*/]), ::STRINGS[89/*"})"*/]), ::STRINGS[89/*"})"*/])), ::TYPES[16/*Fuse.Scripting.Function*/]);
    uPtr(definer)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)Context__PropertyClosure__GetObservable_fn, this)));
}

// private object GetObservable(object[] args) [instance] :381
uObject* Context__PropertyClosure::GetObservable(uArray* args)
{
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(::g::Fuse::Scripting::Context::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[91/*Uno.UX.PropertyObject*/]);
...
{
    ::STRINGS[90] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[91] = uString::Const(" provided");
    ::STRINGS[92] = uString::Const("require(): argument must be a string");
    ::STRINGS[93] = uString::Const("require(): module not found: ");
    ::STRINGS[94] = uString::Const("JavaScript error in ");
    ::STRINGS[95] = uString::Const(" was fixed!");
    ::STRINGS[96] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.38.6/$.uno");
    ::STRINGS[97] = uString::Const("Require");
    ::STRINGS[98] = uString::Const(" line ");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[90/*"require(): ...*/], uBox<int>(::TYPES[35/*int*/], uPtr(args)->Length())), ::STRINGS[91/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[27/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[92/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[93/*"require(): ...*/], id)));
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[94/*"JavaScript ...*/], path), ::STRINGS[95/*" was fixed!"*/]), this, ::STRINGS[96/*"/usr/local/...*/], 204, ::STRINGS[97/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[94/*"JavaScript ...*/], path), ::STRINGS[98/*" line "*/]), uBox<int>(::TYPES[35/*int*/], uPtr(e)->LineNumber())), ::STRINGS[99/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[96/*"/usr/local/...*/], 214, ::STRINGS[97/*"Require"*/]);
    ...
    return uPtr(uPtr(module)->Object)->Item(::STRINGS[59/*"exports"*/]);
}
...
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[92/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[92] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ScriptClass_typeof());
    type->SetFields(0,
...
{
    ::STRINGS[100] = uString::Const("Name: ");
    ::STRINGS[101] = uString::Const("Error message: ");
    ::STRINGS[102] = uString::Const("File name: ");
    ::STRINGS[103] = uString::Const("Line number: ");
    ::STRINGS[104] = uString::Const("Source line: ");
    ::STRINGS[105] = uString::Const("JS stack trace: ");
    ::TYPES[35] = ::g::Uno::Int_typeof();
    type->SetFields(3,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[104/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[105/*"JS stack tr...*/]);
...
{
    ::STRINGS[106] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/scripting/$.uno");
    ::STRINGS[107] = uString::Const("Call");
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[93] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[106/*"Cannot call...*/], __this, ::STRINGS[6/*"/usr/local/...*/], 2167, ::STRINGS[107/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[108/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[108] = uString::Const("require(): module contains an error: ");
    ::STRINGS[109] = uString::Const(".js");
    ::STRINGS[14] = uString::Const("");
    ::STRINGS[23] = uString::Const(".");
    ::STRINGS[110] = uString::Const("/");
    ::STRINGS[111] = uString::Const("..");
    ::STRINGS[112] = uString::Const("(function(");
    ::STRINGS[113] = uString::Const(") { ");
    ::STRINGS[114] = uString::Const("\n"
        " })");
    ::STRINGS[115] = uString::Const("Could not evaluate module '");
    ::STRINGS[116] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[59] = uString::Const("exports");
    ::STRINGS[117] = uString::Const("module, exports, require");
    ::STRINGS[118] = uString::Const("/index.js");
    ::TYPES[94] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[63] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[86] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[16] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[38] = ::g::Fuse::Scripting::Callback_typeof();
    ...
    ::TYPES[42] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[43] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[95] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof());
    ::TYPES[96] = ::g::Uno::UX::BundleFileSource_typeof();
    type->SetInterfaces(
...
{
    uArray* newlines = uArray::New(::TYPES[63/*char[]*/], __this->LineNumberOffset());

    for (int i = 0; i < __this->LineNumberOffset(); ++i)
        uPtr(newlines)->Item<uChar>(i) = 10;

    ::g::Uno::Collections::List* args = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[86/*Uno.Collections.List<object>*/]);
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[112/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[113/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[114/*"\n })"*/]);
    ::g::Fuse::Scripting::Function* moduleFunc = uCast< ::g::Fuse::Scripting::Function*>(uPtr(c)->Evaluate(__this->FileName(), wrappedCode), ::TYPES[16/*Fuse.Scripting.Function*/]);

    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[115/*"Could not e...*/], __this->FileName()), ::STRINGS[116/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[59/*"exports"*/]));
    ::g::Uno::Collections::List__Add_fn(args, uDelegate::New(::TYPES[38/*Fuse.Scripting.Callback*/], (void*)ScriptModule__RequireContext__Require_fn, ScriptModule__RequireContext::New1(c, __this, result)));
    return *__retval = ::STRINGS[117/*"module, exp...*/], void();
}
...
{
    return uIs(obj, ::TYPES[94/*Fuse.Scripting.IModuleProvider*/]);
}

// public Uno.IO.Bundle get_Bundle() [instance] :34
::g::Uno::IO::Bundle* ScriptModule::Bundle()
{
    ::g::Uno::UX::BundleFileSource* bfs = uAs< ::g::Uno::UX::BundleFileSource*>(File(), ::TYPES[96/*Uno.UX.BundleFileSource*/]);
...
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[109/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[109/*".js"*/], ::STRINGS[14/*""*/]);

    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[23/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[110/*"/"*/]))
    {
        *isFile = true;
...
uString* ScriptModule::GetSourcePath()
{
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[63/*char[]*/], 1, '/'));
    else
        return ::STRINGS[14/*""*/];
}
...
::g::Uno::IO::BundleFile* ScriptModule::LookForFile(uString* path)
{
    ...
    if (Bundle() != NULL)
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Bundle())->Files()), ::TYPES[41/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[42/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[43/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);

            if (ScriptModule::IsPathEqual(uPtr(f)->SourcePath(), path))
                return f;
        }

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[41/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[42/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* f1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[43/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret5), ret5);
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[95/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[94/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[63/*char[]*/], 1, '/'));

    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[14/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[23/*"."*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[111/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[110/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[109/*".js"*/])))
        return true;

    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[118/*"/index.js"*/])))
        return true;
...
{
    ::STRINGS[119] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[119/*"ScriptPrope...*/]));
...
{
    ::STRINGS[66] = uString::Const("clear");
    ::STRINGS[120] = uString::Const("replaceAllWithOrigin");
    ::STRINGS[121] = uString::Const("Unexpected null object");
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/scripting/$.uno");
    ::STRINGS[122] = uString::Const("SetExclusive");
    ::STRINGS[123] = uString::Const("setValueWithOrigin");
    ::STRINGS[124] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Scripting::IObserver_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[64] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetInterfaces(
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[66/*"clear"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[35/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uType* __type, uArray* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[120/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, sa, uBox<int>(::TYPES[35/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[121/*"Unexpected ...*/], this, ::STRINGS[6/*"/usr/local/...*/], 1490, ::STRINGS[122/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[123/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_context)->Unwrap(newValue), uBox<int>(::TYPES[35/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[64/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[124/*"Failed to s...*/], ex, this, ::STRINGS[6/*"/usr/local/...*/], 1502, ::STRINGS[122/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
{
    if (uIs(obj, ::TYPES[51/*double*/]))
        return uUnbox<double>(::TYPES[51/*double*/], obj);
    ...
    if (uIs(obj, ::TYPES[36/*uint*/]))
        return (double)uUnbox<uint32_t>(::TYPES[36/*uint*/], obj);
