...
// internal sealed extern class Rectangle :1609
// {
...
// public Rectangle(Fuse.Visual visual) :1612
void Rectangle__ctor_2_fn(Rectangle* __this, ::g::Fuse::Visual* visual)
{
    __this->ctor_2(visual);
}

// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) :1698
...
// private static ObjC.Object CreateUIBezierPath() :1671
void Rectangle__CreateUIBezierPath_fn(uObject** __retval)
{
    *__retval = Rectangle::CreateUIBezierPath();
}

// private void Fuse.Controls.Native.IRectangleView.set_CornerRadius(float4 value) :1620
...
// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) [instance] :1698
...
// private void AddLineToPoint(ObjC.Object handle, float x, float y) [instance] :1691
...
// private void ClosePath(ObjC.Object handle) [instance] :1677
...
// private void MoveToPoint(ObjC.Object handle, float x, float y) [instance] :1684
...
// private static ObjC.Object CreateUIBezierPath() [static] :1671
...
// public Rectangle New(Fuse.Visual visual) [static] :1612
