...
static void EdgeSwiper_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Fuse::Motion::Simulation::SmoothSnap_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[2] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[3] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[4] = ::g::Uno::Action_typeof();
    ::TYPES[5] = ::g::Fuse::Motion::Simulation::DestinationSimulation_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float_typeof());
...
// internal sealed class Swiper :856
// {
// static Swiper() :856
...
{
    ::TYPES[11] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Gestures::Internal::SwipeRegion_typeof());
    ::TYPES[2] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[4] = ::g::Uno::Action_typeof();
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[7] = ::g::Fuse::Input::PointerPressedHandler_typeof();
...
// public void SetActivation(Fuse.Gestures.Internal.SwipeRegion region, bool on, [bool bypass]) :1183
...
// private Swiper(Fuse.Elements.Element elm) [instance] :862
...
// public void AddRegion(Fuse.Gestures.Internal.SwipeRegion region) [instance] :902
...
// private void CheckNeedUpdated([bool off]) [instance] :939
...
// public void Detach() [instance] :884
void Swiper::Detach()
{
    _attachCount--;
...
// private void EndInteraction() [instance] :983
...
// private float2 FromWindow(float2 p) [instance] :1030
...
// private void MoveUser(float2 coord, double elapsed, [bool release]) [instance] :1038
...
// private void OnLostCapture() [instance] :974
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :1052
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :1001
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :1151
...
// private void OnRooted(Fuse.Elements.Element n) [instance] :919
...
// private void OnUnrooted() [instance] :930
...
// private void OnUpdated() [instance] :960
...
// public void RemoveRegion(Fuse.Gestures.Internal.SwipeRegion region) [instance] :913
...
// private void RestartMove(float2 currentCoord) [instance] :1045
...
// private Fuse.Gestures.Internal.SwipeRegion SelectRegion(float2 diff, bool force) [instance] :1128
...
// public void SetActivation(Fuse.Gestures.Internal.SwipeRegion region, bool on, [bool bypass]) [instance] :1183
...
// public static Fuse.Gestures.Internal.Swiper AttachSwiper(Fuse.Elements.Element elm) [static] :868
...
// private Swiper New(Fuse.Elements.Element elm) [static] :862
...
// internal sealed class SwipeRegion :672
// {
// static SwipeRegion() :672
...
static void SwipeRegion_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Action_typeof();
    ::TYPES[3] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[12] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Bool_typeof());
    type->SetFields(1,
...
// public generated SwipeRegion() :672
void SwipeRegion__ctor_1_fn(SwipeRegion* __this)
{
    __this->ctor_1();
}

// public float ActivateStrength(float2 diff) :825
...
// public generated SwipeRegion() [instance] :672
...
// public float ActivateStrength(float2 diff) [instance] :825
...
// private void DoRevertActive() [instance] :738
...
// private void DoSwiped() [instance] :747
...
// public bool InteractProgress(float2 diff, double startProgress) [instance] :840
...
// public bool get_IsActive() [instance] :727
bool SwipeRegion::IsActive()
{
    return _isActive;
}

// public void set_IsActive(bool value) [instance] :728
...
// public bool IsPointInside(Fuse.Elements.Element prime, float2 coord) [instance] :805
...
// public bool get_IsSelectable() [instance] :768
bool SwipeRegion::IsSelectable()
{
    return IsStatic() || IsInterruptible;
}

// public bool get_IsStatic() [instance] :763
...
// public double get_Progress() [instance] :677
double SwipeRegion::Progress()
{
    return _progress;
}

// public float ScalarValue(float2 x) [instance] :850
float SwipeRegion::ScalarValue(::g::Uno::Float2 x)
{
    return ::g::Fuse::Internal::VectorUtil::ScalarProjection(x, Direction);
}

// public bool SetProgress(double value, [bool interacting]) [instance] :687
...
// public double get_StableProgress() [instance] :683
double SwipeRegion::StableProgress()
{
    return _stableProgress;
}

// public generated void add_Swiped(Uno.Action<bool> value) [instance] :721
...
// public generated void remove_Swiped(Uno.Action<bool> value) [instance] :721
...
// public generated SwipeRegion New() [static] :672
...
// internal enum SwipeRegionArea :666
