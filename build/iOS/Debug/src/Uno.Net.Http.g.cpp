...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.38.2/$.uno
// -------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Uno.Net.Http/0.38.2/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"Uno.Net.Htt...*/], 1, ::STRINGS[1/*"/usr/local/...*/], 17);
    else
...
void HttpMessageCache::MaxCacheSizeInBytes(int64_t value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[2/*"Uno.Net.Htt...*/], 1, ::STRINGS[1/*"/usr/local/...*/], 30);
    else
...
{
    ::TYPES[1] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    ::TYPES[2] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Net::Http::HttpMessageHandlerRequest_typeof());
    type->SetInterfaces(
...
static void HttpMessageHandlerRequest_build(uType* type)
{
    ...
    ::TYPES[8] = HttpMessageHandlerRequest__DispatchClosure1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[9] = ::g::Uno::Action1_typeof()->MakeType(HttpMessageHandlerRequest_typeof());
    ::TYPES[10] = ::g::Uno::Action2_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::String_typeof());
    ::TYPES[11] = ::g::Uno::Action4_typeof()->MakeType(HttpMessageHandlerRequest_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Bool_typeof());
    type->SetInterfaces(
...
static void HttpStatusReasonPhrase_build(uType* type)
{
    ...
    ::TYPES[12] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    ::TYPES[13] = ::g::Uno::Collections::IDictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
