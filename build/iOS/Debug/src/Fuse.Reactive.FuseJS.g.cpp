...
// internal void UpdateModules(Fuse.Scripting.Context context) :50
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(context)->Evaluate(::STRINGS[0/*"es6-promise"*/], uPtr(::g::FuseReactive_bundle::es6promisef1fde771())->ReadAllText());
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observable8a79544d()))->EvaluateExports(context, ::STRINGS[1/*"FuseJS/Obse...*/]), ::TYPES[0/*Fuse.Scripting.Function*/]);
    uObject* res;
...
// internal void UpdateModules(Fuse.Scripting.Context context) [instance] :50
...
// private sealed class TimerModule.CallbackClosure :335
// {
...
// public CallbackClosure(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) :341
...
// public void Callback() :351
void TimerModule__CallbackClosure__Callback_fn(TimerModule__CallbackClosure* __this)
{
    __this->Callback();
}

// public CallbackClosure New(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) :341
...
// public CallbackClosure(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) [instance] :341
...
// public void Callback() [instance] :351
void TimerModule__CallbackClosure::Callback()
{
    uPtr(_func)->Call(_args);
}

// public CallbackClosure New(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) [static] :341
...
// internal sealed class FunctionClosure :703
// {
...
// public FunctionClosure(Fuse.Scripting.Context context, Uno.Func<Fuse.Scripting.Context, object[], object> callback) :708
...
// public FunctionClosure(Fuse.Scripting.Context context, Uno.Func<Fuse.Scripting.Context, object[], object> callback) [instance] :708
...
// public Fuse.Scripting.Callback get_Callback() [instance] :721
...
// private object function(object[] args) [instance] :714
uObject* FunctionClosure::function(uArray* args)
{
    return uPtr(_callback)->Invoke(2, (::g::Fuse::Scripting::Context*)_context, args);
}

// public FunctionClosure New(Fuse.Scripting.Context context, Uno.Func<Fuse.Scripting.Context, object[], object> callback) [static] :708
...
// private sealed class Http.FuseJSHttpClient :534
// {
...
// public FuseJSHttpClient(Fuse.Scripting.Context context) :541
void Http__FuseJSHttpClient__ctor__fn(Http__FuseJSHttpClient* __this, ::g::Fuse::Scripting::Context* context)
{
    __this->ctor_(context);
}

// private object CreateRequest(object[] args) :550
...
// public FuseJSHttpClient New(Fuse.Scripting.Context context) :541
...
// private object CreateRequest(object[] args) [instance] :550
...
// public generated Fuse.Scripting.Object get_Obj() [instance] :536
::g::Fuse::Scripting::Object* Http__FuseJSHttpClient::Obj()
{
    return _Obj;
}

// private generated void set_Obj(Fuse.Scripting.Object value) [instance] :536
void Http__FuseJSHttpClient::Obj(::g::Fuse::Scripting::Object* value)
{
    _Obj = value;
}

// public FuseJSHttpClient New(Fuse.Scripting.Context context) [static] :541
...
// private sealed class Http.FuseJSHttpRequest :559
// {
...
// public FuseJSHttpRequest(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) :565
...
// private object EnableCache(object[] args) :658
...
// private object GetResponseContentByteArray(object[] args) :696
...
// private object GetResponseReasonPhrase(object[] args) :675
...
// private object GetResponseType(object[] args) :691
...
// private object GetState(object[] args) :670
...
// public FuseJSHttpRequest New(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) :565
...
// private void OnProgress(Uno.Net.Http.HttpMessageHandlerRequest res, int current, int total, bool hastotal) :629
...
// private void OnStateChanged(Uno.Net.Http.HttpMessageHandlerRequest res) :615
...
// private void OnTimeout(Uno.Net.Http.HttpMessageHandlerRequest res) :608
...
// private object SendAsync(object[] args) :636
...
// private object SetResponseType(object[] args) :680
...
// public FuseJSHttpRequest(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) [instance] :565
void Http__FuseJSHttpRequest::ctor_(::g::Fuse::Scripting::Context* context, ::g::Uno::Net::Http::HttpMessageHandlerRequest* req)
{
    ...
    uPtr(Obj())->Item(::STRINGS[8/*"setTimeout"*/], ::g::Fuse::Scripting::JSCallback::FromAction1(::TYPES[9/*Fuse.Scripting.JSCallback.FromAction<int>*/], uDelegate::New(::TYPES[10/*Uno.Action<int>*/], (void*)::g::Uno::Net::Http::HttpMessageHandlerRequest__SetTimeout_fn, uPtr(_req))));
    ...
    uPtr(Obj())->Item(::STRINGS[12/*"abort"*/], ::g::Fuse::Scripting::JSCallback::FromAction(uDelegate::New(::TYPES[11/*Uno.Action*/], (void*)::g::Uno::Net::Http::HttpMessageHandlerRequest__Abort_fn, uPtr(_req))));
    uPtr(Obj())->Item(::STRINGS[13/*"setHeader"*/], ::g::Fuse::Scripting::JSCallback::FromAction2(::TYPES[12/*Fuse.Scripting.JSCallback.FromAction<string, string>*/], uDelegate::New(::TYPES[13/*Uno.Action<string, string>*/], (void*)::g::Uno::Net::Http::HttpMessageHandlerRequest__SetHeader_fn, uPtr(_req))));
    uPtr(Obj())->Item(::STRINGS[14/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc1(::TYPES[14/*Fuse.Scripting.JSCallback.FromFunc<string, string>*/], uDelegate::New(::TYPES[15/*Uno.Func<string, string>*/], (void*)::g::Uno::Net::Http::HttpMessageHandlerRequest__GetResponseHeader_fn, uPtr(_req))));
    uPtr(Obj())->Item(::STRINGS[15/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[16/*Fuse.Scripting.JSCallback.FromFunc<string>*/], uDelegate::New(::TYPES[17/*Uno.Func<string>*/], (void*)::g::Uno::Net::Http::HttpMessageHandlerRequest__GetResponseHeaders_fn, uPtr(_req))));
    ...
    uPtr(Obj())->Item(::STRINGS[17/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[18/*Fuse.Scripting.JSCallback.FromFunc<int>*/], uDelegate::New(::TYPES[19/*Uno.Func<int>*/], (void*)::g::Uno::Net::Http::HttpMessageHandlerRequest__GetResponseStatus_fn, uPtr(_req))));
    ...
    uPtr(Obj())->Item(::STRINGS[19/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[16/*Fuse.Scripting.JSCallback.FromFunc<string>*/], uDelegate::New(::TYPES[17/*Uno.Func<string>*/], (void*)::g::Uno::Net::Http::HttpMessageHandlerRequest__GetResponseContentString_fn, uPtr(_req))));
...
// private object EnableCache(object[] args) [instance] :658
...
// private object GetResponseContentByteArray(object[] args) [instance] :696
uObject* Http__FuseJSHttpRequest::GetResponseContentByteArray(uArray* args)
{
    return uPtr(_req)->GetResponseContentByteArray();
}

// private object GetResponseReasonPhrase(object[] args) [instance] :675
...
// private void OnDone(Uno.Net.Http.HttpMessageHandlerRequest res) [instance] :622
...
// private void OnError(Uno.Net.Http.HttpMessageHandlerRequest res, string error) [instance] :601
...
// private void OnProgress(Uno.Net.Http.HttpMessageHandlerRequest res, int current, int total, bool hastotal) [instance] :629
...
// private void OnStateChanged(Uno.Net.Http.HttpMessageHandlerRequest res) [instance] :615
...
// private void OnTimeout(Uno.Net.Http.HttpMessageHandlerRequest res) [instance] :608
...
// private object SendAsync(object[] args) [instance] :636
...
// private object SetResponseType(object[] args) [instance] :680
...
// public FuseJSHttpRequest New(Fuse.Scripting.Context context, Uno.Net.Http.HttpMessageHandlerRequest req) [static] :565
...
// private object CreateClient(Fuse.Scripting.Context context, object[] args) :529
...
// public override sealed void Evaluate(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result) :524
void Http__Evaluate_fn(Http* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    uPtr(uPtr(result)->Object)->Item(::STRINGS[28/*"exports"*/], ::g::Fuse::Reactive::FuseJS::FunctionClosure::New1(c, uDelegate::New(::TYPES[23/*Uno.Func<Fuse.Scripting.Context, object[], object>*/], (void*)Http__CreateClient_fn, __this))->Callback());
}
...
// private sealed class TimerManager.Timer :433
// {
...
// public Timer(double ms, Uno.Action callback, bool repeat) :448
...
// public Timer(double ms, Uno.Action callback, bool repeat) [instance] :448
...
// private void Start() [instance] :457
...
// internal void Update() [instance] :470
...
// public static double GetMilliseconds() [static] :493
double TimerManager__Timer::GetMilliseconds()
{
    return (double)(::g::Uno::Diagnostics::Clock::GetTicks() / 10000LL);
}

// public Timer New(double ms, Uno.Action callback, bool repeat) [static] :448
...
// internal sealed class TimerManager :358
// {
...
// public generated TimerManager() :358
void TimerManager__ctor__fn(TimerManager* __this)
{
    __this->ctor_();
}

// public int AddTimer(double ms, Uno.Action callback, [bool repeat]) :379
...
// public int AddTimer(double ms, Uno.Action callback, [bool repeat]) [instance] :379
...
// public void DeleteAllTimers() [instance] :387
...
// public bool DeleteTimer(int id) [instance] :395
...
// private Fuse.Reactive.FuseJS.TimerManager.Timer GetTimer(int id) [instance] :415
...
// private void RemoveTimer(int id) [instance] :406
...
// public generated TimerManager New() [static] :358
...
// public sealed class TimerModule :223
// {
...
// public TimerModule() :240
void TimerModule__ctor_2_fn(TimerModule* __this)
{
    __this->ctor_2();
}

// private object Create(Fuse.Scripting.Context context, object[] args) :277
...
// private object Delete(Fuse.Scripting.Context context, object[] args) :318
...
// public TimerModule() [instance] :240
void TimerModule::ctor_2()
{
    ...
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[29/*"create"*/], uDelegate::New(::TYPES[25/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Create_fn, this)));
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[30/*"delete"*/], uDelegate::New(::TYPES[25/*Fuse.Scripting.NativeCallback*/], (void*)TimerModule__Delete_fn, this)));
    add_Reset(uDelegate::New(::TYPES[26/*Uno.EventHandler*/], (void*)TimerModule__OnReset_fn, this));
}

// private object Create(Fuse.Scripting.Context context, object[] args) [instance] :277
...
// private object Delete(Fuse.Scripting.Context context, object[] args) [instance] :318
...
// private void OnReset(object sender, Uno.EventArgs args) [instance] :253
...
// internal void UpdateModule() [instance] :328
...
// public TimerModule New() [static] :240
