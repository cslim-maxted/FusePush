...
// /usr/local/share/uno/Packages/Fuse.Motion/0.38.6/$.uno
// ------------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Motion/0.38.6/$.uno");
...
{
    ::TYPES[5] = ::g::Fuse::Motion::DestinationMotion_typeof()->MakeType(::g::Uno::Float2_typeof());
    ::TYPES[6] = ::g::Fuse::Motion::Simulation::Friction_typeof()->MakeType(::g::Uno::Float2_typeof());
    type->SetFields(0,
