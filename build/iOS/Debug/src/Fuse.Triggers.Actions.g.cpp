...
// /usr/local/share/uno/Packages/Fuse.Elements/0.38.6/triggers/actions/$.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.38.6/triggers/$.uno
// -----------------------------------------------------------------
...
static void DebugAction_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Triggers::Actions::ITaggedDebugProperty_typeof());
...
// public sealed class EvaluateJS :877
// {
static void EvaluateJS_build(uType* type)
{
    ::STRINGS[1] = uString::Const("");
    ::TYPES[6] = ::g::Fuse::Controls::IWebView_typeof();
    ::TYPES[7] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
...
// private void Execute() :921
void EvaluateJS__Execute_fn(EvaluateJS* __this)
{
    __this->Execute();
}

// public generated void add_Handler(Fuse.Triggers.Actions.JSEventHandler value) :883
void EvaluateJS__add_Handler_fn(EvaluateJS* __this, uDelegate* value)
{
    __this->add_Handler(value);
}

// public generated void remove_Handler(Fuse.Triggers.Actions.JSEventHandler value) :883
void EvaluateJS__remove_Handler_fn(EvaluateJS* __this, uDelegate* value)
{
    __this->remove_Handler(value);
}

// protected override sealed void Perform(Fuse.Node target) :908
...
// public generated void add_Handler(Fuse.Triggers.Actions.JSEventHandler value) [instance] :883
...
// public generated void remove_Handler(Fuse.Triggers.Actions.JSEventHandler value) [instance] :883
...
// private void ResultHandler(string result) [instance] :926
...
// public Fuse.Controls.IWebView get_WebView() [instance] :886
uObject* EvaluateJS::WebView()
{
    return _target;
}

// public void set_WebView(Fuse.Controls.IWebView value) [instance] :887
...
// public sealed class JSEventArgs :782
// {
...
// public JSEventArgs New(string resultJson) [static] :785
...
// public delegate void JSEventHandler(object sender, Fuse.Triggers.Actions.JSEventArgs args) :796
...
void Pause__Perform_fn(Pause* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanPause(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/])))
...
void PlayTo__Perform_fn(PlayTo* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanPlayTo(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/])))
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.38.6/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[12] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[13] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[14] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    type->SetFields(8,
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/0.38.6/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    ::g::Fuse::Controls::Navigator* nav = (n == NULL) ? uCast< ::g::Fuse::Controls::Navigator*>(NULL, ::TYPES[17/*Fuse.Controls.Navigator*/]) : uAs< ::g::Fuse::Controls::Navigator*>(uPtr(n)->Parent(), ::TYPES[17/*Fuse.Controls.Navigator*/]);

    if ((v == NULL) || (nav == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"Requires a ...*/], __this, ::STRINGS[6/*"/usr/local/...*/], 283, ::STRINGS[4/*"Perform"*/]);
        return;
    }
...
void Resume__Perform_fn(Resume* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanResume(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/])))
...
void Stop__Perform_fn(Stop* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanStop(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/])))
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[20/*Uno.Action*/], (void*)TransitionLayout__Transition_fn, __this), 1, ::g::Fuse::LayoutPriority::Placement());
}
...
{
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[21] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Controls::WebView_typeof());
    type->SetFields(8);
}
