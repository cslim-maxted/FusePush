...
static uString* STRINGS[69];
static uType* TYPES[117];

namespace g{
namespace Fuse{

// /usr/local/share/uno/Packages/FuseCore/0.38.6/$.uno
// ---------------------------------------------------
...
static void AppBase_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ...
    ::TYPES[4] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[5] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Visual_typeof());
...
// private void OnEnteringBackground(Uno.Platform2.ApplicationState s) :290
void AppBase__OnEnteringBackground_fn(AppBase* __this, int* s)
{
    __this->OnEnteringBackground(*s);
}

// private void OnLowMemory(object s, object a) :295
...
void AppBase::ctor_1()
{
    ...
    ::g::Uno::Platform2::Application::add_EnteringBackground(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)AppBase__OnEnteringBackground_fn, this));
    ::g::Uno::Platform2::Application::add_ReceivedLowMemoryWarning(uDelegate::New(::TYPES[2/*Uno.EventHandler*/], (void*)AppBase__OnLowMemory_fn, this));
...
void AppBase::InvalidateSelection()
{
    ...
    ::g::Fuse::UpdateManager::AddOnceAction(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)AppBase__DoInvalidateSelection_fn, this), 0);
    _isInvalidateSelectionScheduled = true;
}

// private void OnEnteringBackground(Uno.Platform2.ApplicationState s) [instance] :290
void AppBase::OnEnteringBackground(int s)
{
    ::g::Fuse::Resources::DisposalManager::Clean(1);
}

// private void OnLowMemory(object s, object a) [instance] :295
...
// public abstract class Behavior :413
// {
...
// protected generated Behavior() :413
void Behavior__ctor_2_fn(Behavior* __this)
{
    __this->ctor_2();
}

// protected generated Behavior() [instance] :413
...
// public abstract class Binding :425
// {
static void Binding_build(uType* type)
{
    ::STRINGS[4] = uString::Const("double Binding rooting detected");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/$.uno");
...
// protected generated Binding() :425
void Binding__ctor__fn(Binding* __this)
{
    __this->ctor_();
}

// protected virtual void OnRooted() :429
void Binding__OnRooted_fn(Binding* __this)
{
}

// protected virtual void OnUnrooted() :430
void Binding__OnUnrooted_fn(Binding* __this)
{
}

// protected generated Fuse.Node get_Parent() :427
void Binding__get_Parent_fn(Binding* __this, ::g::Fuse::Node** __retval)
{
    *__retval = __this->Parent();
}

// private generated void set_Parent(Fuse.Node value) :427
void Binding__set_Parent_fn(Binding* __this, ::g::Fuse::Node* value)
{
    __this->Parent(value);
}

// internal void Root(Fuse.Node parent) :432
void Binding__Root_fn(Binding* __this, ::g::Fuse::Node* parent)
{
    __this->Root(parent);
}

// internal void Unroot() :441
void Binding__Unroot_fn(Binding* __this)
{
    __this->Unroot();
}

// protected generated Binding() [instance] :425
void Binding::ctor_()
{
}

// protected generated Fuse.Node get_Parent() [instance] :427
::g::Fuse::Node* Binding::Parent()
{
    return _Parent;
}

// private generated void set_Parent(Fuse.Node value) [instance] :427
void Binding::Parent(::g::Fuse::Node* value)
{
    _Parent = value;
}

// internal void Root(Fuse.Node parent) [instance] :432
void Binding::Root(::g::Fuse::Node* parent)
{
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"double Bind...*/], this, ::STRINGS[5/*"/usr/local/...*/], 435, ::STRINGS[6/*"Root"*/]);

    Parent(parent);
    OnRooted();
}

// internal void Unroot() [instance] :441
void Binding::Unroot()
{
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[7/*"double Bind...*/], this, ::STRINGS[5/*"/usr/local/...*/], 444, ::STRINGS[8/*"Unroot"*/]);
...
// internal sealed class CacheFramebuffer :461
// {
...
// public CacheFramebuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) :560
...
// public void Unpin(bool validate) :547
void CacheFramebuffer__Unpin_fn(CacheFramebuffer* __this, bool* validate)
{
    __this->Unpin(*validate);
}

// public generated int get_Width() :555
void CacheFramebuffer__get_Width_fn(CacheFramebuffer* __this, int* __retval)
{
    *__retval = __this->Width();
}

// private generated void set_Width(int value) :555
void CacheFramebuffer__set_Width_fn(CacheFramebuffer* __this, int* value)
{
    __this->Width(*value);
}

// public CacheFramebuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) [instance] :560
...
// internal void Collect() [instance] :480
...
// public void Dispose() [instance] :487
...
// private void EnsurePinned() [instance] :473
...
// public generated Uno.Graphics.FramebufferFlags get_Flags() [instance] :558
int CacheFramebuffer::Flags()
{
    return _Flags;
}

// private generated void set_Flags(Uno.Graphics.FramebufferFlags value) [instance] :558
void CacheFramebuffer::Flags(int value)
{
    _Flags = value;
}

// public generated Uno.Graphics.Format get_Format() [instance] :557
int CacheFramebuffer::Format()
{
    return _Format;
}

// private generated void set_Format(Uno.Graphics.Format value) [instance] :557
void CacheFramebuffer::Format(int value)
{
    _Format = value;
}

// public framebuffer get_Framebuffer() [instance] :501
...
// internal int get_FramesSinceLastUse() [instance] :529
int CacheFramebuffer::FramesSinceLastUse()
{
    return ::g::Fuse::FramebufferPool::Frame() - _lastFrameUsed;
}

// public generated int get_Height() [instance] :556
int CacheFramebuffer::Height()
{
    return _Height;
}

// private generated void set_Height(int value) [instance] :556
void CacheFramebuffer::Height(int value)
{
    _Height = value;
}

// public bool get_IsContentValid() [instance] :511
...
// public bool get_IsPinned() [instance] :467
bool CacheFramebuffer::IsPinned()
{
    return _isPinned;
}

// public void Pin() [instance] :535
...
// public void Unpin(bool validate) [instance] :547
...
// public generated int get_Width() [instance] :555
int CacheFramebuffer::Width()
{
    return _Width;
}

// private generated void set_Width(int value) [instance] :555
void CacheFramebuffer::Width(int value)
{
    _Width = value;
}

// public CacheFramebuffer New(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) [static] :560
...
// private sealed class Node.CallFuncClosure :3752
// {
...
// public CallFuncClosure(Fuse.Scripting.Function func, object arg) :3756
...
// public CallFuncClosure New(Fuse.Scripting.Function func, object arg) :3756
...
// public void Run() :3762
void Node__CallFuncClosure__Run_fn(Node__CallFuncClosure* __this)
{
    __this->Run();
}

// public CallFuncClosure(Fuse.Scripting.Function func, object arg) [instance] :3756
...
// public void Run() [instance] :3762
void Node__CallFuncClosure::Run()
{
    uPtr(_func)->Call(uArray::Init<uObject*>(::TYPES[10/*object[]*/], 1, (uObject*)_arg));
}

// public CallFuncClosure New(Fuse.Scripting.Function func, object arg) [static] :3756
...
// public enum Visual.CancelInteractionsType :5521
...
// public sealed class Diagnostic :592
// {
...
// public Diagnostic(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) :627
...
// public Diagnostic New(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) :627
...
// public override sealed string ToString() :639
...
// internal Uno.Diagnostics.DebugMessageType get_UnoType() :604
void Diagnostic__get_UnoType_fn(Diagnostic* __this, int* __retval)
{
    *__retval = __this->UnoType();
}

// public Diagnostic(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) [instance] :627
...
// internal Uno.Diagnostics.DebugMessageType get_UnoType() [instance] :604
...
// public Diagnostic New(Fuse.DiagnosticType type, string message, object sourceObject, string filePath, int lineNumber, string memberName, [Uno.Exception exception]) [static] :627
...
// public delegate void DiagnosticHandler(Fuse.Diagnostic d) :669
...
// public static class Diagnostics :689
// {
static void Diagnostics_build(uType* type)
{
    ...
    ::STRINGS[0] = uString::Const("");
    ::TYPES[11] = ::g::Fuse::DiagnosticHandler_typeof();
    type->SetFields(0,
...
// public static void Deprecated(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :784
...
// public static generated void add_DiagnosticReported(Fuse.DiagnosticHandler value) :691
void Diagnostics__add_DiagnosticReported_fn(uDelegate* value)
{
    Diagnostics::add_DiagnosticReported(value);
}

// public static generated void remove_DiagnosticReported(Fuse.DiagnosticHandler value) :691
void Diagnostics__remove_DiagnosticReported_fn(uDelegate* value)
{
    Diagnostics::remove_DiagnosticReported(value);
}

// public static void InternalError(string msg, [object obj], [string filePath], [int lineNumber], [string memberName]) :766
...
// private static void Report(Fuse.Diagnostic d) :693
void Diagnostics__Report_fn(::g::Fuse::Diagnostic* d)
{
    Diagnostics::Report(d);
}

// public static void UnknownException(string msg, Uno.Exception ex, object obj, [string filePath], [int lineNumber], [string memberName]) :777
...
// public static void Unsupported(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :791
...
// public static void UserError(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :707
...
// public static void UserRootError(string expectedType, object actualParent, object obj, [string filePath], [int lineNumber], [string memberName]) :754
...
// internal static void UserScriptError(string msg, Fuse.Scripting.ScriptException ex, object obj, [string filePath], [int lineNumber], [string memberName]) :714
...
// public static void UserSuccess(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :727
...
// private static string UserTypeOf(object a) :739
void Diagnostics__UserTypeOf_fn(uObject* a, uString** __retval)
{
    *__retval = Diagnostics::UserTypeOf(a);
}

// public static void UserWarning(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :812
...
// public static void Deprecated(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :784
...
// public static void InternalError(string msg, [object obj], [string filePath], [int lineNumber], [string memberName]) [static] :766
...
// private static void Report(Fuse.Diagnostic d) [static] :693
...
// public static void UnknownException(string msg, Uno.Exception ex, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :777
...
// public static void Unsupported(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :791
...
// public static void UserError(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :707
...
// public static void UserRootError(string expectedType, object actualParent, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :754
...
// internal static void UserScriptError(string msg, Fuse.Scripting.ScriptException ex, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :714
...
// public static void UserSuccess(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :727
...
// private static string UserTypeOf(object a) [static] :739
...
// public static void UserWarning(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :812
...
// public static generated void add_DiagnosticReported(Fuse.DiagnosticHandler value) [static] :691
void Diagnostics::add_DiagnosticReported(uDelegate* value)
{
    Diagnostics::DiagnosticReported1_ = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Diagnostics::DiagnosticReported1_, value), ::TYPES[11/*Fuse.DiagnosticHandler*/]);
}

// public static generated void remove_DiagnosticReported(Fuse.DiagnosticHandler value) [static] :691
void Diagnostics::remove_DiagnosticReported(uDelegate* value)
{
    Diagnostics::DiagnosticReported1_ = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Diagnostics::DiagnosticReported1_, value), ::TYPES[11/*Fuse.DiagnosticHandler*/]);
}
// }
...
// public enum DiagnosticType :578
...
// public sealed class DrawContext :856
// {
static void DrawContext_build(uType* type)
{
    ...
    ::TYPES[12] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::IRenderViewport_typeof());
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::RenderTargetEntry_typeof());
    ::TYPES[14] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int4_typeof());
    ::TYPES[15] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Graphics::PolygonFace_typeof());
    ::TYPES[16] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Fuse::IFlush_typeof());
    ::TYPES[17] = ::g::Uno::Collections::HashSet__Enumerator_typeof()->MakeType(::g::Fuse::IFlush_typeof());
    ::TYPES[18] = ::g::Fuse::IFlush_typeof();
    ::TYPES[19] = ::g::Fuse::IRenderViewport_typeof();
    ::TYPES[20] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::RenderTargetEntry_typeof());
    ::TYPES[21] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Uno::Int4_typeof());
    ::TYPES[22] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::IRenderViewport_typeof());
...
// internal Fuse.RenderTargetEntry GetRenderTargetEntry() :984
...
// public void PushRenderTargetFrustum(framebuffer fb, Fuse.IFrustum frustum) :1030
...
// public Uno.Recti get_Scissor() :1068
void DrawContext__get_Scissor_fn(DrawContext* __this, ::g::Uno::Recti* __retval)
{
    *__retval = __this->Scissor();
}

// internal void set_Scissor(Uno.Recti value) :1076
void DrawContext__set_Scissor_fn(DrawContext* __this, ::g::Uno::Recti* value)
{
    __this->Scissor(*value);
}

// public Fuse.IRenderViewport get_Viewport() :862
void DrawContext__get_Viewport_fn(DrawContext* __this, uObject** __retval)
{
    *__retval = __this->Viewport();
}

// public float get_ViewportPixelsPerPoint() :1163
void DrawContext__get_ViewportPixelsPerPoint_fn(DrawContext* __this, float* __retval)
{
    *__retval = __this->ViewportPixelsPerPoint();
}

// public DrawContext(Fuse.IRenderViewport viewport) [instance] :889
void DrawContext::ctor_(uObject* viewport)
{
    _viewports = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[12/*Uno.Collections.List<Fuse.IRenderViewport>*/]));
    _renderTargets = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[13/*Uno.Collections.List<Fuse.RenderTargetEntry>*/]));
    _glScissors = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[14/*Uno.Collections.List<int4>*/]));
    _cullFaces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[15/*Uno.Collections.List<Uno.Graphics.PolygonFace>*/]));
...
// public void AddFlushListener(Fuse.IFlush f) [instance] :902
void DrawContext::AddFlushListener(uObject* f)
{
    bool ret4;

    if (flushSet == NULL)
        flushSet = ((::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[16/*Uno.Collections.HashSet<Fuse.IFlush>*/]));

    ::g::Uno::Collections::HashSet__Add_fn(uPtr(flushSet), f, &ret4);
}

// internal void CaptureRootbuffer() [instance] :918
void DrawContext::CaptureRootbuffer()
{
    ::g::OpenGL::GL::Enable(3089);
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 923, ::STRINGS[24/*"CaptureRoot...*/]);
...
// private void CheckGLError([string filePath], [int lineNumber], [string memberName]) [instance] :1189
...
// public void Clear(float4 color, [float depth]) [instance] :1054
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1062, ::STRINGS[25/*"Clear"*/]);
}

// public Uno.Graphics.PolygonFace get_CullFace() [instance] :1175
int DrawContext::CullFace()
{
    return _cullFace;
}

// public void Flush() [instance] :908
void DrawContext::Flush()
{
    ...
    if (flushSet != NULL)
    {
        for (::g::Uno::Collections::HashSet__Enumerator<uStrong<uObject*> > enum1 = (::g::Uno::Collections::HashSet__GetEnumerator_fn(uPtr(flushSet), &ret5), ret5); enum1.MoveNext(::TYPES[17/*Uno.Collections.HashSet<Fuse.IFlush>.Enumerator*/]); )
        {
            uObject* f = enum1.Current(::TYPES[17/*Uno.Collections.HashSet<Fuse.IFlush>.Enumerator*/]);
            ::g::Fuse::IFlush::Flush(uInterface(uPtr(f), ::TYPES[18/*Fuse.IFlush*/]), this);
        }
...
// public float4x4 GetLocalToClipTransform(Fuse.Visual n) [instance] :879
...
// internal Fuse.RenderTargetEntry GetRenderTargetEntry() [instance] :984
...
// private extern OpenGL.GLFramebufferHandle get_GLFramebuffer() [instance] :966
uint32_t DrawContext::GLFramebuffer()
{
    return _glFramebuffer;
}

// private extern void set_GLFramebuffer(OpenGL.GLFramebufferHandle value) [instance] :976
void DrawContext::GLFramebuffer(uint32_t value)
{
    _glFramebuffer = value;
    ::g::OpenGL::GL::BindFramebuffer(36160, value);
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 980, ::STRINGS[33/*"set_GLFrame...*/]);
}

// private int4 get_GLScissor() [instance] :1086
::g::Uno::Int4 DrawContext::GLScissor()
{
    return _glScissor;
}

// private void set_GLScissor(int4 value) [instance] :1097
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    _glScissor = value;
    ::g::OpenGL::GL::Scissor(value.Item(0), value.Item(1), value.Item(2), value.Item(3));
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1103, ::STRINGS[34/*"set_GLScissor"*/]);
}

// public int2 get_GLViewportPixelSize() [instance] :1130
...
// private void set_GLViewportPixelSize(int2 value) [instance] :1141
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1147, ::STRINGS[35/*"set_GLViewp...*/]);
}

// public generated bool get_IsCaching() [instance] :1169
bool DrawContext::IsCaching()
{
    return _IsCaching;
}

// public generated void set_IsCaching(bool value) [instance] :1169
void DrawContext::IsCaching(bool value)
{
    _IsCaching = value;
}

// public void PopRenderTarget() [instance] :1016
void DrawContext::PopRenderTarget()
{
    ::g::Fuse::RenderTargetEntry* ret7;
    Flush();
    ::g::Fuse::RenderTargetEntry* old = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[20/*Uno.Collections.IListExtensions.RemoveLast<Fuse.RenderTargetEntry>*/], (uObject*)_renderTargets, &ret7), ret7);
    _renderTarget = uPtr(old)->RenderTarget;
    GLFramebuffer(uPtr(old)->GLFramebuffer);
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1024, ::STRINGS[26/*"PopRenderTa...*/]);
    GLViewportPixelSize(old->GLViewportPixelSize);
    GLScissor(old->GLScissor);
}

// public void PopRenderTargetFrustum() [instance] :1042
...
// public void PopScissor() [instance] :1116
void DrawContext::PopScissor()
{
    ::g::Uno::Int4 ret8;
    ::g::Uno::Int4 s = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[21/*Uno.Collections.IListExtensions.RemoveLast<int4>*/], (uObject*)_glScissors, &ret8), ret8);
    GLScissor(s);
}

// public void PopViewport() [instance] :873
void DrawContext::PopViewport()
{
    uObject* ret9;
    Flush();
    _viewport = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[22/*Uno.Collections.IListExtensions.RemoveLast<Fuse.IRenderViewport>*/], (uObject*)_viewports, &ret9), ret9);
}

// public void PushRenderTarget(framebuffer fb) [instance] :992
void DrawContext::PushRenderTarget(::g::Uno::Graphics::Framebuffer* fb)
{
    PushRenderTarget1(uPtr(fb)->RenderTarget());
}

// public void PushRenderTarget(Uno.Graphics.RenderTarget rt) [instance] :997
...
// private void PushRenderTarget(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glscissor) [instance] :1002
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[5/*"/usr/local/...*/], 1009, ::STRINGS[27/*"PushRenderT...*/]);
    _renderTarget = rt;
    GLViewportPixelSize(viewportPixelSize);
    GLScissor(glscissor);
}

// public void PushRenderTargetFrustum(framebuffer fb, Fuse.IFrustum frustum) [instance] :1030
...
// public void PushScissor(Uno.Recti scissor) [instance] :1110
...
// public void PushViewport(Fuse.IRenderViewport v) [instance] :866
...
// internal void ReleaseRootbuffer() [instance] :935
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unpopped Sc...*/], this, ::STRINGS[5/*"/usr/local/...*/], 940, ::STRINGS[29/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Cu...*/], this, ::STRINGS[5/*"/usr/local/...*/], 944, ::STRINGS[29/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[31/*"Unpopped Vi...*/], this, ::STRINGS[5/*"/usr/local/...*/], 948, ::STRINGS[29/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[32/*"Unpopped Re...*/], this, ::STRINGS[5/*"/usr/local/...*/], 952, ::STRINGS[29/*"ReleaseRoot...*/]);

    uPtr(_renderTargets)->Clear();
}

// public Uno.Graphics.RenderTarget get_RenderTarget() [instance] :960
::g::Uno::Graphics::RenderTarget* DrawContext::RenderTarget()
{
    return _renderTarget;
}

// public Uno.Recti get_Scissor() [instance] :1068
...
// internal void set_Scissor(Uno.Recti value) [instance] :1076
...
// public Fuse.IRenderViewport get_Viewport() [instance] :862
uObject* DrawContext::Viewport()
{
    return _viewport;
}

// public float get_ViewportPixelsPerPoint() [instance] :1163
...
// public DrawContext New(Fuse.IRenderViewport viewport) [static] :889
...
// internal sealed class DrawHelpers :4863
// {
...
// public generated DrawHelpers() :4863
void DrawHelpers__ctor__fn(DrawHelpers* __this)
{
    __this->ctor_();
}

// internal void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float4x4 transform, float lineWidth, float4 color) :4877
...
// private generated void init_DrawCalls() :4863
void DrawHelpers__init_DrawCalls_fn(DrawHelpers* __this)
{
    __this->init_DrawCalls();
}

// public generated DrawHelpers New() :4863
void DrawHelpers__New1_fn(DrawHelpers** __retval)
{
    *__retval = DrawHelpers::New1();
}

// internal static Fuse.DrawHelpers get_Singelton() :4869
...
// public generated DrawHelpers() [instance] :4863
void DrawHelpers::ctor_()
{
    init_DrawCalls();
}

// internal void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float4x4 transform, float lineWidth, float4 color) [instance] :4877
...
// private generated void init_DrawCalls() [instance] :4863
...
// public generated DrawHelpers New() [static] :4863
...
// internal static Fuse.DrawHelpers get_Singelton() [static] :4869
...
// public sealed class FastMatrix :1764
// {
...
// public void AppendFastMatrix(Fuse.FastMatrix fm) [instance] :1943
...
// public void AppendRotation(float zRadians) [instance] :1826
...
// public void AppendRotationQuaternion(float4 q) [instance] :1900
...
// public void AppendScale(float factor) [instance] :1838
...
// public void AppendScale(float3 scale) [instance] :1894
...
// public void AppendShear(float xRadians, float yRadians) [instance] :1856
...
// public void AppendTranslation(float x, float y, float z) [instance] :1802
...
// public float4x4 get_Matrix() [instance] :1767
::g::Uno::Float4x4 FastMatrix::Matrix()
{
    return _matrix;
}

// public Fuse.FastMatrix Mul(Fuse.FastMatrix m) [instance] :1869
...
// public void PrependFastMatrix(Fuse.FastMatrix fm) [instance] :1928
...
// public void PrependRotation(float zRadians) [instance] :1832
...
// public void PrependRotationQuaternion(float4 q) [instance] :1917
...
// public void PrependScale(float factor) [instance] :1844
...
// public void PrependScale(float3 scale) [instance] :1911
...
// public void PrependShear(float xRadians, float yRadians) [instance] :1850
...
// public void PrependTranslation(float x, float y, float z) [instance] :1814
...
// public void PrependTranslation(float3 offset) [instance] :1923
...
// public void ResetIdentity() [instance] :1789
void FastMatrix::ResetIdentity()
{
    _matrix = ::g::Uno::Float4x4__Identity();
}

// private void SimpleTranslation(float x, float y, float z) [instance] :1862
...
// public static Fuse.FastMatrix FromFloat4x4(float4x4 m) [static] :1794
...
// public static Fuse.FastMatrix Identity() [static] :1782
FastMatrix* FastMatrix::Identity()
{
    return FastMatrix::New1();
}

// private FastMatrix New() [static] :1771
...
// private FastMatrix New(Fuse.FastMatrix orig) [static] :1776
...
// internal enum FastProperty1 :4999
...
// public FastProperty1Link(Fuse.FastProperty1 p) :5046
void FastProperty1Link__ctor__fn(FastProperty1Link* __this, int* p)
{
    __this->ctor_(*p);
}

// public FastProperty1Link(Fuse.FastProperty1 p) [instance] :5046
...
// internal sealed class FastProperty1Link<T> :5052
// {
...
// public FastProperty1Link(Fuse.FastProperty1 p, T value) :5055
...
// public FastProperty1Link New(Fuse.FastProperty1 p, T value) :5055
...
// internal enum FastProperty2 :5172
...
// public FastProperty2Link(Fuse.FastProperty2 p) :5199
void FastProperty2Link__ctor__fn(FastProperty2Link* __this, int* p)
{
    __this->ctor_(*p);
}

// public FastProperty2Link(Fuse.FastProperty2 p) [instance] :5199
...
// internal sealed class FastProperty2Link<T> :5205
// {
...
// public FastProperty2Link(Fuse.FastProperty2 p, T value) :5208
...
// public FastProperty2Link New(Fuse.FastProperty2 p, T value) :5208
...
// internal sealed class FixedViewport :2754
// {
static void FixedViewport_build(uType* type)
{
    ::TYPES[25] = ::g::Fuse::IFrustum_typeof();
    type->SetInterfaces(
...
// public FixedViewport(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) :2793
...
// public FixedViewport New(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) :2793
...
// public float4x4 get_ProjectionTransform() :2767
...
// public float4x4 get_ViewTransform() :2775
void FixedViewport__get_ViewTransform_fn(FixedViewport* __this, ::g::Uno::Float4x4* __retval)
{
    *__retval = __this->ViewTransform();
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :2786
...
// public FixedViewport(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) [instance] :2793
...
// public float2 get_PixelSize() [instance] :2762
::g::Uno::Float2 FixedViewport::PixelSize()
{
    return _pixelSize;
}

// public float get_PixelsPerPoint() [instance] :2757
float FixedViewport::PixelsPerPoint()
{
    return _pixelsPerPoint;
}

// public Uno.Geometry.Ray PointToWorldRay(float2 pointPos) [instance] :2782
...
// public float4x4 get_ProjectionTransform() [instance] :2767
::g::Uno::Float4x4 FixedViewport::ProjectionTransform()
{
    return uPtr(_frustumViewport)->ProjectionTransform;
}

// public float2 get_Size() [instance] :2759
::g::Uno::Float2 FixedViewport::Size()
{
    return ::g::Uno::Float2__op_Division1(PixelSize(), PixelsPerPoint());
}

// public float3 get_ViewOrigin() [instance] :2779
::g::Uno::Float3 FixedViewport::ViewOrigin()
{
    return ::g::Fuse::IFrustum::GetWorldPosition(uInterface(uPtr(_frustum), ::TYPES[25/*Fuse.IFrustum*/]), (uObject*)this);
}

// public float4x4 get_ViewProjectionTransform() [instance] :2771
::g::Uno::Float4x4 FixedViewport::ViewProjectionTransform()
{
    return uPtr(_frustumViewport)->ViewProjectionTransform;
}

// public float4x4 get_ViewTransform() [instance] :2775
::g::Uno::Float4x4 FixedViewport::ViewTransform()
{
    return uPtr(_frustumViewport)->ViewTransform;
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [instance] :2786
...
// public FixedViewport New(int2 pixelSize, float pixelsPerPoint, Fuse.IFrustum frustum) [static] :2793
...
// private enum LayoutParams.Flags :2852
...
// public sealed class Font :1987
// {
// static Font() :1987
static void Font__cctor__fn(uType* __type)
{
    Font::_fontFaces_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[26/*Uno.Collections.Dictionary<Uno.UX.FileSource, Uno.Content.Fonts.FontFace>*/]));
}

static void Font_build(uType* type)
{
    ::TYPES[26] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), ::g::Uno::Content::Fonts::FontFace_typeof());
    type->SetFields(0,
...
// public Font(Uno.UX.FileSource file) [instance] :2037
void Font::ctor_(::g::Uno::UX::FileSource* file)
{
    _file = file;
}

// internal Uno.UX.FileSource get_File() [instance] :1993
::g::Uno::UX::FileSource* Font::File()
{
    return _file;
}

// public Font New(Uno.UX.FileSource file) [static] :2037
...
// public static Fuse.Font get_PlatformDefault() [static] :2049
Font* Font::PlatformDefault()
{
    Font_typeof()->Init();

    if (Font::_fallback() == NULL)
        Font::_fallback() = Font::New1(::g::Uno::UX::BundleFileSource::New1(::g::FuseCore_bundle::RobotoRegularf890a122()));

    return Font::_fallback();
}

// public static float get_PlatformDefaultSize() [static] :2061
...
// public static float4 get_PlatformDefaultTextColor() [static] :2071
...
// public static class FramebufferPool :2092
// {
...
// private static void EnsurePool() :2096
void FramebufferPool__EnsurePool_fn()
{
    FramebufferPool::EnsurePool();
}

// internal static int get_Frame() :2128
void FramebufferPool__get_Frame_fn(int* __retval)
{
    *__retval = FramebufferPool::Frame();
}

// public static framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) :2114
...
// public static framebuffer Lock(int2 size, Uno.Graphics.Format format, bool depth) :2110
...
// private static void EnsurePool() [static] :2096
...
// public static framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) [static] :2114
...
// public static framebuffer Lock(int2 size, Uno.Graphics.Format format, bool depth) [static] :2110
...
// internal static void Register(Fuse.CacheFramebuffer cfb) [static] :2098
...
// public static void Release(framebuffer fb) [static] :2120
...
// internal static void UnRegister(Fuse.CacheFramebuffer cfb) [static] :2104
...
// internal static int get_Frame() [static] :2128
...
// internal sealed class FramebufferPoolImpl :2137
// {
static void FramebufferPoolImpl_build(uType* type)
{
    ...
    ::TYPES[27] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof());
    ::TYPES[28] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), ::g::Uno::Int_typeof());
    ::TYPES[29] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof());
    ::TYPES[30] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof());
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[31] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof());
    type->SetInterfaces(
...
// public FramebufferPoolImpl() :2139
void FramebufferPoolImpl__ctor__fn(FramebufferPoolImpl* __this)
{
    __this->ctor_();
}

// private void CollectCacheFramebuffers() :2226
void FramebufferPoolImpl__CollectCacheFramebuffers_fn(FramebufferPoolImpl* __this)
{
    __this->CollectCacheFramebuffers();
}

// private framebuffer FindBuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) :2157
...
// private void Fuse.Resources.ISoftDisposable.SoftDispose() :2258
...
// internal framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) :2280
...
void FramebufferPoolImpl::ctor_()
{
    ...
    ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)FramebufferPoolImpl__Update_fn, this), 0);
    ::g::Fuse::Resources::DisposalManager::Add1((uObject*)this);
}

// private void CollectCacheFramebuffers() [instance] :2226
...
// private framebuffer FindBuffer(int width, int height, Uno.Graphics.Format format, Uno.Graphics.FramebufferFlags flags) [instance] :2157
...
// internal framebuffer Lock(int width, int height, Uno.Graphics.Format format, bool depth) [instance] :2280
...
// internal void Register(Fuse.CacheFramebuffer cfb) [instance] :2198
...
// internal void Release(framebuffer fb) [instance] :2288
...
// internal void UnRegister(Fuse.CacheFramebuffer cfb) [instance] :2219
...
// public void Update() [instance] :2298
...
// public FramebufferPoolImpl New() [static] :2139
...
// internal sealed class FrustumViewport :2672
// {
...
// public generated FrustumViewport() :2672
void FrustumViewport__ctor__fn(FrustumViewport* __this)
{
    __this->ctor_();
}

// public static float2 LocalPlaneIntersection(Uno.Geometry.Ray local) :2745
...
// public generated FrustumViewport New() :2672
void FrustumViewport__New1_fn(FrustumViewport** __retval)
{
    *__retval = FrustumViewport::New1();
}

// public static Uno.Geometry.Ray PointToWorldRay(Fuse.IViewport viewport, float4x4 viewProjectionInverse, float2 pointPos) :2716
...
// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum) :2681
void FrustumViewport__Update_fn(FrustumViewport* __this, uObject* viewport, uObject* frustum)
{
    __this->Update(viewport, frustum);
}

// public static Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport viewport, Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :2731
...
// public generated FrustumViewport() [instance] :2672
void FrustumViewport::ctor_()
{
}

// public void Update(Fuse.IViewport viewport, Fuse.IFrustum frustum) [instance] :2681
void FrustumViewport::Update(uObject* viewport, uObject* frustum)
{
    ProjectionTransform = ::g::Fuse::IFrustum::GetProjectionTransform(uInterface(uPtr(frustum), ::TYPES[25/*Fuse.IFrustum*/]), viewport);
    ProjectionTransformInverse = ::g::Fuse::IFrustum::GetProjectionTransformInverse(uInterface(frustum, ::TYPES[25/*Fuse.IFrustum*/]), viewport);
    ViewTransform = ::g::Fuse::IFrustum::GetViewTransform(uInterface(frustum, ::TYPES[25/*Fuse.IFrustum*/]), viewport);
    ViewTransformInverse = ::g::Fuse::IFrustum::GetViewTransformInverse(uInterface(frustum, ::TYPES[25/*Fuse.IFrustum*/]), viewport);
...
// public static float2 LocalPlaneIntersection(Uno.Geometry.Ray local) [static] :2745
...
// public generated FrustumViewport New() [static] :2672
...
// public static Uno.Geometry.Ray PointToWorldRay(Fuse.IViewport viewport, float4x4 viewProjectionInverse, float2 pointPos) [static] :2716
...
// public static Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport viewport, Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [static] :2731
...
// private sealed class TranslationModes.HeightMode :9658
// {
...
// public generated HeightMode() :9658
void TranslationModes__HeightMode__ctor_1_fn(TranslationModes__HeightMode* __this)
{
    __this->ctor_1();
}

// public override sealed float3 GetAbsVector(Fuse.Translation t) :9660
...
// public generated HeightMode New() :9658
...
// public generated HeightMode() [instance] :9658
void TranslationModes__HeightMode::ctor_1()
{
    ctor_();
}

// public generated HeightMode New() [static] :9658
...
// public delegate void HitTestCallback(Fuse.HitTestResult result) :2478
...
// public sealed class HitTestContext :2491
// {
...
// public HitTestContext(float2 windowPoint, Fuse.HitTestCallback callback) :2553
...
// public Uno.Geometry.Ray PushWorldRay(Uno.Geometry.Ray n) :2513
...
// public Fuse.HitTestCallback get_Callback() [instance] :2528
uDelegate* HitTestContext::Callback()
{
    return _callback;
}

// public void Dispose() [instance] :2560
void HitTestContext::Dispose()
{
    _callback = NULL;
}

// public void Hit(Fuse.Visual obj) [instance] :2531
...
// public void Hit(Fuse.Visual obj, float hitDistance) [instance] :2541
...
// public float2 get_LocalPoint() [instance] :2496
::g::Uno::Float2 HitTestContext::LocalPoint()
{
    return _localPoint;
}

// public void PopLocalPoint(float2 lp) [instance] :2505
void HitTestContext::PopLocalPoint(::g::Uno::Float2 lp)
{
    _localPoint = lp;
}

// public float2 PushLocalPoint(float2 lp) [instance] :2498
...
// public Uno.Geometry.Ray PushWorldRay(Uno.Geometry.Ray n) [instance] :2513
...
// public generated float2 get_WindowPoint() [instance] :2493
::g::Uno::Float2 HitTestContext::WindowPoint()
{
    return _WindowPoint;
}

// private generated void set_WindowPoint(float2 value) [instance] :2493
void HitTestContext::WindowPoint(::g::Uno::Float2 value)
{
    _WindowPoint = value;
}

// public Uno.Geometry.Ray get_WorldRay() [instance] :2511
::g::Uno::Geometry::Ray HitTestContext::WorldRay()
{
    return _worldRay;
}

// public HitTestContext New(float2 windowPoint, Fuse.HitTestCallback callback) [static] :2553
...
// public generated HitTestRecord() :5398
void Visual__HitTestRecord__ctor__fn(Visual__HitTestRecord* __this)
{
    __this->ctor_();
}

// public void HitTestCallback(Fuse.HitTestResult result) :5401
...
// public generated HitTestRecord New() :5398
void Visual__HitTestRecord__New1_fn(Visual__HitTestRecord** __retval)
{
    *__retval = Visual__HitTestRecord::New1();
}

// public generated HitTestRecord() [instance] :5398
void Visual__HitTestRecord::ctor_()
{
}

// public void HitTestCallback(Fuse.HitTestResult result) [instance] :5401
...
// public generated HitTestRecord New() [static] :5398
...
// public sealed class HitTestResult :2482
// {
...
// internal enum Visual.HitTestTransformMode :5329
...
// public abstract interface IActualPlacement :9576
// {
...
// public abstract interface IBeginRemoveVisualListener :4437
// {
...
// public abstract interface ICommonViewport :2594
// {
...
// private sealed class ScalingModes.IdentityMode :8728
// {
...
// public generated IdentityMode() :8728
void ScalingModes__IdentityMode__ctor__fn(ScalingModes__IdentityMode* __this)
{
    __this->ctor_();
}

// public float3 GetScaleVector(Fuse.Scaling t) :8730
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :8733
...
// public generated IdentityMode() [instance] :8728
void ScalingModes__IdentityMode::ctor_()
{
}

// public float3 GetScaleVector(Fuse.Scaling t) [instance] :8730
::g::Uno::Float3 ScalingModes__IdentityMode::GetScaleVector(::g::Fuse::Scaling* t)
{
    return uPtr(t)->Vector();
}

// public object Subscribe(Fuse.ITransformRelative transform) [instance] :8732
uObject* ScalingModes__IdentityMode::Subscribe(uObject* transform)
{
    return NULL;
}

// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :8733
void ScalingModes__IdentityMode::Unsubscribe(uObject* transform, uObject* sub)
{
}

// public generated IdentityMode New() [static] :8728
...
// public abstract interface IFrustum :2575
// {
...
// private struct Visual.InteractionItem :5475
// {
...
// public enum InvalidateLayoutReason :5860
...
// public abstract interface IRenderViewport :2622
// {
...
// public abstract interface IScalingMode :8721
// {
...
// public abstract interface ITransformMode :9408
// {
...
// public abstract interface ITransformRelative :9398
// {
...
// public abstract interface ITranslationMode :9583
// {
...
// public abstract interface IUpdateListener :9821
// {
...
// public abstract interface IViewport :2652
// {
...
// internal sealed class KeyboardBootstrapper :8458
// {
...
// public static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) :8460
...
// public static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) :8477
...
// public static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) [static] :8460
...
// public static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) [static] :8477
...
// public enum LayoutDependent :5868
...
// public struct LayoutParams :2850
// {
...
// private float2 PointConstrain(float2 p, bool knowX, bool knowY) :3171
...
// public void BoxConstrain(Fuse.LayoutParams o) [instance] :3156
...
// public Fuse.LayoutParams Clone() [instance] :2918
...
// public Fuse.LayoutParams CloneAndDerive() [instance] :2947
...
// public void ConstrainMax(float2 max, [bool hasMaxX], [bool hasMaxY]) [instance] :3113
...
// public void ConstrainMaxX(float max) [instance] :3095
...
// public void ConstrainMaxY(float max) [instance] :3104
...
// public void ConstrainMin(float2 min, [bool hasMinX], [bool hasMinY]) [instance] :3142
...
// public void ConstrainMinX(float min) [instance] :3124
...
// public void ConstrainMinY(float min) [instance] :3133
...
// public float2 GetAvailableSize() [instance] :3208
::g::Uno::Float2 LayoutParams::GetAvailableSize()
{
    return PointConstrain1(::g::Uno::Float2__New1(0.0f), false, false);
}

// public bool get_HasMaxSize() [instance] :2890
bool LayoutParams::HasMaxSize()
{
    return HasMaxX() && HasMaxY();
}

// public bool get_HasMaxX() [instance] :2888
bool LayoutParams::HasMaxX()
{
    return (_flags & 8) == 8;
}

// public bool get_HasMaxY() [instance] :2889
bool LayoutParams::HasMaxY()
{
    return (_flags & 16) == 16;
}

// public bool get_HasMinX() [instance] :2892
bool LayoutParams::HasMinX()
{
    return (_flags & 32) == 32;
}

// public bool get_HasMinY() [instance] :2893
bool LayoutParams::HasMinY()
{
    return (_flags & 64) == 64;
}

// public bool get_HasRelativeX() [instance] :2898
...
// public bool get_HasRelativeY() [instance] :2907
...
// public bool get_HasSize() [instance] :2884
bool LayoutParams::HasSize()
{
    return HasX() && HasY();
}

// public bool get_HasX() [instance] :2882
bool LayoutParams::HasX()
{
    return (_flags & 1) == 1;
}

// public bool get_HasY() [instance] :2883
bool LayoutParams::HasY()
{
    return (_flags & 2) == 2;
}

// public bool IsCompatible(Fuse.LayoutParams nlp) [instance] :3284
...
// public float2 get_MaxSize() [instance] :3217
::g::Uno::Float2 LayoutParams::MaxSize()
{
    return _maxSize;
}

// public float get_MaxX() [instance] :3218
float LayoutParams::MaxX()
{
    return _maxSize.X;
}

// public float get_MaxY() [instance] :3219
float LayoutParams::MaxY()
{
    return _maxSize.Y;
}

// public float2 get_MinSize() [instance] :3221
::g::Uno::Float2 LayoutParams::MinSize()
{
    return _minSize;
}

// public float get_MinX() [instance] :3222
float LayoutParams::MinX()
{
    return _minSize.X;
}

// public float get_MinY() [instance] :3223
float LayoutParams::MinY()
{
    return _minSize.Y;
}

// public float2 PointConstrain(float2 p) [instance] :3166
::g::Uno::Float2 LayoutParams::PointConstrain(::g::Uno::Float2 p)
{
    return PointConstrain1(p, true, true);
}

// private float2 PointConstrain(float2 p, bool knowX, bool knowY) [instance] :3171
...
// public float get_RelativeX() [instance] :3228
...
// public float get_RelativeY() [instance] :3237
...
// public void RemoveSize(float2 size) [instance] :3023
...
// public void RemoveSize(float4 size) [instance] :3030
...
// public void Reset() [instance] :2971
...
// public void RetainMaxXY(bool x, bool y) [instance] :3049
...
// public void RetainXY(bool x, bool y) [instance] :3035
...
// private void SetFlag(Fuse.LayoutParams.Flags g, bool val) [instance] :2874
...
// public void SetRelativeSize(float2 sz, bool hasX, bool hasY) [instance] :3086
...
// public void SetSize(float2 xy, [bool hasX], [bool hasY]) [instance] :3063
...
// public void SetX(float x) [instance] :3074
...
// public void SetY(float y) [instance] :3080
...
// public float2 get_Size() [instance] :3213
::g::Uno::Float2 LayoutParams::Size()
{
    return _size;
}

// public bool get_Temporary() [instance] :2886
bool LayoutParams::Temporary()
{
    return (_flags & 4) == 4;
}

// public float get_X() [instance] :3214
float LayoutParams::X()
{
    return _size.X;
}

// public float get_Y() [instance] :3215
float LayoutParams::Y()
{
    return _size.Y;
}

// public static Fuse.LayoutParams Create(float2 size) [static] :2986
...
// public static Fuse.LayoutParams CreateEmpty() [static] :3015
LayoutParams LayoutParams__CreateEmpty()
{
    return uDefault<LayoutParams>();
}

// public static Fuse.LayoutParams CreateTemporary(float2 size) [static] :2995
...
// public static Fuse.LayoutParams CreateXY(float2 size, bool hasX, bool hasY) [static] :3005
...
// public static class LayoutPriority :9814
// {
// static LayoutPriority() :9814
...
// private sealed class TranslationModes.LocalMode :9590
// {
...
// public generated LocalMode() :9590
void TranslationModes__LocalMode__ctor__fn(TranslationModes__LocalMode* __this)
{
    __this->ctor_();
}

// public float3 GetAbsVector(Fuse.Translation t) :9592
...
// internal sealed extern class MobileBootstrapping :3320
// {
static void MobileBootstrapping_build(uType* type)
{
    ::TYPES[1] = ::g::Uno::Platform2::ApplicationStateTransitionHandler_typeof();
    ::TYPES[2] = ::g::Uno::EventHandler_typeof();
    ::TYPES[33] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof());
    type->SetFields(0,
...
// internal static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) :3358
...
// private static void OnReceivedLowMemoryWarning(object sender, Uno.EventArgs args) :3389
...
// private static void OnStarted(Uno.Platform2.ApplicationState state) :3363
void MobileBootstrapping__OnStarted_fn(int* state)
{
    MobileBootstrapping::OnStarted(*state);
}

// private static void OnTerminating(Uno.Platform2.ApplicationState state) :3342
...
// public static void Init() [static] :3323
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform2::Application::add_Started(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnStarted_fn));
    ::g::Uno::Platform2::Application::add_EnteringForeground(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnEnterForeground_fn));
    ::g::Uno::Platform2::Application::add_EnteringInteractive(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnEnterInteractive_fn));
    ::g::Uno::Platform2::Application::add_ExitedInteractive(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnExitInteractive_fn));
    ::g::Uno::Platform2::Application::add_EnteringBackground(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnEnterBackground_fn));
    ::g::Uno::Platform2::Application::add_ReceivedLowMemoryWarning(uDelegate::New(::TYPES[2/*Uno.EventHandler*/], (void*)MobileBootstrapping__OnReceivedLowMemoryWarning_fn));
    ::g::Uno::Platform2::Application::add_Terminating(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnTerminating_fn));
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[33/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyDown(uDelegate::New(::TYPES[33/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyPressed_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[33/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
    ::g::Uno::Platform2::Application::add_KeyUp(uDelegate::New(::TYPES[33/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)MobileBootstrapping__OnKeyReleased_fn));
}

// private static void OnEnterBackground(Uno.Platform2.ApplicationState state) [static] :3385
void MobileBootstrapping::OnEnterBackground(int state)
{
}

// private static void OnEnterForeground(Uno.Platform2.ApplicationState state) [static] :3368
void MobileBootstrapping::OnEnterForeground(int state)
{
    uPtr(::g::Uno::Platform2::Display::MainDisplay())->FramesPerSecond(20U);
}

// private static void OnEnterInteractive(Uno.Platform2.ApplicationState state) [static] :3373
...
// private static void OnExitInteractive(Uno.Platform2.ApplicationState state) [static] :3379
...
// internal static void OnKeyPressed(object sender, Uno.Platform.KeyEventArgs args) [static] :3353
...
// internal static void OnKeyReleased(object sender, Uno.Platform.KeyEventArgs args) [static] :3358
...
// private static void OnReceivedLowMemoryWarning(object sender, Uno.EventArgs args) [static] :3389
void MobileBootstrapping::OnReceivedLowMemoryWarning(uObject* sender, ::g::Uno::EventArgs* args)
{
}

// private static void OnStarted(Uno.Platform2.ApplicationState state) [static] :3363
void MobileBootstrapping::OnStarted(int state)
{
    uPtr(::g::Uno::Application::Current())->Load();
}

// private static void OnTerminating(Uno.Platform2.ApplicationState state) [static] :3342
void MobileBootstrapping::OnTerminating(int state)
{
    ::g::Uno::Platform2::Application::remove_Started(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnStarted_fn));
    ::g::Uno::Platform2::Application::remove_EnteringForeground(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnEnterForeground_fn));
    ::g::Uno::Platform2::Application::remove_EnteringInteractive(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnEnterInteractive_fn));
    ::g::Uno::Platform2::Application::remove_ExitedInteractive(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnExitInteractive_fn));
    ::g::Uno::Platform2::Application::remove_EnteringBackground(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnEnterBackground_fn));
    ::g::Uno::Platform2::Application::remove_ReceivedLowMemoryWarning(uDelegate::New(::TYPES[2/*Uno.EventHandler*/], (void*)MobileBootstrapping__OnReceivedLowMemoryWarning_fn));
    ::g::Uno::Platform2::Application::remove_Terminating(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)MobileBootstrapping__OnTerminating_fn));
}
// }
...
// public static class NameRegistry :8874
// {
// static NameRegistry() :8874
static void NameRegistry__cctor__fn(uType* __type)
{
    NameRegistry::_nameToObj_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[34/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/]));
    NameRegistry::_names_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[35/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/]));
    NameRegistry::_listeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[36/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/]));
}

static void NameRegistry_build(uType* type)
{
    ::TYPES[34] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof()));
    ::TYPES[35] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), ::g::Uno::UX::Selector_typeof());
    ::TYPES[36] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof()));
    ::TYPES[37] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof());
    ::TYPES[38] = ::g::Fuse::INameListener_typeof();
    ::TYPES[39] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof()));
    ::TYPES[40] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetFields(0,
...
// public static void AddListener(Uno.UX.Selector name, Fuse.INameListener listener) :8935
void NameRegistry__AddListener_fn(::g::Uno::UX::Selector* name, uObject* listener)
{
    NameRegistry::AddListener(*name, listener);
}

// public static void ClearName(Fuse.Node obj) :8928
void NameRegistry__ClearName_fn(::g::Fuse::Node* obj)
{
    NameRegistry::ClearName(obj);
}

// internal static Uno.Collections.List<Fuse.Node> GetObjectsWithName(Uno.UX.Selector name) :8915
...
// private static void NotifyNameChanged(Fuse.Node obj, Uno.UX.Selector name) :8957
void NameRegistry__NotifyNameChanged_fn(::g::Fuse::Node* obj, ::g::Uno::UX::Selector* name)
{
    NameRegistry::NotifyNameChanged(obj, *name);
}

// public static void RemoveListener(Fuse.INameListener listener) :8945
void NameRegistry__RemoveListener_fn(uObject* listener)
{
    NameRegistry::RemoveListener(listener);
}

// public static void SetName(Fuse.Node obj, Uno.UX.Selector name) :8880
...
// public static void AddListener(Uno.UX.Selector name, Fuse.INameListener listener) [static] :8935
void NameRegistry::AddListener(::g::Uno::UX::Selector name, uObject* listener)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret5), ret5))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(NameRegistry::_listeners()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[37/*Uno.Collections.List<Fuse.INameListener>*/]));
...
// public static void ClearName(Fuse.Node obj) [static] :8928
...
// internal static Uno.Collections.List<Fuse.Node> GetObjectsWithName(Uno.UX.Selector name) [static] :8915
...
// private static void NotifyNameChanged(Fuse.Node obj, Uno.UX.Selector name) [static] :8957
void NameRegistry::NotifyNameChanged(::g::Fuse::Node* obj, ::g::Uno::UX::Selector name)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret12), ret12))
        ...
        for (array2 = (uArray*)uPtr((::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret13), ret13))->ToArray(), index3 = 0, length4 = uPtr(array2)->Length(); index3 < length4; ++index3)
        {
            ...
            ::g::Fuse::INameListener::OnNameChanged(uInterface(uPtr(listener), ::TYPES[38/*Fuse.INameListener*/]), obj, name);
        }
}

// public static void RemoveListener(Fuse.INameListener listener) [static] :8945
void NameRegistry::RemoveListener(uObject* listener)
{
    ...
    for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(NameRegistry::_listeners())->Values()), &ret14), ret14); enum1.MoveNext(::TYPES[39/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* list = enum1.Current(::TYPES[39/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]);
...
// public static void SetName(Fuse.Node obj, Uno.UX.Selector name) [static] :8880
    ...
    if (::g::Uno::UX::Selector__op_Inequality(name, oldName))
    {
        ...
        else
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), &ret24), ret24))
                ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[40/*Uno.Collections.List<Fuse.Node>*/]));
...
// public interfacemodifiers class Node :3419
// {
// static Node() :3744
static void Node__cctor__fn(uType* __type)
{
    Node::_emptyBindings_ = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[41/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Binding>*/], uArray::New(::TYPES[42/*Fuse.Binding[]*/], 0)));
    ::g::Fuse::Scripting::ScriptClass::Register(Node_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[44/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[45/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[41/*"_findData"*/], uDelegate::New(::TYPES[46/*Uno.Action<Fuse.Scripting.Context, Fuse.Node, object[]>*/], (void*)Node___findData_fn), 2), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(::STRINGS[42/*"findData"*/], 1, ::STRINGS[43/*"function(ke...*/])));
}
...
static void Node_build(uType* type)
{
    ...
    ::TYPES[41] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[42] = ::g::Fuse::Binding_typeof()->Array();
    ::TYPES[43] = ::g::Uno::Type_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[45] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(Node_typeof());
    ::TYPES[46] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), Node_typeof(), uObject_typeof()->Array());
    ::TYPES[47] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[48] = ::g::Uno::String_typeof();
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[50] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[51] = ::g::Fuse::Binding_typeof();
    ::TYPES[52] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[53] = ::g::Fuse::Scripting::IObject_typeof();
    ::TYPES[54] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[2] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
...
// private Fuse.Scripting.Context Fuse.Scripting.IScriptObject.get_ScriptContext() :3431
...
// private object Fuse.Scripting.IScriptObject.get_ScriptObject() :3426
...
// private void Fuse.Scripting.IScriptObject.SetScriptObject(object obj, Fuse.Scripting.Context context) :3434
...
// protected internal void GetImplicitDataForChild(Fuse.Node child, Uno.Collections.List<object> result) :3688
...
// private void Uno.Collections.ICollection<Fuse.Binding>.Clear() :3577
...
// private bool Uno.Collections.ICollection<Fuse.Binding>.Contains(Fuse.Binding item) :3602
...
// private int Uno.Collections.ICollection<Fuse.Binding>.get_Count() :3612
void Node__UnoCollectionsICollectionFuseBindingget_Count_fn(Node* __this, int* __retval)
{
    if (__this->_bindings == NULL)
        return *__retval = 0, void();

    if (uIs((uObject*)__this->_bindings, ::TYPES[51/*Fuse.Binding*/]))
        return *__retval = 1, void();

    return *__retval = uPtr(__this->BindingList())->Count(), void();
}

// private Uno.Collections.IEnumerator<Fuse.Binding> Uno.Collections.IEnumerable<Fuse.Binding>.GetEnumerator() :3670
void Node__UnoCollectionsIEnumerableFuseBindingGetEnumerator_fn(Node* __this, uObject** __retval)
{
    ...
    if (__this->_bindings == NULL)
        return *__retval = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Node::_emptyBindings()), ::TYPES[54/*Uno.Collections.IEnumerable<Fuse.Binding>*/])), void();

    if (uIs((uObject*)__this->_bindings, ::TYPES[51/*Fuse.Binding*/]))
        __this->MakeBindingList(NULL);

    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[51/*Fuse.Binding*/]), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->BindingList()), &ret9), ret9)), void();
}

// private Fuse.Binding Uno.Collections.IList<Fuse.Binding>.get_Item(int index) :3651
...
// private void Uno.Collections.IList<Fuse.Binding>.RemoveAt(int index) :3632
...
// protected generated Node() [instance] :3419
void Node::ctor_1()
{
...
// public void Add(Fuse.Binding item) [instance] :3583
void Node::Add(::g::Fuse::Binding* item)
{
    if (_bindings == NULL)
        _bindings = item;
    else if (uIs((uObject*)_bindings, ::TYPES[51/*Fuse.Binding*/]))
...
// private Fuse.Binding get_Binding() [instance] :3531
::g::Fuse::Binding* Node::Binding()
{
    return uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[51/*Fuse.Binding*/]);
}

// private Uno.Collections.List<Fuse.Binding> get_BindingList() [instance] :3532
::g::Uno::Collections::List* Node::BindingList()
{
    return uAs< ::g::Uno::Collections::List*>(_bindings, ::TYPES[52/*Uno.Collections.List<Fuse.Binding>*/]);
}

// public Uno.Collections.IList<Fuse.Binding> get_Bindings() [instance] :3527
uObject* Node::Bindings()
{
    return (uObject*)this;
}

// public Fuse.Node get_ContextParent() [instance] :3462
...
// public generated void add_DataContextChanged(Uno.EventHandler value) [instance] :3727
void Node::add_DataContextChanged(uDelegate* value)
{
    DataContextChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(DataContextChanged1, value), ::TYPES[2/*Uno.EventHandler*/]);
}

// public generated void remove_DataContextChanged(Uno.EventHandler value) [instance] :3727
void Node::remove_DataContextChanged(uDelegate* value)
{
    DataContextChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(DataContextChanged1, value), ::TYPES[2/*Uno.EventHandler*/]);
}

// private int DistanceTo(Fuse.Node obj, int reference) [instance] :3888
...
// public Fuse.Node FindNodeByName(Uno.UX.Selector name, [Uno.Predicate<Fuse.Node> acceptor]) [instance] :3863
...
// protected internal void GetImplicitDataForChild(Fuse.Node child, Uno.Collections.List<object> result) [instance] :3688
void Node::GetImplicitDataForChild(Node* child, ::g::Uno::Collections::List* result)
{
}

// private bool HasInSubtree(Fuse.Node c) [instance] :3904
...
// public void Insert(int index, Fuse.Binding item) [instance] :3620
void Node::Insert(int index, ::g::Fuse::Binding* item)
{
    ...
    {
        if (uIs((uObject*)_bindings, ::TYPES[51/*Fuse.Binding*/]))
...
// internal bool get_IsPreservedRootFrame() [instance] :4098
bool Node::IsPreservedRootFrame()
{
    return _preservedRootFrame == ::g::Fuse::UpdateManager::FrameIndex();
}

// public bool get_IsRootingCompleted() [instance] :3949
bool Node::IsRootingCompleted()
{
    return _rootStage == 2;
}

// public bool get_IsRootingStarted() [instance] :3944
bool Node::IsRootingStarted()
{
    return (_rootStage == 1) || (_rootStage == 2);
}

// internal bool get_IsUnrooting() [instance] :3951
bool Node::IsUnrooting()
{
    return _rootStage == 3;
}

// private void MakeBindingList(Fuse.Binding newItem) [instance] :3534
void Node::MakeBindingList(::g::Fuse::Binding* newItem)
{
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[52/*Uno.Collections.List<Fuse.Binding>*/]);
    ::g::Fuse::Binding* oldItem = uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[51/*Fuse.Binding*/]);
...
// public Uno.UX.Selector get_Name() [instance] :3841
::g::Uno::UX::Selector Node::Name()
{
    return _name;
}

// public void set_Name(Uno.UX.Selector value) [instance] :3842
...
// public void OnDataContextChanged() [instance] :3711
...
// public Fuse.Visual get_Parent() [instance] :3454
::g::Fuse::Visual* Node::Parent()
{
    return _parent;
}

// public Fuse.Properties get_Properties() [instance] :3444
...
// public bool Remove(Fuse.Binding item) [instance] :3592
bool Node::Remove(::g::Fuse::Binding* item)
{
    ...
    if ((_bindings == NULL) || uIs((uObject*)_bindings, ::TYPES[51/*Fuse.Binding*/]))
        return false;

    return (::g::Uno::Collections::List__Remove_fn(uPtr(BindingList()), item, &ret6), ret6);
}

// private void Root(Fuse.Binding b) [instance] :3543
...
// private void RootBindings() [instance] :3553
...
// internal generated void add_RootingCompleted(Uno.Action value) [instance] :4035
void Node::add_RootingCompleted(uDelegate* value)
{
    RootingCompleted1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RootingCompleted1, value), ::TYPES[8/*Uno.Action*/]);
}

// internal generated void remove_RootingCompleted(Uno.Action value) [instance] :4035
void Node::remove_RootingCompleted(uDelegate* value)
{
    RootingCompleted1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RootingCompleted1, value), ::TYPES[8/*Uno.Action*/]);
}

// internal void RootInternal(Fuse.Visual parent) [instance] :3988
...
// private void RootInternalImpl(Fuse.Visual parent) [instance] :4001
...
// private void Unroot(Fuse.Binding b) [instance] :3548
...
// private void UnrootBindings() [instance] :3565
...
// internal generated void add_Unrooted(Uno.Action value) [instance] :4045
void Node::add_Unrooted(uDelegate* value)
{
    Unrooted1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Unrooted1, value), ::TYPES[8/*Uno.Action*/]);
}

// internal generated void remove_Unrooted(Uno.Action value) [instance] :4045
void Node::remove_Unrooted(uDelegate* value)
{
    Unrooted1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Unrooted1, value), ::TYPES[8/*Uno.Action*/]);
}

// internal void UnrootInternal() [instance] :4047
void Node::UnrootInternal()
{
    ...
    if (_rootStage != 2)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[48/*"Incomplete ...*/], this), ::STRINGS[45/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));
...
// private static void _findData(Fuse.Scripting.Context c, Fuse.Node n, object[] args) [static] :3777
void Node::_findData(::g::Fuse::Scripting::Context* c, Node* n, uArray* args)
{
    Node_typeof()->Init();
    uObject* ret2;
    ::g::Fuse::Scripting::Function* callback = uAs< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[47/*Fuse.Scripting.Function*/]);
    uString* key = uAs<uString*>(args->Strong<uObject*>(1), ::TYPES[48/*string*/]);

    if (::g::Uno::String::op_Equality(key, NULL))
        return;

    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[49/*Uno.Collections.List<object>*/]);
    ...
    while (n != NULL)
    {
        ...
        if (uPtr(list)->Count() > 0)
        {
            for (int i = 0; i < uPtr(list)->Count(); i++)
            {
                ...
                if (res != NULL)
                {
                    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(c)->Dispatcher()), ::TYPES[50/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Node__CallFuncClosure__Run_fn, Node__CallFuncClosure::New1(callback, res)));
                    return;
                }
            }
...
// internal static bool CaptureRooting() [static] :3965
...
// internal static bool IsRootCapture(int index) [static] :3960
...
// internal static void Relate(Fuse.Visual parent, Fuse.Node child) [static] :4075
...
// internal static void ReleaseRooting(bool captured) [static] :3978
...
// private static object TryFindData(object obj, string key) [static] :3816
uObject* Node::TryFindData(uObject* obj, uString* key)
{
    Node_typeof()->Init();
    uObject* om = uAs<uObject*>(obj, ::TYPES[53/*Fuse.Scripting.IObject*/]);

    if ((om != NULL) && ::g::Fuse::Scripting::IObject::ContainsKey(uInterface(uPtr(om), ::TYPES[53/*Fuse.Scripting.IObject*/]), key))
        return ::g::Fuse::Scripting::IObject::Item(uInterface(uPtr(om), ::TYPES[53/*Fuse.Scripting.IObject*/]), key);

    return NULL;
}

// internal static void Unrelate(Fuse.Visual parent, Fuse.Node child) [static] :4083
...
// internal static int get_RootCaptureIndex() [static] :3959
...
// public sealed class OrthographicFrustum :7578
// {
...
// public generated OrthographicFrustum() :7578
void OrthographicFrustum__ctor__fn(OrthographicFrustum* __this)
{
    __this->ctor_();
}

// public float4x4 GetProjectionTransform(Fuse.ICommonViewport viewport) :7619
...
// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) :7632
...
// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) :7624
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) :7637
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) :7645
...
// public float4x4 get_LocalFromWorld() :7611
...
// public void set_LocalFromWorld(float4x4 value) :7612
...
// private float4x4 MatrixProjection(float2 viewSize) :7669
...
// private float4x4 MatrixProjectionInverse(float2 viewSize) :7674
...
// private float4x4 MatrixView(float2 origin, float2 viewSize) :7655
...
// private float4x4 MatrixViewInverse(float2 origin, float2 viewSize) :7662
...
// public generated OrthographicFrustum New() :7578
void OrthographicFrustum__New1_fn(OrthographicFrustum** __retval)
{
    *__retval = OrthographicFrustum::New1();
}

// public float2 get_Origin() :7584
void OrthographicFrustum__get_Origin_fn(OrthographicFrustum* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->Origin();
}

// public void set_Origin(float2 value) :7585
void OrthographicFrustum__set_Origin_fn(OrthographicFrustum* __this, ::g::Uno::Float2* value)
{
    __this->Origin(*value);
}

// public float2 get_Size() :7596
void OrthographicFrustum__get_Size_fn(OrthographicFrustum* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->Size();
}

// public void set_Size(float2 value) :7600
void OrthographicFrustum__set_Size_fn(OrthographicFrustum* __this, ::g::Uno::Float2* value)
{
    __this->Size(*value);
}

// public generated OrthographicFrustum() [instance] :7578
void OrthographicFrustum::ctor_()
{
    _localFromWorld = ::g::Uno::Float4x4__Identity();
}

// public float4x4 GetProjectionTransform(Fuse.ICommonViewport viewport) [instance] :7619
::g::Uno::Float4x4 OrthographicFrustum::GetProjectionTransform(uObject* viewport)
{
    return MatrixProjection(_hasSize ? Size() : ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[23/*Fuse.ICommonViewport*/])));
}

// public float4x4 GetProjectionTransformInverse(Fuse.ICommonViewport viewport) [instance] :7632
::g::Uno::Float4x4 OrthographicFrustum::GetProjectionTransformInverse(uObject* viewport)
{
    return MatrixProjectionInverse(_hasSize ? Size() : ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[23/*Fuse.ICommonViewport*/])));
}

// public float4x4 GetViewTransform(Fuse.ICommonViewport viewport) [instance] :7624
::g::Uno::Float4x4 OrthographicFrustum::GetViewTransform(uObject* viewport)
{
    ::g::Uno::Float4x4 ts = MatrixView(_hasOrigin ? Origin() : ::g::Uno::Float2__New1(0.0f), _hasSize ? Size() : ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[23/*Fuse.ICommonViewport*/])));
...
// public float4x4 GetViewTransformInverse(Fuse.ICommonViewport viewport) [instance] :7637
::g::Uno::Float4x4 OrthographicFrustum::GetViewTransformInverse(uObject* viewport)
{
    ::g::Uno::Float4x4 ts = MatrixViewInverse(_hasOrigin ? Origin() : ::g::Uno::Float2__New1(0.0f), _hasSize ? Size() : ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[23/*Fuse.ICommonViewport*/])));
...
// public float3 GetWorldPosition(Fuse.ICommonViewport viewport) [instance] :7645
::g::Uno::Float3 OrthographicFrustum::GetWorldPosition(uObject* viewport)
{
    return ::g::Uno::Float3__New4(::g::Uno::Float2__op_Division1(_hasSize ? Size() : ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[23/*Fuse.ICommonViewport*/])), 2.0f), 2.0f);
}

// public float4x4 get_LocalFromWorld() [instance] :7611
::g::Uno::Float4x4 OrthographicFrustum::LocalFromWorld()
{
    return _localFromWorld;
}

// public void set_LocalFromWorld(float4x4 value) [instance] :7612
...
// private float4x4 MatrixProjection(float2 viewSize) [instance] :7669
...
// private float4x4 MatrixProjectionInverse(float2 viewSize) [instance] :7674
...
// private float4x4 MatrixView(float2 origin, float2 viewSize) [instance] :7655
...
// private float4x4 MatrixViewInverse(float2 origin, float2 viewSize) [instance] :7662
...
// public float2 get_Origin() [instance] :7584
::g::Uno::Float2 OrthographicFrustum::Origin()
{
    return _origin;
}

// public void set_Origin(float2 value) [instance] :7585
...
// public float2 get_Size() [instance] :7596
::g::Uno::Float2 OrthographicFrustum::Size()
{
    return _size;
}

// public void set_Size(float2 value) [instance] :7600
...
// public generated OrthographicFrustum New() [static] :7578
...
// /usr/local/share/uno/Packages/Fuse.iOS/0.38.6/$.uno
// ---------------------------------------------------

// public sealed extern class OSVersion :267
// {
...
// public OSVersion(int major, int minor, int patch) [instance] :272
...
// public OSVersion New(int major, int minor, int patch) [static] :272
...
// private sealed class Visual.ParameterProperty :6587
// {
// static ParameterProperty() :6587
...
// public ParameterProperty New(Fuse.Visual visual) :6595
...
// public override sealed Uno.UX.PropertyObject get_Object() :6590
...
// public override sealed void Set(string value, Uno.UX.IPropertyListener origin) :6593
...
// public override sealed bool get_SupportsOriginSetter() :6591
...
// public ParameterProperty(Fuse.Visual visual) [instance] :6595
...
// public ParameterProperty New(Fuse.Visual visual) [static] :6595
...
// private sealed class TranslationModes.ParentSizeMode :9613
// {
...
// public generated ParentSizeMode New() :9613
...
// public object Subscribe(Fuse.ITransformRelative transform) :9616
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) :9623
...
// public generated ParentSizeMode() [instance] :9613
void TranslationModes__ParentSizeMode::ctor_()
{
}

// public float3 GetAbsVector(Fuse.Translation t) [instance] :9615
...
// public object Subscribe(Fuse.ITransformRelative transform) [instance] :9616
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :9623
...
// public generated ParentSizeMode New() [static] :9613
...
// public sealed class PendingRemoveVisual :4391
// {
...
// internal PendingRemoveVisual(Fuse.Visual child, Fuse.Visual parent, Uno.Action then) :4398
...
// public void AddSubscriber() [instance] :4406
void PendingRemoveVisual::AddSubscriber()
{
    subscribers++;
}

// public generated Fuse.Visual get_Child() [instance] :4394
::g::Fuse::Visual* PendingRemoveVisual::Child()
{
    return _Child;
}

// private generated void set_Child(Fuse.Visual value) [instance] :4394
void PendingRemoveVisual::Child(::g::Fuse::Visual* value)
{
    _Child = value;
}

// public bool get_HasSubscribers() [instance] :4422
bool PendingRemoveVisual::HasSubscribers()
{
    return subscribers > 0;
}

// public generated Fuse.Visual get_Parent() [instance] :4393
::g::Fuse::Visual* PendingRemoveVisual::Parent()
{
    return _Parent;
}

// private generated void set_Parent(Fuse.Visual value) [instance] :4393
void PendingRemoveVisual::Parent(::g::Fuse::Visual* value)
{
    _Parent = value;
}

// public void Remove() [instance] :4426
...
// public void RemoveSubscriber() [instance] :4411
...
// internal PendingRemoveVisual New(Fuse.Visual child, Fuse.Visual parent, Uno.Action then) [static] :4398
...
// public sealed class PlacedArgs :9549
// {
...
// internal PlacedArgs(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) :9557
...
// public generated bool get_HasPrev() :9551
void PlacedArgs__get_HasPrev_fn(PlacedArgs* __this, bool* __retval)
{
    *__retval = __this->HasPrev();
}

// private generated void set_HasPrev(bool value) :9551
void PlacedArgs__set_HasPrev_fn(PlacedArgs* __this, bool* value)
{
    __this->HasPrev(*value);
}

// internal PlacedArgs New(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) :9557
...
// public generated bool get_HasPrev() [instance] :9551
bool PlacedArgs::HasPrev()
{
    return _HasPrev;
}

// private generated void set_HasPrev(bool value) [instance] :9551
void PlacedArgs::HasPrev(bool value)
{
    _HasPrev = value;
}

// public generated float2 get_NewPosition() [instance] :9555
::g::Uno::Float2 PlacedArgs::NewPosition()
{
    return _NewPosition;
}

// private generated void set_NewPosition(float2 value) [instance] :9555
void PlacedArgs::NewPosition(::g::Uno::Float2 value)
{
    _NewPosition = value;
}

// public generated float2 get_NewSize() [instance] :9554
::g::Uno::Float2 PlacedArgs::NewSize()
{
    return _NewSize;
}

// private generated void set_NewSize(float2 value) [instance] :9554
void PlacedArgs::NewSize(::g::Uno::Float2 value)
{
    _NewSize = value;
}

// public generated float2 get_PrevPosition() [instance] :9552
::g::Uno::Float2 PlacedArgs::PrevPosition()
{
    return _PrevPosition;
}

// private generated void set_PrevPosition(float2 value) [instance] :9552
void PlacedArgs::PrevPosition(::g::Uno::Float2 value)
{
    _PrevPosition = value;
}

// public generated float2 get_PrevSize() [instance] :9553
::g::Uno::Float2 PlacedArgs::PrevSize()
{
    return _PrevSize;
}

// private generated void set_PrevSize(float2 value) [instance] :9553
void PlacedArgs::PrevSize(::g::Uno::Float2 value)
{
    _PrevSize = value;
}

// internal PlacedArgs New(bool hasPrev, float2 prevPosition, float2 newPosition, float2 prevSize, float2 newSize) [static] :9557
...
// public delegate void PlacedHandler(object sender, Fuse.PlacedArgs args) :9574
...
// public sealed class Properties :8174
// {
// static Properties() :8174
...
// public static Fuse.PropertyHandle CreateHandle() :8180
void Properties__CreateHandle_fn(::g::Fuse::PropertyHandle** __retval)
{
    *__retval = Properties::CreateHandle();
}

// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object[]> action, object[] state) :8291
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object> action, object state) :8274
...
// public void Set(Fuse.PropertyHandle handle, object val) :8207
void Properties__Set_fn(Properties* __this, ::g::Fuse::PropertyHandle* handle, uObject* val)
{
    __this->Set(handle, val);
}

// public bool TryGet(Fuse.PropertyHandle handle, object& val) :8192
...
// public generated Properties() [instance] :8174
void Properties::ctor_()
{
}

// public void AddToList(Fuse.PropertyHandle handle, object val) [instance] :8225
...
// public void Clear(Fuse.PropertyHandle handle) [instance] :8308
void Properties::Clear(::g::Fuse::PropertyHandle* handle)
{
    Clear1(handle, Properties::NoValue(), true);
}

// private void Clear(Fuse.PropertyHandle handle, object val, bool all) [instance] :8315
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object[]> action, object[] state) [instance] :8291
...
// public void ForeachInList(Fuse.PropertyHandle handle, Uno.Action<object, object> action, object state) [instance] :8274
...
// public object Get(Fuse.PropertyHandle handle) [instance] :8185
...
// public void RemoveFromList(Fuse.PropertyHandle handle, object val) [instance] :8243
void Properties::RemoveFromList(::g::Fuse::PropertyHandle* handle, uObject* val)
{
    Clear1(handle, val, false);
}

// public void Set(Fuse.PropertyHandle handle, object val) [instance] :8207
...
// public bool TryGet(Fuse.PropertyHandle handle, object& val) [instance] :8192
...
// public static Fuse.PropertyHandle CreateHandle() [static] :8180
...
// public generated Properties New() [static] :8174
...
// public sealed class PropertyHandle :8169
// {
...
// public abstract class RelativeTransform<TransformMode> :9438
// {
static void RelativeTransform_build(uType* type)
{
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[58] = ::g::Fuse::ITransformMode_typeof();
    type->SetInterfaces(
...
// private Fuse.Visual Fuse.ITransformRelative.get_RelativeNode() :9476
...
// protected override sealed void OnRooted() :9479
...
// private void CheckSubscription(bool fromRooted) [instance] :9517
void RelativeTransform::CheckSubscription(bool fromRooted)
{
    ...
    if ((RelativeNode() != NULL) && !uPtr(RelativeNode())->IsRootingStarted())
    {
        ...
        uPtr(_waitRootingCompleted)->add_RootingCompleted(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)RelativeTransform__OnRootingCompleted_fn, this));
        return;
    }

    ClearSubscription();
    _subscription = ::g::Fuse::ITransformMode::Subscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[58/*Fuse.ITransformMode*/])), ::TYPES[58/*Fuse.ITransformMode*/]), (uObject*)this);
    OnMatrixChanged(NULL, NULL);
}

// private void ClearRootingCompleted() [instance] :9503
void RelativeTransform::ClearRootingCompleted()
{
    if (_waitRootingCompleted != NULL)
    {
        uPtr(_waitRootingCompleted)->remove_RootingCompleted(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)RelativeTransform__OnRootingCompleted_fn, this));
        _waitRootingCompleted = NULL;
    }
}

// private void ClearSubscription() [instance] :9492
void RelativeTransform::ClearSubscription()
{
    if (_subscription != NULL)
    {
        ::g::Fuse::ITransformMode::Unsubscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[58/*Fuse.ITransformMode*/])), ::TYPES[58/*Fuse.ITransformMode*/]), (uObject*)this, _subscription);
        _subscription = NULL;
    }
}

// private void OnRootingCompleted() [instance] :9511
void RelativeTransform::OnRootingCompleted()
{
    CheckSubscription(false);
}

// public Fuse.Visual get_RelativeNode() [instance] :9444
...
// public void set_RelativeNode(Fuse.Visual value) [instance] :9445
...
// public TransformMode get_RelativeTo() [instance] :9458
uObject* RelativeTransform::RelativeTo()
{
    return _relativeTo;
}

// public void set_RelativeTo(TransformMode value) [instance] :9459
...
// internal sealed class RenderTargetEntry :839
// {
...
// public extern RenderTargetEntry(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) :846
...
// public extern RenderTargetEntry New(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) :846
...
// public extern RenderTargetEntry(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) [instance] :846
...
// public extern RenderTargetEntry New(Uno.Graphics.RenderTarget rt, int2 viewportPixelSize, int4 glScissor, OpenGL.GLFramebufferHandle handle) [static] :846
...
// public sealed class RequestBringIntoViewArgs :5892
// {
...
// public RequestBringIntoViewArgs(Fuse.Visual elm) :5895
void RequestBringIntoViewArgs__ctor_1_fn(RequestBringIntoViewArgs* __this, ::g::Fuse::Visual* elm)
{
    __this->ctor_1(elm);
}

// public RequestBringIntoViewArgs New(Fuse.Visual elm) :5895
...
// public generated Fuse.Visual get_Visual() :5894
...
// private generated void set_Visual(Fuse.Visual value) :5894
void RequestBringIntoViewArgs__set_Visual_fn(RequestBringIntoViewArgs* __this, ::g::Fuse::Visual* value)
{
    __this->Visual(value);
}

// public RequestBringIntoViewArgs(Fuse.Visual elm) [instance] :5895
...
// public generated Fuse.Visual get_Visual() [instance] :5894
::g::Fuse::Visual* RequestBringIntoViewArgs::Visual()
{
    return _Visual;
}

// private generated void set_Visual(Fuse.Visual value) [instance] :5894
void RequestBringIntoViewArgs::Visual(::g::Fuse::Visual* value)
{
    _Visual = value;
}

// public RequestBringIntoViewArgs New(Fuse.Visual elm) [static] :5895
...
// public delegate void RequestBringIntoViewHandler(object sender, Fuse.RequestBringIntoViewArgs args) :5901
...
// public sealed class RootViewport :8502
// {
static void RootViewport_build(uType* type)
{
    ::TYPES[2] = ::g::Uno::EventHandler_typeof();
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[59] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) :8508
...
// public override sealed void Draw(Fuse.DrawContext dc) :8539
void RootViewport__Draw_fn(RootViewport* __this, ::g::Fuse::DrawContext* dc)
{
    ::g::Fuse::Node* ret2;

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), ::TYPES[6/*Fuse.Visual*/]);
        uPtr(v)->Draw(dc);
    }
}

// private void EstablishSize() :8591
void RootViewport__EstablishSize_fn(RootViewport* __this)
{
    __this->EstablishSize();
}

// private extern void EstablishSizeInternals() :8653
void RootViewport__EstablishSizeInternals_fn(RootViewport* __this)
{
    __this->EstablishSizeInternals();
}

// public RootViewport New(Uno.Platform.Window window, [float overridePixelsPerPoint]) :8508
...
// public generated void add_Resized(Uno.Action<float2> value) :8506
void RootViewport__add_Resized_fn(RootViewport* __this, uDelegate* value)
{
    __this->add_Resized(value);
}

// public generated void remove_Resized(Uno.Action<float2> value) :8506
void RootViewport__remove_Resized_fn(RootViewport* __this, uDelegate* value)
{
    __this->remove_Resized(value);
}

// public float2 get_Size() :8678
void RootViewport__get_Size_fn(RootViewport* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->Size();
}

// private void Uno.IDisposable.Dispose() :8528
void RootViewport__UnoIDisposableDispose_fn(RootViewport* __this)
{
    ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)::g::Fuse::Visual__PerformLayout_fn, __this), 1);
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(__this->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/]));
}

// public float4x4 get_ViewTransform() :8698
void RootViewport__get_ViewTransform_fn(RootViewport* __this, ::g::Uno::Float4x4* __retval)
{
    *__retval = __this->ViewTransform();
}

// public override sealed Fuse.VisualContext get_VisualContext() :8536
void RootViewport__get_VisualContext_fn(RootViewport* __this, int* __retval)
{
    return *__retval = 1, void();
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) :8705
...
// public RootViewport(Uno.Platform.Window window, [float overridePixelsPerPoint]) [instance] :8508
void RootViewport::ctor_3(::g::Uno::Platform::Window* window, float overridePixelsPerPoint)
{
    ...
    Window = window;
    EstablishSize();
    uPtr(Window)->add_GotFocus(uDelegate::New(::TYPES[2/*Uno.EventHandler*/], (void*)RootViewport__OnGotFocus_fn, this));
    uPtr(Window)->add_LostFocus(uDelegate::New(::TYPES[2/*Uno.EventHandler*/], (void*)RootViewport__OnLostFocus_fn, this));
    uPtr(Window)->add_Resized(uDelegate::New(::TYPES[2/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
    uPtr(::g::Uno::Platform2::Display::MainDisplay())->add_FrameChanged(uDelegate::New(::TYPES[2/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
    uPtr(_frustumViewport)->Update((uObject*)this, Frustum);
    RootInternal(NULL);
    ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)::g::Fuse::Visual__PerformLayout_fn, this), 1);
}

// private void EstablishSize() [instance] :8591
...
// private extern void EstablishSizeInternals() [instance] :8653
...
// private void OnGotFocus(object sender, Uno.EventArgs args) [instance] :8548
...
// private void OnLostFocus(object sender, Uno.EventArgs args) [instance] :8560
...
// internal void OnResized(object s, object a) [instance] :8572
...
// public float2 get_PixelSize() [instance] :8684
::g::Uno::Float2 RootViewport::PixelSize()
{
    return _pixelSize;
}

// public float get_PixelsPerPoint() [instance] :8671
float RootViewport::PixelsPerPoint()
{
    return (_overridePixelsPerPoint > 0.0f) ? _overridePixelsPerPoint : _pixelsPerPoint;
}

// public Uno.Geometry.Ray PointToWorldRay(float2 pixelPos) [instance] :8701
...
// public generated void add_Resized(Uno.Action<float2> value) [instance] :8506
...
// public generated void remove_Resized(Uno.Action<float2> value) [instance] :8506
...
// public float2 get_Size() [instance] :8678
::g::Uno::Float2 RootViewport::Size()
{
    return ::g::Uno::Float2__op_Division1(PixelSize(), PixelsPerPoint());
}

// public float4x4 get_ViewTransform() [instance] :8698
::g::Uno::Float4x4 RootViewport::ViewTransform()
{
    return uPtr(_frustumViewport)->ViewTransform;
}

// public Uno.Geometry.Ray WorldToLocalRay(Fuse.IViewport world, Uno.Geometry.Ray worldRay, Fuse.Visual where) [instance] :8705
::g::Uno::Geometry::Ray RootViewport::WorldToLocalRay(uObject* world, ::g::Uno::Geometry::Ray worldRay, ::g::Fuse::Visual* where)
{
    return ::g::Fuse::FrustumViewport::WorldToLocalRay((uObject*)this, world, worldRay, where);
}

// public RootViewport New(Uno.Platform.Window window, [float overridePixelsPerPoint]) [static] :8508
...
// public sealed class Rotation :9199
// {
...
// public generated Rotation() :9199
void Rotation__ctor_3_fn(Rotation* __this)
{
    __this->ctor_3();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9298
...
// public generated Rotation New() :9199
void Rotation__New2_fn(Rotation** __retval)
{
    *__retval = Rotation::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix m) :9304
...
// public generated Rotation() [instance] :9199
void Rotation::ctor_3()
{
    ctor_2();
}

// public float get_Degrees() [instance] :9237
float Rotation::Degrees()
{
    return DegreesZ();
}

// public void set_Degrees(float value) [instance] :9238
void Rotation::Degrees(float value)
{
    DegreesZ(value);
}

// public float get_DegreesZ() [instance] :9246
float Rotation::DegreesZ()
{
    return ::g::Uno::Math::RadiansToDegrees1(_euler.Z);
}

// public void set_DegreesZ(float value) [instance] :9247
...
// public float3 get_EulerAngle() [instance] :9205
::g::Uno::Float3 Rotation::EulerAngle()
{
    return _euler;
}

// public void set_EulerAngle(float3 value) [instance] :9206
...
// public sealed class Scaling :8758
// {
...
// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :8837
...
// private float3 get_EffectiveVector() [instance] :8824
::g::Uno::Float3 Scaling::EffectiveVector()
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[62/*Fuse.IScalingMode*/]), this);
}

// private bool IsIdentity(float3 v) [instance] :8830
...
// public float3 get_Vector() [instance] :8790
::g::Uno::Float3 Scaling::Vector()
{
    return _vector;
}

// public void set_Vector(float3 value) [instance] :8791
...
// public Scaling New() [static] :8760
...
// public static class ScalingModes :8726
// {
// static ScalingModes() :8726
...
// public sealed class Shear :9322
// {
...
// public generated Shear() :9322
void Shear__ctor_3_fn(Shear* __this)
{
    __this->ctor_3();
}

// public override sealed void AppendTo(Fuse.FastMatrix m, float weight) :9380
...
// public override sealed bool get_IsFlat() :9394
void Shear__get_IsFlat_fn(Shear* __this, bool* __retval)
{
    return *__retval = true, void();
}

// public generated Shear New() :9322
void Shear__New2_fn(Shear** __retval)
{
    *__retval = Shear::New2();
}

// public override sealed void PrependTo(Fuse.FastMatrix m) :9386
...
// public float2 get_Vector() :9328
void Shear__get_Vector_fn(Shear* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->Vector();
}

// public void set_Vector(float2 value) :9329
void Shear__set_Vector_fn(Shear* __this, ::g::Uno::Float2* value)
{
    __this->Vector(*value);
}

// public generated Shear() [instance] :9322
void Shear::ctor_3()
{
    ctor_2();
}

// public float2 get_Vector() [instance] :9328
::g::Uno::Float2 Shear::Vector()
{
    return _vector;
}

// public void set_Vector(float2 value) [instance] :9329
...
// public generated Shear New() [static] :9322
Shear* Shear::New2()
{
...
// private class TranslationModes.SizeMode :9597
// {
...
// public generated SizeMode() :9597
void TranslationModes__SizeMode__ctor__fn(TranslationModes__SizeMode* __this)
{
    __this->ctor_();
}

// public virtual float3 GetAbsVector(Fuse.Translation t) :9599
...
// public void Unsubscribe(Fuse.ITransformRelative transform, object sub) [instance] :9607
void TranslationModes__SizeMode::Unsubscribe(uObject* transform, uObject* sub)
{
    ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[55/*Fuse.IActualPlacement*/])), ::TYPES[55/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[57/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[56/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}

// public generated SizeMode New() [static] :9597
...
// internal sealed class Stage :9854
// {
...
// public void AddDeferredAction(Uno.Action pu, [int priority]) [instance] :9891
...
// public void Insert(Uno.Collections.List<Fuse.UpdateListener> list, Fuse.UpdateListener us) [instance] :9873
...
// public void ResetDeferredActions() [instance] :9902
...
// public Stage New(Fuse.UpdateStage _updateStage) [static] :9867
...
// internal static void Init(double start) [static] :9085
...
// internal static void Set(double current) [static] :9094
...
// public static double get_FrameInterval() [static] :9119
double Time::FrameInterval()
{
    return Time::_delta_;
}

// public static double get_FrameTime() [static] :9112
double Time::FrameTime()
{
    return Time::_current_ - Time::_base_;
}

// public static double get_FrameTimeBase() [static] :9125
...
// public abstract class Transform :9162
// {
...
// internal Transform() :9182
void Transform__ctor_2_fn(Transform* __this)
{
    __this->ctor_2();
}

// internal generated void add_MatrixChanged(Uno.Action<Fuse.Transform> value) :9167
void Transform__add_MatrixChanged_fn(Transform* __this, uDelegate* value)
{
    __this->add_MatrixChanged(value);
}

// internal generated void remove_MatrixChanged(Uno.Action<Fuse.Transform> value) :9167
void Transform__remove_MatrixChanged_fn(Transform* __this, uDelegate* value)
{
    __this->remove_MatrixChanged(value);
}

// protected void OnMatrixChanged([object igoreSender], [object ignoreArgs]) :9169
...
// internal Transform() [instance] :9182
void Transform::ctor_2()
{
    ctor_1();
}

// internal generated void add_MatrixChanged(Uno.Action<Fuse.Transform> value) [instance] :9167
...
// internal generated void remove_MatrixChanged(Uno.Action<Fuse.Transform> value) [instance] :9167
...
// protected void OnMatrixChanged([object igoreSender], [object ignoreArgs]) [instance] :9169
...
// public sealed class Translation :9671
// {
...
// public float get_X() [instance] :9685
float Translation::X()
{
    return _x;
}

// public void set_X(float value) [instance] :9686
...
// public float get_Y() [instance] :9723
float Translation::Y()
{
    return _y;
}

// public void set_Y(float value) [instance] :9724
...
// public float get_Z() [instance] :9742
float Translation::Z()
{
    return _z;
}

// public void set_Z(float value) [instance] :9743
...
// public Translation New() [static] :9673
...
// public static class TranslationModes :9588
// {
// static TranslationModes() :9588
...
// private static float3 SizeOf(Fuse.Node node) :9630
...
// private static float3 SizeOf(Fuse.Node node) [static] :9630
...
// internal struct UpdateAction :9848
// {
...
// internal sealed class UpdateDispatcher :9909
// {
...
// internal sealed class UpdateListener :9826
// {
static void UpdateListener_build(uType* type)
{
    ::TYPES[67] = ::g::Fuse::IUpdateListener_typeof();
    type->SetFields(0,
...
void UpdateListener::Invoke()
{
    ...
    if (update != NULL)
        ::g::Fuse::IUpdateListener::Update(uInterface(uPtr(update), ::TYPES[67/*Fuse.IUpdateListener*/]));
}

// public generated UpdateListener New() [static] :9826
...
// public static class UpdateManager :9917
// {
// static UpdateManager() :9924
static void UpdateManager__cctor__fn(uType* __type)
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[68/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[69/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[69/*Uno.Collections.List<Uno.Action>*/]));
...
{
    ::STRINGS[50] = uString::Const("no Action found to remove");
    ::TYPES[68] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof());
    ::TYPES[69] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[70] = ::g::Uno::IDisposable_typeof();
    ::TYPES[32] = ::g::Uno::Exception_typeof();
    ::TYPES[71] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetFields(0,
...
// public static void AddAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) :9944
void UpdateManager__AddAction_fn(uObject* pu, int* stage)
{
    UpdateManager::AddAction(pu, *stage);
}

// public static void AddAction(Uno.Action pu, [Fuse.UpdateStage stage]) :9933
void UpdateManager__AddAction1_fn(uDelegate* pu, int* stage)
{
    UpdateManager::AddAction1(pu, *stage);
}

// public static void AddDeferredAction(Uno.Action pu, [Fuse.UpdateStage stage], [int priority]) :10035
...
// public static void Update() :10053
void UpdateManager__Update_fn()
{
    UpdateManager::Update();
}

// private static void Update(Fuse.Stage stage) :10072
...
// public static void AddAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) [static] :9944
...
// public static void AddAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9933
...
// public static void AddDeferredAction(Uno.Action pu, [Fuse.UpdateStage stage], [int priority]) [static] :10035
...
// public static void AddDeferredAction(Uno.Action pu, int priority) [static] :10042
...
// public static void AddOnceAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9988
...
// private static void CheckExceptions(Uno.Collections.List<Uno.Exception> exs) [static] :10193
...
// public static void IncreaseFrameIndex() [static] :10047
...
// public static void PerformNextFrame(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :10005
...
// public static void PostAction(Uno.Action pu) [static] :10019
void UpdateManager::PostAction(uDelegate* pu)
{
...

    {
        const auto __finally_fun = [&]()
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr(lg), ::TYPES[70/*Uno.IDisposable*/]));
        };
...
// private static void ProcessPostActions() [static] :10157
...
// public static void RemoveAction(Fuse.IUpdateListener pu, [Fuse.UpdateStage stage]) [static] :9980
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[50/*"no Action f...*/]));

    uPtr(s)->HasListenersRemoved = true;
}

// public static void RemoveAction(Uno.Action pu, [Fuse.UpdateStage stage]) [static] :9972
...
// private static bool RemoveFrom(Uno.Collections.List<Fuse.UpdateListener> list, Uno.Action action, Fuse.IUpdateListener update) [static] :9954
...
// public static void Update() [static] :10053
...
// private static void Update(Fuse.Stage stage) [static] :10072
...
// public static int get_FrameIndex() [static] :10207
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/0.38.6/$.uno
// ----------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(UserEvent_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[44/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[72/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[51/*"raise"*/], uDelegate::New(::TYPES[73/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[53] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.38.6/$.uno");
    ...
    ::TYPES[43] = ::g::Uno::Type_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[72] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(UserEvent_typeof());
    ::TYPES[73] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), UserEvent_typeof(), uObject_typeof()->Array());
    ::TYPES[74] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[75] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[59] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[60] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    type->SetInterfaces(
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[52/*"UserEvent r...*/], __this, ::STRINGS[53/*"/usr/local/...*/], 638, ::STRINGS[54/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[57/*"Trying to R...*/], this, ::STRINGS[53/*"/usr/local/...*/], 685, ::STRINGS[58/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[55/*"Raise must ...*/], n, ::STRINGS[53/*"/usr/local/...*/], 421, ::STRINGS[51/*"raise"*/]);
        return;
    }

    ::g::Fuse::Scripting::Object* so = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[74/*Fuse.Scripting.Object*/]);

    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[53/*"/usr/local/...*/], 428, ::STRINGS[51/*"raise"*/]);
        return;
    }
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ...
        if (v != NULL)
            ...
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
            {
                UserEvent* ue = uAs<UserEvent*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), UserEvent_typeof());
...
{
    UserEventDispatch::_userEvents_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[76/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/]));
}

static void UserEventDispatch_build(uType* type)
{
    ::TYPES[76] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), UserEventDispatch_typeof());
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[77] = ::g::Fuse::UserEventHandler_typeof();
    type->SetFields(0,
...
{
    ::g::Fuse::UserEventArgs* m = ::g::Fuse::UserEventArgs::New2(this, source, args);
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)::g::Fuse::UserEventArgs__Raise_fn, m), -1, 0);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Raised1, value), ::TYPES[77/*Fuse.UserEventHandler*/]);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Raised1, value), ::TYPES[77/*Fuse.UserEventHandler*/]);
}
...
// public interfacemodifiers class Visual :4442
// {
// static Visual() :6579
static void Visual__cctor_1_fn(uType* __type)
{
    Visual::_emptyChildren_ = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[78/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Node>*/], uArray::New(::TYPES[79/*Fuse.Node[]*/], 0)));
    Visual::_isContextEnabledChangedHandle_ = ::g::Fuse::Properties::CreateHandle();
    Visual::_isEnabledName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[59/*"IsEnabled"*/]);
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(Visual_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[44/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[80/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[49/*"Parameter"*/], uDelegate::New(::TYPES[81/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[60/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[82/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[61/*"onParameter...*/], uDelegate::New(::TYPES[83/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[82/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[62/*"bringIntoView"*/], uDelegate::New(::TYPES[83/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[59] = uString::Const("IsEnabled");
    ::STRINGS[49] = uString::Const("Parameter");
    ::STRINGS[60] = uString::Const(".notNull().parseJson()");
    ::STRINGS[61] = uString::Const("onParameterChanged");
    ::STRINGS[62] = uString::Const("bringIntoView");
    ::STRINGS[63] = uString::Const("index");
    ::STRINGS[64] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[65] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[78] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[79] = ::g::Fuse::Node_typeof()->Array();
    ::TYPES[43] = ::g::Uno::Type_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[80] = ::g::Fuse::Scripting::ScriptProperty1_typeof()->MakeType(Visual_typeof(), ::g::Uno::String_typeof());
    ::TYPES[81] = ::g::Uno::Func1_typeof()->MakeType(Visual_typeof(), ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof()));
    ::TYPES[82] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(Visual_typeof());
    ::TYPES[83] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), Visual_typeof(), uObject_typeof()->Array());
    ::TYPES[59] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[84] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::Function_typeof());
    ::TYPES[85] = ::g::Fuse::Scripting::IScriptObject_typeof();
    ::TYPES[10] = uObject_typeof()->Array();
    ::TYPES[86] = ::g::Fuse::IDataProvider_typeof();
    ::TYPES[60] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[87] = ::g::Uno::Int_typeof()->Array();
    ::TYPES[88] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[5] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(Visual_typeof());
    ::TYPES[89] = ::g::Fuse::Transform_typeof();
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[90] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[91] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof());
    ::TYPES[92] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(uObject_typeof());
    ::TYPES[93] = ::g::Uno::Comparison_typeof()->MakeType(Visual_typeof());
    ::TYPES[94] = ::g::Fuse::FastProperty1Link1_typeof();
    ::TYPES[95] = ::g::Fuse::FastProperty2Link1_typeof();
    ::TYPES[96] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[97] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Template_typeof());
    ::TYPES[7] = ::g::Fuse::IViewport_typeof();
    ::TYPES[98] = ::g::Fuse::HitTestCallback_typeof();
    ::TYPES[99] = ::g::Uno::Collections::HashSet_typeof()->MakeType(Visual_typeof());
    ::TYPES[100] = ::g::Fuse::Node_typeof();
    ::TYPES[101] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[102] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[2] = ::g::Uno::EventHandler_typeof();
    ::TYPES[103] = ::g::Uno::EventArgs_typeof();
    ::TYPES[40] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[104] = ::g::Fuse::IBeginRemoveVisualListener_typeof();
    ::TYPES[105] = ::g::Fuse::IParentObserver_typeof();
    ::TYPES[47] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[106] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[65] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[23] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[107] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[108] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[109] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[110] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[111] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[112] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof());
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(Visual_typeof());
    ::TYPES[113] = ::g::Fuse::RequestBringIntoViewHandler_typeof();
    type->SetPrecalc(
...
// private void AddParameterChangedListener(Fuse.Scripting.Function func) :6527
...
// internal void AdjustMarginBoxPosition(float2 position) :6282
void Visual__AdjustMarginBoxPosition_fn(Visual* __this, ::g::Uno::Float2* position)
{
    __this->AdjustMarginBoxPosition(*position);
}

// protected internal override sealed void AppendSubtreeData(Uno.Collections.List<object> result) :7139
void Visual__AppendSubtreeData_fn(Visual* __this, ::g::Uno::Collections::List* result)
{
    ::g::Fuse::Node* ret9;

    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])) - 1; i >= 0; i--)
    {
        uObject* dp = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret9), ret9), ::TYPES[86/*Fuse.IDataProvider*/]);

        if (dp != NULL)
        {
            uObject* data = ::g::Fuse::IDataProvider::Data(uInterface(uPtr(dp), ::TYPES[86/*Fuse.IDataProvider*/]));
...
// internal bool get_AreChildrenFlat() :5716
void Visual__get_AreChildrenFlat_fn(Visual* __this, bool* __retval)
{
    *__retval = __this->AreChildrenFlat();
}

// public float2 ArrangeMarginBox(float2 position, Fuse.LayoutParams lp) :6249
...
void Visual__CalcIsLocalFlat_fn(Visual* __this, bool* __retval)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret15), ret15), ::TYPES[89/*Fuse.Transform*/]);
...
// internal Fuse.VisualBounds CalcRenderBoundsInParentSpace() :6961
...
// protected void DrawLocalSelectionRect(Fuse.DrawContext dc, Uno.Rect rect) :4916
...
// public virtual void DrawSelection(Fuse.DrawContext dc) :4926
...
// internal T Get<T>(Fuse.FastProperty2 p, T defaultValue) :5220
...
// public Fuse.Visual GetHitWindowPoint(float2 windowPoint) :5387
...
// public virtual float2 GetMarginSize(Fuse.LayoutParams lp) :5953
void Visual__GetMarginSize_fn(Visual* __this, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    return *__retval = ::g::Uno::Float2__New1(0.0f), void();
}

// public T GetNearestAncestorOfType<T>() :7226
...
// protected virtual Fuse.VisualBounds get_HitTestChildrenBounds() :5452
...
// protected virtual Fuse.VisualBounds get_HitTestLocalBounds() :5444
...
// private void Insert<T>(Fuse.FastProperty2 p, T value) :5271
...
void Visual__OnChildAdded_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret35), ret35);
            uObject* obs = uAs<uObject*>(n, ::TYPES[105/*Fuse.IParentObserver*/]);

            if ((obs != NULL) && uPtr(n)->IsRootingCompleted())
                ::g::Fuse::IParentObserver::OnChildAddedWhileRooted(uInterface(uPtr(obs), ::TYPES[105/*Fuse.IParentObserver*/]), elm);
        }

    if (uIs(elm, ::TYPES[105/*Fuse.IParentObserver*/]))
        __this->_observerCount++;
}

// protected virtual void OnChildRemoved(Fuse.Node elm) :4612
void Visual__OnChildRemoved_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret36), ret36);
            uObject* obs = uAs<uObject*>(n, ::TYPES[105/*Fuse.IParentObserver*/]);

            if ((obs != NULL) && uPtr(n)->IsRootingCompleted())
                ::g::Fuse::IParentObserver::OnChildRemovedWhileRooted(uInterface(uPtr(obs), ::TYPES[105/*Fuse.IParentObserver*/]), elm);
        }
...
// protected virtual void OnHitTest(Fuse.HitTestContext htc) :5377
...
void Visual__OnRooted_fn(Visual* __this)
{
    ...
    {
        uArray* children = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[106/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], __this->Children());
...
// internal virtual Fuse.FastMatrix get_ParentWorldTransformInternal() :6796
...
// internal void Set<T>(Fuse.FastProperty2 p, T value, T defaultValue) :5226
...
void Visual__TryGetResource_fn(Visual* __this, uString* key, uDelegate* acceptor, uObject** resource, bool* __retval)
{
    ...
    if (__this->HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[108/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[109/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret47), ret47);
...
// private void Uno.Collections.ICollection<Fuse.Node>.Clear() :4683
...
// private bool Uno.Collections.ICollection<Fuse.Node>.Contains(Fuse.Node item) :4726
...
// private int Uno.Collections.ICollection<Fuse.Node>.get_Count() :4736
void Visual__UnoCollectionsICollectionFuseNodeget_Count_fn(Visual* __this, int* __retval)
{
    if (__this->_children == NULL)
        return *__retval = 0, void();

    if (uIs((uObject*)__this->_children, ::TYPES[100/*Fuse.Node*/]))
        return *__retval = 1, void();

    return *__retval = uPtr(__this->NodeList())->Count(), void();
}

// private Uno.Collections.IEnumerator<Fuse.Node> Uno.Collections.IEnumerable<Fuse.Node>.GetEnumerator() :4845
void Visual__UnoCollectionsIEnumerableFuseNodeGetEnumerator_fn(Visual* __this, uObject** __retval)
{
    ...
    if (__this->_children == NULL)
        return *__retval = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Visual::_emptyChildren()), ::TYPES[110/*Uno.Collections.IEnumerable<Fuse.Node>*/])), void();

    if (uIs((uObject*)__this->_children, ::TYPES[100/*Fuse.Node*/]))
        __this->MakeNodeList(NULL);

    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[100/*Fuse.Node*/]), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->NodeList()), &ret51), ret51)), void();
}

// private Fuse.Node Uno.Collections.IList<Fuse.Node>.get_Item(int index) :4826
void Visual__UnoCollectionsIListFuseNodeget_Item_fn(Visual* __this, int* index, ::g::Fuse::Node** __retval)
{
    ...
    if (b != NULL)
    {
        ...
        return *__retval = (::g::Uno::Collections::List__get_Item_fn(uPtr(__this->NodeList()), uCRef<int>(index_), &ret59), ret59), void();
}

// private void Uno.Collections.IList<Fuse.Node>.RemoveAt(int index) :4805
...
void Visual__VisitSubtree_fn(Visual* __this, uDelegate* action)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret55), ret55))->VisitSubtree(action);
}

// public virtual Fuse.VisualContext get_VisualContext() :7091
...
// public float2 WindowToLocal(float2 windowCoord) :6911
...
// protected generated Visual() [instance] :4442
void Visual::ctor_2()
{
...
// private bool get__areChildrenFlat() [instance] :5709
bool Visual::_areChildrenFlat()
{
    return HasBit(32);
}

// private void set__areChildrenFlat(bool value) [instance] :5710
void Visual::_areChildrenFlat(bool value)
{
    SetBit1(32, value);
}

// private bool get__areChildrenFlatCached() [instance] :5703
bool Visual::_areChildrenFlatCached()
{
    return HasBit(16);
}

// private void set__areChildrenFlatCached(bool value) [instance] :5704
void Visual::_areChildrenFlatCached(bool value)
{
    SetBit1(16, value);
}

// private bool get__isLocalFlat() [instance] :5673
bool Visual::_isLocalFlat()
{
    return HasBit(4);
}

// private void set__isLocalFlat(bool value) [instance] :5674
void Visual::_isLocalFlat(bool value)
{
    SetBit1(4, value);
}

// private bool get__isLocalFlatCached() [instance] :5668
bool Visual::_isLocalFlatCached()
{
    return HasBit(8);
}

// private void set__isLocalFlatCached(bool value) [instance] :5669
void Visual::_isLocalFlatCached(bool value)
{
    SetBit1(8, value);
}

// public float get_AbsoluteZoom() [instance] :6108
...
// public void Add(Fuse.Node item) [instance] :4699
void Visual::Add1(::g::Fuse::Node* item)
{
    Insert1(::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])), item);
}

// public void AddDrawCost(double cost) [instance] :7119
...
// private void AddEventHandler(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne, object handler) [instance] :4977
...
// private void AddParameterChangedListener(Fuse.Scripting.Function func) [instance] :6527
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    if (_parameterListeners == NULL)
        _parameterListeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[84/*Uno.Collections.List<Fuse.Scripting.Function>*/]));

    ::g::Uno::Collections::List__Add_fn(uPtr(_parameterListeners), func);

    if (::g::Uno::String::op_Inequality(_parameter, NULL))
    {
        uObject* so = uAs<uObject*>(this, ::TYPES[85/*Fuse.Scripting.IScriptObject*/]);

        if (so != NULL)
            uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[10/*object[]*/], 1, (uObject*)uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[85/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter)));
    }
}

// internal void AdjustMarginBoxPosition(float2 position) [instance] :6282
void Visual::AdjustMarginBoxPosition(::g::Uno::Float2 position)
{
    ArrangeMarginBox(position, _ambLayoutParams);
}

// internal bool get_AreChildrenFlat() [instance] :5716
...
// public float2 ArrangeMarginBox(float2 position, Fuse.LayoutParams lp) [instance] :6249
...
// public void BeginInteraction(object id, Uno.Action cancelled) [instance] :5494
void Visual::BeginInteraction(uObject* id, uDelegate* cancelled)
{
    Visual__InteractionItem collection1;

    if (_interactions == NULL)
        _interactions = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[88/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>*/]));
...
// public void BeginRemoveChild(Fuse.Node n, [Uno.Action then]) [instance] :4478
void Visual::BeginRemoveChild(::g::Fuse::Node* n, uDelegate* then)
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/]), n, &ret11);
...
// public void BeginRemoveVisual(Fuse.Visual child, [Uno.Action then]) [instance] :4445
void Visual::BeginRemoveVisual(Visual* child, uDelegate* then)
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret12);
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret13), ret13))
        return;
...
// public void BringIntoView() [instance] :6318
void Visual::BringIntoView()
{
    OnBringIntoView(this);
}

// public void BringToFront(Fuse.Visual item) [instance] :7423
...
// internal bool CalcAreChildrenFlat() [instance] :5727
...
// internal Fuse.VisualBounds CalcRenderBoundsInParentSpace() [instance] :6961
...
// private Fuse.FastMatrix CalcWorldTransform() [instance] :6837
...
// public void CancelInteractions([Fuse.Visual.CancelInteractionsType how]) [instance] :5526
void Visual::CancelInteractions(int how)
{
    ...
    if (_interactions != NULL)
    {
        ::g::Uno::Collections::List* ids = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[49/*Uno.Collections.List<object>*/]);

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uObject*>, Visual__InteractionItem> enum2 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(_interactions), &ret16), ret16); enum2.MoveNext(::TYPES[90/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uObject*>, Visual__InteractionItem> i = enum2.Current(::TYPES[90/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]);
            ::g::Uno::Collections::List__Add_fn(uPtr(ids), i.Key(::TYPES[91/*Uno.Collections.KeyValuePair<object, Fuse.Visual.InteractionItem>*/]));
        }

        for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum3 = (::g::Uno::Collections::List__GetEnumerator_fn(ids, &ret17), ret17); enum3.MoveNext(::TYPES[92/*Uno.Collections.List<object>.Enumerator*/]); )
        {
            uObject* id = enum3.Current(::TYPES[92/*Uno.Collections.List<object>.Enumerator*/]);
...
// internal void CancelPendingRemove() [instance] :4500
...
// public Uno.Collections.IList<Fuse.Node> get_Children() [instance] :4591
uObject* Visual::Children()
{
    return (uObject*)this;
}

// private void Clear(Fuse.FastProperty1 p) [instance] :5087
...
// private void Clear(Fuse.FastProperty2 p) [instance] :5239
...
// internal void ClearBit(Fuse.FastProperty1 p) [instance] :5103
void Visual::ClearBit(int p)
{
    _fastPropertyBits1 = (_fastPropertyBits1 & ~p);
}

// internal void ClearBit(Fuse.FastProperty2 p) [instance] :5255
void Visual::ClearBit1(int p)
{
    _fastPropertyBits2 = (_fastPropertyBits2 ^ p);
}

// private void ClearBit(Fuse.Visual.VisualBits nb) [instance] :4964
void Visual::ClearBit2(int nb)
{
    _nodebits = (_nodebits & ~(1 << nb));
}

// internal void ConcludePendingRemove() [instance] :4508
void Visual::ConcludePendingRemove()
{
    ...
    if (HasBit(268435456))
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/]), this, &ret20);
        SetBit1(268435456, false);
    }
}

// public double get_DrawCost() [instance] :7117
double Visual::DrawCost()
{
    return _drawCost;
}

// private void DrawLocalRect(Fuse.DrawContext dc, Uno.Rect rect, float lineWidth, float4 color, float4x4 localToClipTransform) [instance] :4911
...
// protected void DrawLocalSelectionRect(Fuse.DrawContext dc, Uno.Rect rect) [instance] :4916
...
// private void EmitZOrderChanged() [instance] :7551
...
// public void EndInteraction(object id) [instance] :5503
...
// internal void EnsureSortedZOrder() [instance] :7500
void Visual::EnsureSortedZOrder()
{
    ...
    EnsureZOrder();
    uPtr(ZOrder())->Sort(uDelegate::New(::TYPES[93/*Uno.Comparison<Fuse.Visual>*/], (void*)Visual__ZOrderComparator_fn, this));
    _sortedZOrder = true;
...
// private void EnsureZOrder() [instance] :7516
...
// private Fuse.FastProperty1Link<T> Find<T>(Fuse.FastProperty1 p) [instance] :5150
...
// private Fuse.FastProperty2Link<T> Find<T>(Fuse.FastProperty2 p) [instance] :5302
...
// public T FindByType<T>() [instance] :7220
...
// private Fuse.FastProperty1Link FindPrevious(Fuse.FastProperty1 p) [instance] :5137
...
// private Fuse.FastProperty2Link FindPrevious(Fuse.FastProperty2 p) [instance] :5289
...
// public Uno.UX.Template FindTemplate(string key) [instance] :7029
::g::Uno::UX::Template* Visual::FindTemplate(uString* key)
{
    ...
    for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_templates), ::TYPES[96/*Uno.Collections.ICollection<Uno.UX.Template>*/])); (i--) > 0; )
    {
        ::g::Uno::UX::Template* t = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_templates), ::TYPES[97/*Uno.Collections.IList<Uno.UX.Template>*/]), uCRef<int>(i), &ret23), ret23);
...
// public Fuse.IViewport FindViewport() [instance] :7254
...
// public Fuse.Visual get_FirstVisualChild() [instance] :7348
Visual* Visual::FirstVisualChild()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        Visual* c = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret56), ret56), Visual_typeof());
...
// public Fuse.Visual GetHitWindowPoint(float2 windowPoint) [instance] :5387
Visual* Visual::GetHitWindowPoint(::g::Uno::Float2 windowPoint)
{
    Visual__HitTestRecord* htr = Visual__HitTestRecord::New1();
    ::g::Fuse::HitTestContext* htc = ::g::Fuse::HitTestContext::New1(windowPoint, uDelegate::New(::TYPES[98/*Fuse.HitTestCallback*/], (void*)Visual__HitTestRecord__HitTestCallback_fn, htr));
...
// public T GetNearestAncestorOfType<T>() [instance] :7226
...
// public float4x4 GetTransformTo(Fuse.Visual other) [instance] :6849
::g::Uno::Float4x4 Visual::GetTransformTo(Visual* other)
{
    bool ret25;
    bool ret26;
    ::g::Uno::Collections::HashSet* parents = (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[99/*Uno.Collections.HashSet<Fuse.Visual>*/]);
    Visual* q = this;
...
// private float4x4 GetTransformToAncestor(Fuse.Visual ancestor) [instance] :6878
...
// public Fuse.Visual GetZOrderChild(int index) [instance] :7402
...
// internal bool HasBit(Fuse.FastProperty1 p) [instance] :5098
bool Visual::HasBit(int p)
{
    return (_fastPropertyBits1 & p) != 0;
}

// internal bool HasBit(Fuse.FastProperty2 p) [instance] :5250
bool Visual::HasBit1(int p)
{
    return (_fastPropertyBits2 & p) != 0;
}

// private bool HasBit(Fuse.Visual.VisualBits nb) [instance] :4962
bool Visual::HasBit2(int nb)
{
    return (_nodebits & (1 << nb)) != 0;
}

// public bool get_HasChildren() [instance] :4544
bool Visual::HasChildren()
{
    if (_children == NULL)
        return false;

    if (uIs((uObject*)_children, ::TYPES[100/*Fuse.Node*/]))
        return true;

    ::g::Uno::Collections::List* list = uAs< ::g::Uno::Collections::List*>(_children, ::TYPES[40/*Uno.Collections.List<Fuse.Node>*/]);
    return uPtr(list)->Count() > 0;
}

// private bool get_HasExplicitTransforms() [instance] :6679
bool Visual::HasExplicitTransforms()
{
    return _transformCount > 0;
}

// internal bool get_HasMarginBox() [instance] :6227
bool Visual::HasMarginBox()
{
    return _hasMarginBox;
}

// public bool get_HasPendingRemove() [instance] :4517
bool Visual::HasPendingRemove()
{
    return HasBit(268435456);
}

// private bool get_HasResources() [instance] :6469
bool Visual::HasResources()
{
    return HasBit2(1);
}

// public bool get_HasVisualChildren() [instance] :7344
bool Visual::HasVisualChildren()
{
    return (_zOrder != NULL) && (uPtr(_zOrder)->Count() > 0);
}

// public void HitTest(Fuse.HitTestContext htc) [instance] :5345
...
// internal Fuse.Visual.HitTestTransformMode get_HitTestTransform() [instance] :5337
...
// protected float2 IfSnap(float2 p) [instance] :6075
::g::Uno::Float2 Visual::IfSnap(::g::Uno::Float2 p)
{
    return SnapToPixels() ? Snap(p) : p;
}

// protected float2 IfSnapDown(float2 p) [instance] :6100
::g::Uno::Float2 Visual::IfSnapDown(::g::Uno::Float2 p)
{
    return SnapToPixels() ? SnapDown(p) : p;
}

// protected float2 IfSnapUp(float2 p) [instance] :6080
::g::Uno::Float2 Visual::IfSnapUp(::g::Uno::Float2 p)
{
    return SnapToPixels() ? SnapUp(p) : p;
}

// public void Insert(int index, Fuse.Node item) [instance] :4744
void Visual::Insert1(int index, ::g::Fuse::Node* item)
{
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[63/*"index"*/]));
...
// private void InsertCleanup(Fuse.Node item) [instance] :4754
...
// private void InsertImpl(int index, Fuse.Node item) [instance] :4760
...
// internal void InsertNodes(int index, Uno.Collections.IEnumerator<Fuse.Node> items) [instance] :4776
void Visual::InsertNodes(int index, uObject* items)
{
    ...
    while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(items), ::TYPES[101/*Uno.Collections.IEnumerator*/])))
        InsertCleanup((::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[102/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret31), ret31));
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::IEnumerator::Reset(uInterface(uPtr(items), ::TYPES[101/*Uno.Collections.IEnumerator*/]));

        while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(items, ::TYPES[101/*Uno.Collections.IEnumerator*/])))
            InsertImpl(index++, (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[102/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret32), ret32));

        ::g::Uno::Collections::IEnumerator::Reset(uInterface(items, ::TYPES[101/*Uno.Collections.IEnumerator*/]));

        while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(items, ::TYPES[101/*Uno.Collections.IEnumerator*/])))
            OnAdded((::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[102/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret33), ret33));
    }
}

// internal Fuse.FastMatrix get_InternLocalTransformInternal() [instance] :6808
::g::Fuse::FastMatrix* Visual::InternLocalTransformInternal()
{
    return LocalTransformInternal();
}

// internal float2 InternSnap(float2 p) [instance] :6068
::g::Uno::Float2 Visual::InternSnap(::g::Uno::Float2 p)
{
    return Snap(p);
}

// internal float2 InternSnapUp(float2 p) [instance] :6087
::g::Uno::Float2 Visual::InternSnapUp(::g::Uno::Float2 p)
{
    return SnapUp(p);
}

// internal void InvalidateFlat() [instance] :5655
...
// protected void InvalidateHitTestBounds() [instance] :5408
...
// public void InvalidateLayout([Fuse.InvalidateLayoutReason reason]) [instance] :5981
void Visual::InvalidateLayout(int reason)
{
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[64/*"Layout was ...*/]));
...
// protected void InvalidateRenderBounds() [instance] :6940
...
// public void InvalidateVisual() [instance] :7289
...
// public void InvalidateVisualComposition() [instance] :7309
...
// private void InvalidateWorldTransform() [instance] :6725
...
// private void InvalidateZOrder() [instance] :7557
...
// private void InvokeEventHandler(object obj, object args) [instance] :4971
void Visual::InvokeEventHandler(uObject* obj, uObject* args)
{
    uPtr(uCast<uDelegate*>(obj, ::TYPES[2/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[103/*Uno.EventArgs*/]));
}

// public bool get_IsContextEnabled() [instance] :5617
bool Visual::IsContextEnabled()
{
    return HasBit(2);
}

// public void add_IsContextEnabledChanged(Uno.EventHandler value) [instance] :5574
void Visual::add_IsContextEnabledChanged(uDelegate* value)
{
    AddEventHandler(Visual::_isContextEnabledChangedHandle(), 4, value);
}

// public void remove_IsContextEnabledChanged(Uno.EventHandler value) [instance] :5575
...
// public bool get_IsEnabled() [instance] :5590
bool Visual::IsEnabled()
{
    return HasBit(1);
}

// public void set_IsEnabled(bool value) [instance] :5591
...
// public generated void add_IsInteractingChanged(Uno.EventHandler value) [instance] :5484
void Visual::add_IsInteractingChanged(uDelegate* value)
{
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(IsInteractingChanged1, value), ::TYPES[2/*Uno.EventHandler*/]);
}

// public generated void remove_IsInteractingChanged(Uno.EventHandler value) [instance] :5484
void Visual::remove_IsInteractingChanged(uDelegate* value)
{
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(IsInteractingChanged1, value), ::TYPES[2/*Uno.EventHandler*/]);
}

// internal bool get_IsLocalFlat() [instance] :5680
...
// public bool get_IsVisible() [instance] :5773
bool Visual::IsVisible()
{
    return _isVisibleCached;
}

// public Fuse.Layer get_Layer() [instance] :5912
int Visual::Layer()
{
    uObject* v;
...
// public void set_Layer(Fuse.Layer value) [instance] :5919
...
// public Fuse.LayoutRole get_LayoutRole() [instance] :5934
...
// public void set_LayoutRole(Fuse.LayoutRole value) [instance] :5946
...
// public float4x4 get_LocalTransform() [instance] :6802
::g::Uno::Float4x4 Visual::LocalTransform()
{
    return uPtr(LocalTransformInternal())->Matrix();
}

// protected Fuse.FastMatrix get_LocalTransformInternal() [instance] :6812
...
// protected float4x4 get_LocalTransformInverse() [instance] :6826
...
// private void MakeNodeList(Fuse.Node newItem) [instance] :4633
void Visual::MakeNodeList(::g::Fuse::Node* newItem)
{
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[40/*Uno.Collections.List<Fuse.Node>*/]);
    ::g::Fuse::Node* oldItem = uAs< ::g::Fuse::Node*>(_children, ::TYPES[100/*Fuse.Node*/]);
...
// internal float2 get_MarginBoxPosition() [instance] :6280
::g::Uno::Float2 Visual::MarginBoxPosition()
{
    return _ambPosition;
}

// private Fuse.Node get_Node() [instance] :4630
::g::Fuse::Node* Visual::Node()
{
    return uAs< ::g::Fuse::Node*>(_children, ::TYPES[100/*Fuse.Node*/]);
}

// private Uno.Collections.List<Fuse.Node> get_NodeList() [instance] :4631
::g::Uno::Collections::List* Visual::NodeList()
{
    return uAs< ::g::Uno::Collections::List*>(_children, ::TYPES[40/*Uno.Collections.List<Fuse.Node>*/]);
}

// private void OnAdded(Fuse.Node b) [instance] :4642
void Visual::OnAdded(::g::Fuse::Node* b)
{
    ...
    ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>(b, ::TYPES[89/*Fuse.Transform*/]);
...
// protected void OnBeginRemoveVisual(Fuse.PendingRemoveVisual args) [instance] :4489
void Visual::OnBeginRemoveVisual(::g::Fuse::PendingRemoveVisual* args)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        uObject* rvl = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret34), ret34), ::TYPES[104/*Fuse.IBeginRemoveVisualListener*/]);

        if (rvl != NULL)
            ::g::Fuse::IBeginRemoveVisualListener::OnBeginRemoveVisual(uInterface(uPtr(rvl), ::TYPES[104/*Fuse.IBeginRemoveVisualListener*/]), args);
    }
}

// protected internal void OnBringIntoView(Fuse.Visual elm) [instance] :6309
...
// private void OnInteractionsChanged() [instance] :5515
...
// private void OnInvalidateChildZOffset(Fuse.Visual child) [instance] :7525
void Visual::OnInvalidateChildZOffset(Visual* child)
{
    SoftInvalidateZOrder(false);
}

// protected void OnInvalidateWorldTransform() [instance] :6746
void Visual::OnInvalidateWorldTransform()
{
    RaiseEvent(Visual::_worldTransformInvalidatedHandle(), 10);
}

// protected void OnIsContextEnabledChanged() [instance] :5634
...
// private void OnIsEnabledChanged(Uno.UX.IPropertyListener origin) [instance] :5602
void Visual::OnIsEnabledChanged(uObject* origin)
{
    OnPropertyChanged1(Visual::_isEnabledName(), origin);
}

// protected void OnLocalVisibleChanged() [instance] :5782
void Visual::OnLocalVisibleChanged()
{
    UpdateIsVisibleCache();
}

// private void OnMatrixChanged(Fuse.Transform t) [instance] :6711
void Visual::OnMatrixChanged(::g::Fuse::Transform* t)
{
    InvalidateLocalTransform();
}

// private void OnParameterChanged() [instance] :6544
void Visual::OnParameterChanged()
{
    ...
    if (_parameterListeners != NULL)
    {
        ...
        if (so != NULL)
        {
            uObject* param = uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[85/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter);
...
// private void OnRemoved(Fuse.Node b) [instance] :4654
...
// private void OnResourceChanged(Uno.UX.Resource res) [instance] :6472
void Visual::OnResourceChanged(::g::Uno::UX::Resource* res)
{
    ::g::Fuse::Resources::ResourceRegistry::NotifyResourceChanged(uPtr(res)->Key());
}

// public void OnSubtreeDataContextChanged() [instance] :7152
void Visual::OnSubtreeDataContextChanged()
{
    uArray* children = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[106/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], Children());

    for (int i = 0; i < uPtr(children)->Length(); i++)
        uPtr(uPtr(children)->Strong< ::g::Fuse::Node*>(i))->OnDataContextChanged();
}

// private void OnTransformAdded(Fuse.Transform t) [instance] :6697
...
// private void OnTransformRemoved(Fuse.Transform t) [instance] :6704
...
// private void OnVisualAdded(Fuse.Visual v) [instance] :4666
...
// private void OnVisualRemoved(Fuse.Visual v) [instance] :4674
...
// public string get_Parameter() [instance] :6514
uString* Visual::Parameter()
{
    return _parameter;
}

// public void set_Parameter(string value) [instance] :6515
...
// public float2 ParentToLocal(float2 parentPoint) [instance] :7240
...
// protected void PerformLayout() [instance] :6156
...
// protected void PerformLayout(float2 clientSize) [instance] :6164
...
// private void PrependExplicitTransforms(Fuse.FastMatrix m) [instance] :6897
void Visual::PrependExplicitTransforms(::g::Fuse::FastMatrix* m)
{
    ...
    if (HasExplicitTransforms())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret41), ret41), ::TYPES[89/*Fuse.Transform*/]);
...
// private void PrependLocalTransform(Fuse.FastMatrix m) [instance] :6891
...
// private void RaiseEvent(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne) [instance] :4966
void Visual::RaiseEvent(::g::Fuse::PropertyHandle* ph, int ne)
{
    if (HasBit2(ne))
        uPtr(Properties())->ForeachInList1(ph, uDelegate::New(::TYPES[107/*Uno.Action<object, object>*/], (void*)Visual__InvokeEventHandler_fn, this), ::g::Uno::EventArgs::Empty());
}

// private void RearrangeMarginBox() [instance] :6229
void Visual::RearrangeMarginBox()
{
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[65/*"Invalid cal...*/]));

    ArrangeMarginBox(_ambPosition, _ambLayoutParams);
}

// public bool Remove(Fuse.Node item) [instance] :4704
bool Visual::Remove1(::g::Fuse::Node* item)
{
    ...
    else if ((_children == NULL) || uIs((uObject*)_children, ::TYPES[100/*Fuse.Node*/]))
        r = false;
    else
...
// public void RemoveAllChildren<T>() [instance] :4572
void Visual::RemoveAllChildren(uType* __type)
{
    ...
    ::g::Fuse::Node* ret43;
    int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])) - 1;

    while (i >= 0)
    {
        if (uIs((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret43), ret43), __types[0]))
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), i);

        i = ::g::Uno::Math::Min8(i, ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/]))) - 1;
    }
}

// public void RemoveDrawCost(double cost) [instance] :7129
...
// private void RemoveEventHandler(Fuse.PropertyHandle ph, Fuse.Visual.VisualBits ne, object handler) [instance] :4983
...
// public generated void add_RequestBringIntoView(Fuse.RequestBringIntoViewHandler value) [instance] :6307
void Visual::add_RequestBringIntoView(uDelegate* value)
{
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RequestBringIntoView1, value), ::TYPES[113/*Fuse.RequestBringIntoViewHandler*/]);
}

// public generated void remove_RequestBringIntoView(Fuse.RequestBringIntoViewHandler value) [instance] :6307
void Visual::remove_RequestBringIntoView(uDelegate* value)
{
    RequestBringIntoView1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RequestBringIntoView1, value), ::TYPES[113/*Fuse.RequestBringIntoViewHandler*/]);
}

// private void ResetParameterListeners() [instance] :6559
void Visual::ResetParameterListeners()
{
    _parameterListeners = NULL;
}

// public Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :6417
uObject* Visual::Resources()
{
    if (!HasResources())
    {
        SetBit4(1);
        uPtr(Properties())->Set(Visual::_resourcesHandle(), (::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[111/*Uno.Collections.ObservableList<Uno.UX.Resource>*/], uDelegate::New(::TYPES[112/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this), uDelegate::New(::TYPES[112/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this)));
    }

    return (uObject*)uPtr(Properties())->Get(Visual::_resourcesHandle());
}

// public void SendToBack(Fuse.Visual item) [instance] :7444
...
// internal void SetBit(Fuse.FastProperty1 p) [instance] :5108
void Visual::SetBit(int p)
{
    _fastPropertyBits1 = (_fastPropertyBits1 | p);
}

// internal void SetBit(Fuse.FastProperty1 p, bool value) [instance] :5113
...
// internal void SetBit(Fuse.FastProperty2 p) [instance] :5260
void Visual::SetBit2(int p)
{
    _fastPropertyBits2 = (_fastPropertyBits2 | p);
}

// private void SetBit(Fuse.Visual.VisualBits nb) [instance] :4963
void Visual::SetBit4(int nb)
{
    _nodebits = (_nodebits | (1 << nb));
}

// public void SetResource(string key, object value) [instance] :6428
void Visual::SetResource(uString* key, uObject* value)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[108/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); ++i)
    {
        ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[109/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret45), ret45);

        if (::g::Uno::String::op_Equality(uPtr(r)->Key(), key))
        {
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(resources), ::TYPES[109/*Uno.Collections.IList<Uno.UX.Resource>*/]), i);
            break;
        }
    }

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(resources), ::TYPES[108/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), ::g::Uno::UX::Resource::New1(key, value));
}

// protected float2 Snap(float2 p) [instance] :6069
...
// protected float2 SnapDown(float2 p) [instance] :6094
...
// public bool get_SnapToPixels() [instance] :6122
bool Visual::SnapToPixels()
{
    return HasBit(67108864);
}

// public void set_SnapToPixels(bool value) [instance] :6126
...
// protected float2 SnapUp(float2 p) [instance] :6088
...
// private void SoftInvalidateZOrder([bool force]) [instance] :7535
void Visual::SoftInvalidateZOrder(bool force)
{
    ...
    if (::g::Uno::Delegate::op_Inequality(ZOrderChanged1, NULL))
        ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Visual__EmitZOrderChanged_fn, this), -1, 0);
}

// private void UpdateContextSnapToPixelsCache() [instance] :6138
void Visual::UpdateContextSnapToPixelsCache()
{
    ...
    if (newValue != SnapToPixels())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret53), ret53), Visual_typeof());
...
// private void UpdateIsContextEnabledCache() [instance] :5620
...
// private void UpdateIsVisibleCache() [instance] :5787
...
// private void UpdateLayout() [instance] :6198
void Visual::UpdateLayout()
{
    ...
    switch (_layoutDirty)
    {
        ...
        case 1:
        {
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
            {
                Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[60/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret54), ret54), Visual_typeof());
...
// public int get_ValidFrameCount() [instance] :7326
int Visual::ValidFrameCount()
{
    return ::g::Fuse::UpdateManager::FrameIndex() - _lastInvalidate;
}

// public Fuse.IViewport get_Viewport() [instance] :7270
...
// public float2 WindowToLocal(float2 windowCoord) [instance] :6911
...
// public float3 get_WorldPosition() [instance] :6775
...
// public float4x4 get_WorldTransform() [instance] :6767
::g::Uno::Float4x4 Visual::WorldTransform()
{
    return uPtr(WorldTransformInternal())->Matrix();
}

// private Fuse.FastMatrix get_WorldTransformInternal() [instance] :6786
...
// public float4x4 get_WorldTransformInverse() [instance] :6754
...
// public float get_ZOffset() [instance] :6337
float Visual::ZOffset()
{
    return _zOffset;
}

// public void set_ZOffset(float value) [instance] :6338
...
// internal Uno.Collections.List<Fuse.Visual> get_ZOrder() [instance] :7410
...
// internal generated void add_ZOrderChanged(Uno.EventHandler value) [instance] :7530
void Visual::add_ZOrderChanged(uDelegate* value)
{
    ZOrderChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ZOrderChanged1, value), ::TYPES[2/*Uno.EventHandler*/]);
}

// internal generated void remove_ZOrderChanged(Uno.EventHandler value) [instance] :7530
void Visual::remove_ZOrderChanged(uDelegate* value)
{
    ZOrderChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ZOrderChanged1, value), ::TYPES[2/*Uno.EventHandler*/]);
}

// public int get_ZOrderChildCount() [instance] :7395
...
// private int ZOrderComparator(Fuse.Visual a, Fuse.Visual b) [instance] :7462
...
// private static void AssignZOrder(Uno.Collections.IList<Fuse.Node> nodes) [static] :7473
void Visual::AssignZOrder(uObject* nodes)
{
    Visual_typeof()->Init();
    ::g::Fuse::Node* ret10;
    uArray* current = uArray::Init<int>(::TYPES[87/*int[]*/], 4, 0, 0, 0, 0);

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
...
// private static void bringIntoView(Fuse.Scripting.Context c, Fuse.Visual n, object[] args) [static] :6611
...
// private static Uno.UX.Property<string> getParameterProperty(Fuse.Visual v) [static] :6599
...
// private static void onParameterChanged(Fuse.Scripting.Context c, Fuse.Visual v, object[] args) [static] :6637
void Visual::onParameterChanged(::g::Fuse::Scripting::Context* c, Visual* v, uArray* args)
{
    Visual_typeof()->Init();
    uPtr(v)->AddParameterChangedListener(uCast< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[47/*Fuse.Scripting.Function*/]));
}
// }
...
// private enum Visual.VisualBits :4947
...
// public sealed class VisualBounds :4139
// {
// static VisualBounds() :4139
...
// private VisualBounds() :4141
void VisualBounds__ctor__fn(VisualBounds* __this)
{
    __this->ctor_();
}

// public Fuse.VisualBounds AddRect(float2 mn, float2 mx) :4222
...
// public Fuse.VisualBounds IntersectXY(Fuse.VisualBounds nb) :4307
...
// public Fuse.VisualBounds MergeChild(Fuse.Visual child, Fuse.VisualBounds nb) :4326
...
// private VisualBounds() [instance] :4141
void VisualBounds::ctor_()
{
}

// public Fuse.VisualBounds AddRect(float2 mn, float2 mx) [instance] :4222
...
// public Fuse.VisualBounds AddRect(Uno.Rect r) [instance] :4227
VisualBounds* VisualBounds::AddRect1(::g::Uno::Rect r)
{
    return AddRect(r.Minimum(), r.Maximum());
}

// public float3 get_AxisMax() [instance] :4199
::g::Uno::Float3 VisualBounds::AxisMax()
{
    return _box.Maximum;
}

// public float3 get_AxisMin() [instance] :4198
::g::Uno::Float3 VisualBounds::AxisMin()
{
    return _box.Minimum;
}

// public bool ContainsPoint(float2 pt) [instance] :4331
...
// public Uno.Rect get_FlatRect() [instance] :4204
...
// public Fuse.VisualBounds InflateXY(float padding) [instance] :4235
...
// public bool IntersectsRay(Uno.Geometry.Ray ray) [instance] :4343
...
// public Fuse.VisualBounds IntersectXY(Fuse.VisualBounds nb) [instance] :4307
...
// public bool get_IsEmpty() [instance] :4151
bool VisualBounds::IsEmpty()
{
    return this == VisualBounds::_empty();
}

// public bool get_IsFlat() [instance] :4209
bool VisualBounds::IsFlat()
{
    return IsEmpty() || ((_box.Minimum.Z == 0.0f) && (_box.Maximum.Z == 0.0f));
}

// public bool get_IsInfinite() [instance] :4162
bool VisualBounds::IsInfinite()
{
    return this == VisualBounds::_infinite();
}

// public Fuse.VisualBounds Merge(Fuse.VisualBounds nb, [Fuse.FastMatrix trans]) [instance] :4283
...
// public Fuse.VisualBounds MergeChild(Fuse.Visual child, Fuse.VisualBounds nb) [instance] :4326
...
// public float3 get_Size() [instance] :4200
::g::Uno::Float3 VisualBounds::Size()
{
    return ::g::Uno::Float3__op_Subtraction2(_box.Maximum, _box.Minimum);
}

// public Fuse.VisualBounds Translate(float3 offset) [instance] :4250
...
// public static Fuse.VisualBounds Box(Uno.Geometry.Box a) [static] :4189
...
// public static Uno.Geometry.Box BoxTransform(Uno.Geometry.Box box, float4x4 transform) [static] :4365
...
// private VisualBounds New() [static] :4141
...
// public static Fuse.VisualBounds Rect(float2 a, float2 b) [static] :4184
...
// public static Fuse.VisualBounds Rect(float3 a, float3 b) [static] :4176
...
// public static Fuse.VisualBounds get_Empty() [static] :4146
...
// public static Fuse.VisualBounds get_Infinite() [static] :4157
...
// public enum VisualContext :7055
...
// public abstract class VisualEvent<THandler, TArgs> :1610
// {
static void VisualEvent_build(uType* type)
{
    ::STRINGS[66] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[5] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/$.uno");
    ::TYPES[114] = ::g::Uno::Collections::List_typeof();
    ::TYPES[32] = ::g::Uno::Exception_typeof();
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[115] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array());
    ::TYPES[10] = uObject_typeof()->Array();
    type->SetPrecalc(
...
// protected generated VisualEvent() :1610
void VisualEvent__ctor__fn(VisualEvent* __this)
{
    __this->ctor_();
}

// public void AddGlobalHandler(THandler handler) :1625
...
// public void AddHandler(Fuse.Visual visual, THandler handler) :1614
...
// private void InvokeGlobalHandlers(Fuse.Visual visual, TArgs args) :1635
...
// private void InvokeInternal(THandler handler, object sender, TArgs args) :1712
...
// private void OnRaise(object target, object[] args) :1695
void VisualEvent__OnRaise_fn(VisualEvent* __this, uObject* target, uArray* args)
{
    __this->OnRaise(target, args);
}

// private void OnRaiseEnabled(object target, object[] args) :1703
void VisualEvent__OnRaiseEnabled_fn(VisualEvent* __this, uObject* target, uArray* args)
{
    __this->OnRaiseEnabled(target, args);
}

// private void Raise(TArgs args, Fuse.VisualEventMode type, bool bubble, [Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction]) :1660
...
// public void RaiseWithBubble(TArgs args, [Fuse.VisualEventMode type]) :1644
...
// internal void RaiseWithBubble(TArgs args, Fuse.VisualEventMode type, Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction) :1649
...
// public void RaiseWithoutBubble(TArgs args, [Fuse.VisualEventMode type]) :1655
...
// public void RemoveGlobalHandler(THandler handler) :1630
...
// public void RemoveHandler(Fuse.Visual visual, THandler handler) :1619
...
// protected generated VisualEvent() [instance] :1610
...
// private void InvokeGlobalHandlers(Fuse.Visual visual, TArgs args) [instance] :1635
...
// private void OnRaise(object target, object[] args) [instance] :1695
...
// private void OnRaiseEnabled(object target, object[] args) [instance] :1703
...
// private void Raise(TArgs args, Fuse.VisualEventMode type, bool bubble, [Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction]) [instance] :1660
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[115/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[115/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[66/*"Invalid Rai...*/], 1, ::STRINGS[5/*"/usr/local/...*/], 1672);
            return;
        }
    }
...
// public void RaiseWithBubble(TArgs args, [Fuse.VisualEventMode type]) [instance] :1644
void VisualEvent::RaiseWithBubble(::g::Fuse::VisualEventArgs* args, int type)
{
    Raise(args, type, true, NULL);
}

// internal void RaiseWithBubble(TArgs args, Fuse.VisualEventMode type, Uno.Action<TArgs, Uno.Collections.IList<Fuse.Visual>> PostBubbleAction) [instance] :1649
...
// public void RaiseWithoutBubble(TArgs args, [Fuse.VisualEventMode type]) [instance] :1655
...
// public class VisualEventArgs :1728
// {
static void VisualEventArgs_build(uType* type)
{
    ::STRINGS[67] = uString::Const("visual");
    type->SetFields(0,
...
// public delegate void VisualEventHandler(object sender, Fuse.VisualEventArgs args) :1752
...
// public enum VisualEventMode :1575
...
// internal static class VisualListCache :1588
// {
// static VisualListCache() :1588
static void VisualListCache__cctor__fn(uType* __type)
{
    VisualListCache::_visualListCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[116/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/]));
}

static void VisualListCache_build(uType* type)
{
    ::TYPES[116] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof()));
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof());
    type->SetFields(0,
...
// public static Uno.Collections.List<Fuse.Visual> Acquire() :1592
void VisualListCache__Acquire_fn(::g::Uno::Collections::List** __retval)
{
    *__retval = VisualListCache::Acquire();
}

// public static void Release(Uno.Collections.List<Fuse.Visual> list) :1603
...
// public static Uno.Collections.List<Fuse.Visual> Acquire() [static] :1592
...
// public static void Release(Uno.Collections.List<Fuse.Visual> list) [static] :1603
...
// private sealed class TranslationModes.WidthMode :9650
// {
...
// public generated WidthMode() :9650
void TranslationModes__WidthMode__ctor_1_fn(TranslationModes__WidthMode* __this)
{
    __this->ctor_1();
}

// public override sealed float3 GetAbsVector(Fuse.Translation t) :9652
...
// internal sealed class WrapException :10231
// {
static void WrapException_build(uType* type)
{
    ::STRINGS[68] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
// public WrapException(Uno.Exception inner) :10233
void WrapException__ctor_3_fn(WrapException* __this, ::g::Uno::Exception* inner)
{
    __this->ctor_3(inner);
}

// public override sealed string get_Message() :10257
...
// public static Uno.Exception Unwrap(Uno.Exception e) :10240
void WrapException__Unwrap_fn(::g::Uno::Exception* e, ::g::Uno::Exception** __retval)
{
    *__retval = WrapException::Unwrap(e);
}

// public WrapException(Uno.Exception inner) [instance] :10233
void WrapException::ctor_3(::g::Uno::Exception* inner)
{
    ctor_2(::STRINGS[68/*"Wrapped Exc...*/], inner);
}

// public WrapException New(Uno.Exception inner) [static] :10233
...
// public static Uno.Exception Unwrap(Uno.Exception e) [static] :10240
