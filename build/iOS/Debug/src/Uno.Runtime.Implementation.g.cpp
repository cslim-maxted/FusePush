...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/runtime/implementation/$.uno
// ------------------------------------------------------------------------------------
...
static void ArrayCopyImpl_build(uType* type)
{
    ...
    type->SetPrecalc(
        ArrayCopyImpl_typeof()->MakeMethod(1, type->U(0)));
}
...
static void ArraySortImpl_build(uType* type)
{
    ...
    type->SetPrecalc(
        ArraySortImpl_typeof()->MakeMethod(1, type->U(0)),
        ArraySortImpl_typeof()->MakeMethod(1, type->U(0)),
        ArraySortImpl_typeof()->MakeMethod(1, type->U(0)),
        ArraySortImpl_typeof()->MakeMethod(1, type->U(0)),
        ArraySortImpl_typeof()->MakeMethod(1, type->U(0)),
...
void ArraySortImpl::ShellSort(uType* __type, uArray* data, uDelegate* comparison, int left, int right)
{
    uType* __types[] = {
        __type->U(0),
        __type->Precalced(2/*Uno.Runtime.Implementation.ArraySortImpl.Swap<T>*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(3/*Uno.Runtime.Implementation.ArraySortImpl.ValidateArguments<T>*/),
        __type->Precalced(4/*Uno.Runtime.Implementation.ArraySortImpl.QuickSort<T>*/),
        __type->Precalced(5/*Uno.Runtime.Implementation.ArraySortImpl.ShellSort<T>*/),
    };
...
{
    ::TYPES[0] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::SystemUIWillResizeEventArgs_typeof());
    type->SetFields(0,
