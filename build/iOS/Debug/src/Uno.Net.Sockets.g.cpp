...
// /usr/local/share/uno/Packages/Uno.Net.Sockets/0.38.2/$.uno
// ----------------------------------------------------------
...
// public override sealed void Write(byte[] src, int byteOffset, int byteCount) :391
...
// public sealed class Socket :676
// {
// ~Socket() :959
...
// public void Dispose() :954
void Socket__Dispose_fn(Socket* __this)
{
    __this->Dispose();
}

// protected void Dispose(bool disposing) :935
void Socket__Dispose1_fn(Socket* __this, bool* disposing)
{
    __this->Dispose1(*disposing);
}

// public int Receive(byte[] buffer, int offset, int length, Uno.Net.Sockets.SocketFlags flags) :823
...
// public int Send(byte[] buffer, int offset, int length) :805
...
// public void Dispose() [instance] :954
void Socket::Dispose()
{
    Dispose1(true);
}

// protected void Dispose(bool disposing) [instance] :935
...
// public int Receive(byte[] buffer, int offset, int length, Uno.Net.Sockets.SocketFlags flags) [instance] :823
...
// public int Send(byte[] buffer, int offset, int length) [instance] :805
...
// public sealed class SocketException :966
// {
...
// internal extern struct Socket.SocketHandle :683
// {
