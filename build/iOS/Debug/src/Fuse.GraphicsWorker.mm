...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/$.uno");
    ::STRINGS[3] = uString::Const("Run");
    ::TYPES[0] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[3] = ::g::Uno::EventHandler_typeof();
    ::TYPES[4] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Action_typeof());
    type->SetFields(0,
...
// private static extern ObjC.Object CreateContext() :2387
...
// private static extern void SetCurrentContext(ObjC.Object context) :2393
...
// private static extern ObjC.Object CreateContext() [static] :2387
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[1/*"GraphicsWor...*/], e, a, ::STRINGS[2/*"/usr/local/...*/], 2452, ::STRINGS[3/*"Run"*/]);
...
// private static extern void SetCurrentContext(ObjC.Object context) [static] :2393
