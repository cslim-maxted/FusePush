...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/0.38.6/ios/$.uno
// --------------------------------------------------------------------
...
static void WebView__Finalize_fn(WebView* __this)
{
    if (__this->Handle1 != NULL)
        ::g::Uno::Platform2::Application::remove_ReceivedLowMemoryWarning(uDelegate::New(::TYPES[0/*Uno.EventHandler*/], (void*)WebView__OnLowMemory_fn, __this));

    if (__this->_isUpdating)
        __this->_isUpdating = false;

    ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)WebView__OnUpdate_fn, __this), 0);
}
...
static void WebView_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.WebView/0.38.6/ios/$.uno");
...
// private void OnLowMemory(object sender, Uno.EventArgs args) :223
...
void WebView::ctor_2(::g::Fuse::Controls::WebView* webViewHost, uObject* wvHandle)
{
    ...
    Handle1 = wvHandle;
    NavigationDelegate = ::g::Fuse::iOS::Controls::NavDelegate::Create(uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)WebView__OnBeginNavigation_fn, this), uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)WebView__OnFinishNavigation_fn, this), uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)WebView__OnURLChanged_fn, this));
    ::g::Fuse::iOS::Controls::WKWebViewHelpers::SetNavigationDelegate(Handle1, NavigationDelegate);
    ::g::Uno::Platform2::Application::add_ReceivedLowMemoryWarning(uDelegate::New(::TYPES[0/*Uno.EventHandler*/], (void*)WebView__OnLowMemory_fn, this));
...
{
    BeginLoading1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(BeginLoading1, value), ::TYPES[0/*Uno.EventHandler*/]);
}
...
{
    BeginLoading1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(BeginLoading1, value), ::TYPES[0/*Uno.EventHandler*/]);
}
...
// private void OnLowMemory(object sender, Uno.EventArgs args) [instance] :223
...
void WebView::OnUpdate()
{
    ...
    {
        _isUpdating = false;
        ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)WebView__OnUpdate_fn, this), 0);
    }
}
...
{
    PageLoaded1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PageLoaded1, value), ::TYPES[0/*Uno.EventHandler*/]);
}
...
{
    PageLoaded1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PageLoaded1, value), ::TYPES[0/*Uno.EventHandler*/]);
}
...
{
    if (!_isUpdating)
        ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[1/*Uno.Action*/], (void*)WebView__OnUpdate_fn, this), 0);
}
...
{
    UrlChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(UrlChanged1, value), ::TYPES[0/*Uno.EventHandler*/]);
}
...
{
    UrlChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(UrlChanged1, value), ::TYPES[0/*Uno.EventHandler*/]);
}
