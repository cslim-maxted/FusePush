...
// internal sealed class Blitter :1018
// {
// static Blitter() :1018
...
// public generated Blitter() :1018
void Blitter__ctor__fn(Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Visual where, texture2D vt, float2 pos, float2 size) :1022
...
// private generated void init_DrawCalls() :1018
void Blitter__init_DrawCalls_fn(Blitter* __this)
{
    __this->init_DrawCalls();
}

// public generated Blitter New() :1018
...
// public generated Blitter() [instance] :1018
void Blitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Visual where, texture2D vt, float2 pos, float2 size) [instance] :1022
...
// private generated void init_DrawCalls() [instance] :1018
...
// public generated Blitter New() [static] :1018
...
// internal extern struct CGColorSpaceRef :860
// {
...
// internal extern struct CGContextRef :864
// {
...
// internal extern struct CGFontRef :359
// {
static void CGFontRef_build(uType* type)
{
    type->SetFields(0,
        ::g::Uno::IntPtr_typeof(), offsetof(::g::Fuse::iOS::Bindings::CGFontRef, _dummy), 0);
}
...
uStructType* CGFontRef_typeof()
{
    ...
    uTypeOptions options;
    options.FieldCount = 1;
    options.ValueSize = sizeof(::CGFontRef);
    options.TypeSize = sizeof(uStructType);
    type = uStructType::New("Fuse.iOS.Bindings.CGFontRef", options);
