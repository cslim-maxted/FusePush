...
//    #endif
    {
        return com.maxted.fusetest.commaxtedfusetest.RootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.maxted.fusetest.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.maxted.fusetest.commaxtedfusetest activity = (com.maxted.fusetest.commaxtedfusetest)getRootActivity();
