...
public class TextEditRenderer
{
    ...
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.maxted.fusetest.commaxtedfusetest.GetRootActivity());
    ...
    {
        android.widget.TextView tv = new android.widget.TextView(com.maxted.fusetest.commaxtedfusetest.GetRootActivity());
