    ...
    public static Object CreateTouchListener80()
    {
        return new android.view.View.OnTouchListener() {
        					public boolean onTouch(android.view.View view, android.view.MotionEvent e) {
        						return ExternedBlockHost.callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch81(view,e,UnoHelper.GetUnoObjectRef(view),UnoHelper.GetUnoObjectRef(e));
        					}
        				};
    }
