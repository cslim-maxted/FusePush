...
public class XliCppThreadHandler extends Handler {
	...
	private void handleRepeating(Message msg)
	{
		if (msg.arg1 == xliCallbackIndex) {
            com.maxted.fusetest.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1); // {TODO} this should own callback
			...
			com.maxted.fusetest.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1);
