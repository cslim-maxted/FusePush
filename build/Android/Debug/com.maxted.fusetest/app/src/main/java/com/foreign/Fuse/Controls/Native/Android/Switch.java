...
public class Switch
{
    ...
    public static void AddCallback136(final Object _this, final Object handle)
    {
        ((android.widget.Switch)handle).setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener() {
        				public void onCheckedChanged(android.widget.CompoundButton buttonView, boolean isChecked) {
        					ExternedBlockHost.callUno_Fuse_Controls_Native_Android_Switch_OnToggleChanged137(_this,isChecked);
        				}
        			});
    }
    ...
    {
        return new android.widget.Switch(com.maxted.fusetest.commaxtedfusetest.GetRootActivity());
    }
