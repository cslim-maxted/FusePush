...
//#else
public class commaxtedfusetest extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	commaxtedfusetest activity = _appState.CurrentActivity;
...
//#endif
    ...
    public static commaxtedfusetest RootActivity()
    {
        return _appState.CurrentActivity;
    }
