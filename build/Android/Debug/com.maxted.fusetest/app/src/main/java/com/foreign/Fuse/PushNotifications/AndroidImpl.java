...
public class AndroidImpl
{
        ...
        Activity activity = com.fuse.Activity.getRootActivity();
        			...
        			if (resultCode != ConnectionResult.SUCCESS) {
        				if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
        					GooglePlayServicesUtil.getErrorDialog(resultCode, activity, ExternedBlockHost.callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet273()).show();
        				} else {
        			...
        			com.fuse.Activity.subscribeToIntents(
        				new com.fuse.Activity.IntentListener() {
        					public void onIntent (Intent newIntent) {
        						ExternedBlockHost.callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve276(newIntent.getExtras(),UnoHelper.GetUnoObjectRef(newIntent.getExtras()));
        					}
        				},
        				PushNotificationReceiver.ACTION);
        
        			// Set up GCM
        			final String senderID = ExternedBlockHost.callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet277();
        			final Activity activity = com.fuse.Activity.getRootActivity();
        			activity.runOnUiThread(new Runnable() {
        					@Override
        						public void run() {
        						// Check device for Play Services APK. If check succeeds, proceed with GCM registration.
        						if (com.foreign.Fuse.PushNotifications.AndroidImpl.CheckPlayServices272()) {
        							...
        							new AsyncTask<Void, Void, String>() {
        								@Override protected String doInBackground(Void... params) {
        									...
        									try {
        										...
        										ExternedBlockHost.callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess278(_regID);
        										return "Device registered, registration ID=" + _regID;
        									} catch (java.io.IOException ex) {
        										msg = "Error :" + ex.getMessage();
        										ExternedBlockHost.callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError279(msg);
        										return msg;
        									}
        								}
        ...
        PushNotificationReceiver.InForeground = isItInteractive;
        			...
        			if (isItInteractive && bundles!=null && bundles.size()>0) {
        				for (Bundle bundle : bundles)
        					ExternedBlockHost.callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve276(bundle,UnoHelper.GetUnoObjectRef(bundle));
        				bundles.clear();
        			}
    }
    ...
    public static void NotificationFromJson281(final Object listener,final String _jsonStr,final Object _bundle)
    {
        JSONObject json = null;
        			...
        			if (alertObj == null) {
        				com.foreign.Fuse.PushNotifications.AndroidImpl.cacheBundle271(bundle);
        				return;
        			}
        			...
        			if (cls == String.class) {
        				...
        				com.foreign.Fuse.PushNotifications.AndroidImpl.SpitOutNotification282(listener, s, "", json.optString("sound"), bundle);
        			} else {
        				JSONObject alert = (JSONObject)alertObj;
        				if (alertObj!=null) {
        					com.foreign.Fuse.PushNotifications.AndroidImpl.SpitOutNotification282(listener, alert.optString("title"), alert.optString("body"), alert.optString("sound"), bundle);
        				}
        			}
    }
        ...
        final Bundle bundle = (Bundle)_bundle;
        			...
        			if (!PushNotificationReceiver.InForeground) {
        				...
        				if (notification != null) {
        					...
        					com.foreign.Fuse.PushNotifications.AndroidImpl.NotificationFromJson281(listener, notification, bundle);
        				} else if (aps != null) {
        					// using the apple style 'aps' subtree
        					com.foreign.Fuse.PushNotifications.AndroidImpl.NotificationFromJson281(listener, aps, bundle);
        				} else {
        					com.foreign.Fuse.PushNotifications.AndroidImpl.cacheBundle271(bundle);
        				}
        			} else {
    ...
    public static void SpitOutNotification282(final Object _listener,final String title,final String body,final String sound,final Object _payload)
    {
        Context context = (Context)_listener;
        			...
        			Intent intent = new Intent(context, com.maxted.fusetest.commaxtedfusetest.class);
        			...
        			NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
        				.setSmallIcon(com.maxted.fusetest.R.mipmap.icon)
