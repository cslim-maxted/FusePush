...
public class MediaPlayer
{
    ...
    {
        android.view.Window window = com.maxted.fusetest.commaxtedfusetest.GetRootActivity().getWindow();
        			...
        			try
        			{
        				android.content.pm.ActivityInfo info = com.maxted.fusetest.commaxtedfusetest.GetRootActivity().getPackageManager().getActivityInfo(com.maxted.fusetest.commaxtedfusetest.GetRootActivity().getComponentName(), 0);
    ...
    public static void LoadAsyncAsset209(final Object _this, final Object handle,final String assetName)
    {
        android.media.MediaPlayer player = (android.media.MediaPlayer)handle;
        			...
        			try
        			{
        				afd = com.maxted.fusetest.commaxtedfusetest
        					.GetRootActivity()
        					.getAssets()
        					.openFd(assetName);
        			}
    ...
    public static void Pause1212(final Object handle)
    {
        android.media.MediaPlayer player = (android.media.MediaPlayer)handle;
        			if (player.isPlaying())
        			{
        				android.media.AudioManager am = (android.media.AudioManager)com.maxted.fusetest.commaxtedfusetest.GetRootActivity().getSystemService(android.content.Context.AUDIO_SERVICE);
