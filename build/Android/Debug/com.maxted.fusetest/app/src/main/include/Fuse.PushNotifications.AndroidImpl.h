// This file was generated based on /usr/local/share/uno/Packages/Fuse.PushNotifications/0.38.6/android/$.uno.
...
struct AndroidImpl : uObject
{
    ...
    static void cacheBundle(uObject* _bundle);
    ...
    static void NotificationFromJson(uObject* listener, uString* _jsonStr, uObject* _bundle);
    ...
    static void SpitOutNotification(uObject* _listener, uString* title, uString* body, uString* sound, uObject* _payload);
