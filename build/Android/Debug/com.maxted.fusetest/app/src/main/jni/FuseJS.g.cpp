...
// /usr/local/share/uno/Packages/FuseJS/0.38.6/$.uno
// -------------------------------------------------
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) :412
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) :454
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) :391
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) :433
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :412
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :454
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :391
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :433
...
// public sealed class Bundle :489
// {
...
// private static object Read(Fuse.Scripting.Context c, object[] args) [static] :559
...
// private static string Read(string filename) [static] :569
...
// private static Uno.Threading.Future<string> ReadAsync(object[] args) [static] :533
...
// private static Uno.Threading.Future<string> ReadAsync(string filename) [static] :586
...
// private static bool TryGetBundleFile(string sourcePath, Uno.IO.BundleFile& bundleFile) [static] :501
...
// public sealed class Environment :316
// {
...
// public Environment() [instance] :320
void Environment::ctor_2()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[10/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[10/*"android"*/], uCRef(true), &ret2), ret2));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[10/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[11/*"ios"*/], uCRef(false), &ret3), ret3));
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[10/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[14/*"preview"*/], uCRef(false), &ret6), ret6));
...
// private static string GetMobileOSVersion() [static] :332
...
// public Environment New() [static] :320
...
// private sealed class FileReaderImpl.FileReadCommand :624
// {
...
// public string ReadAsDataURL() :635
...
// public FileReadCommand(string path) [instance] :627
void FileReaderImpl__FileReadCommand::ctor_(uString* path)
{
    _path = path;
}

// public string ReadAsDataURL() [instance] :635
...
// public sealed class FileReaderImpl :622
// {
...
// private static Uno.Threading.Future<string> readAsText(object[] args) :659
...
// public FileReaderImpl() [instance] :645
...
// public FileReaderImpl New() [static] :645
...
// private static Uno.Threading.Future<string> readAsDataURL(object[] args) [static] :653
...
// private static Uno.Threading.Future<string> readAsText(object[] args) [static] :659
...
void Lifecycle::ctor_2()
{
    ...
    Lifecycle::_background_ = (::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[15/*Fuse.Scripting.NativeProperty<int, int>*/], ::STRINGS[35/*"BACKGROUND"*/], uCRef<int>(1), &ret2), ret2);
    Lifecycle::_foreground_ = (::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[15/*Fuse.Scripting.NativeProperty<int, int>*/], ::STRINGS[36/*"FOREGROUND"*/], uCRef<int>(2), &ret3), ret3);
    Lifecycle::_interactive_ = (::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[15/*Fuse.Scripting.NativeProperty<int, int>*/], ::STRINGS[37/*"INTERACTIVE"*/], uCRef<int>(3), &ret4), ret4);
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("/usr/local/share/uno/Packages/FuseJS/0.38.6/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[38/*"Cannot find...*/], Name), this, ::STRINGS[39/*"/usr/local/...*/], 688, ::STRINGS[40/*"Raise"*/]);
        return;
    }
...
// public generated RaiseEvent New() [static] :676
...
// public ReadClosure(string filename) [instance] :595
void Bundle__ReadClosure::ctor_(uString* filename)
{
    _filename = filename;
}

// public string Invoke() [instance] :600
uString* Bundle__ReadClosure::Invoke()
{
    return ::g::FuseJS::Bundle::Read1(_filename);
}

// public ReadClosure New(string filename) [static] :595
...
// public sealed class UserEvents :698
// {
...
// public UserEvents() :701
void UserEvents__ctor_2_fn(UserEvents* __this)
{
    __this->ctor_2();
}

// public UserEvents New() :701
void UserEvents__New2_fn(UserEvents** __retval)
{
    *__retval = UserEvents::New2();
}

// public static object Raise(Fuse.Scripting.Context context, object[] args) :714
...
// public UserEvents() [instance] :701
...
// public UserEvents New() [static] :701
...
// public static object Raise(Fuse.Scripting.Context context, object[] args) [static] :714
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    if (!UserEvents::_warn_)
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[43/*"The FuseJS/...*/], context, ::STRINGS[39/*"/usr/local/...*/], 719, ::STRINGS[40/*"Raise"*/]);
