...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/maxted/fusetest/commaxtedfusetest");
    jclass entryPointsClass = env->FindClass("com/maxted/fusetest/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/maxted/fusetest/Display");
