// This file was generated based on /usr/local/share/uno/Packages/UnoCore/0.38.2/backends/cplusplus/Uno/ObjectModel.cpp.
...
uType* uGetParameterized(uType* type, uType* root)
{
    ...
    case uTypeTypeGeneric:
    {
        ...
        if (generic->GenericCount ||
            generic->GenericIndex >= root->GenericCount)
            break;
