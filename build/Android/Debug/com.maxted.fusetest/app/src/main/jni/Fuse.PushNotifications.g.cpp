...
// /usr/local/share/uno/Packages/Fuse.PushNotifications/0.38.6/android/$.uno
// -------------------------------------------------------------------------
...
static void AndroidImpl__cctor__fn(uType* __type)
{
    ...
    AndroidImpl::_senderID_ = uString::Ansi("222819165455");
...
static void AndroidImpl_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.PushNotifications/0.38.6/android/$.uno");
...
// private static void cacheBundle(object _bundle) :151
void AndroidImpl__cacheBundle_fn(uObject* _bundle)
{
...
// private static void NotificationFromJson(object listener, string _jsonStr, object _bundle) :252
void AndroidImpl__NotificationFromJson_fn(uObject* listener, uString* _jsonStr, uObject* _bundle)
{
    AndroidImpl::NotificationFromJson(listener, _jsonStr, _bundle);
}

// private static void OnEnteringInteractive(Uno.Platform2.ApplicationState newState) :157
void AndroidImpl__OnEnteringInteractive_fn(int* newState)
{
    AndroidImpl::OnEnteringInteractive(*newState);
}

// private static void OnExitedInteractive(Uno.Platform2.ApplicationState newState) :169
...
// private static void SpitOutNotification(object _listener, string title, string body, string sound, object _payload) :285
void AndroidImpl__SpitOutNotification_fn(uObject* _listener, uString* title, uString* body, uString* sound, uObject* _payload)
{
...
// private static void cacheBundle(object _bundle) [static] :151
void AndroidImpl::cacheBundle(uObject* _bundle)
{
    AndroidImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "cacheBundle271", "(Ljava/lang/Object;)V");
        uObject* __u_bundle=_bundle;
        jobject ___bundle = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(__u_bundle);
...
bool AndroidImpl::CheckPlayServices()
{
    AndroidImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CheckPlayServices272", "()Z");
...
uString* AndroidImpl::GetPayloadFromBundle(::g::Java::Object* _bundle)
{
    AndroidImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetPayloadFromBundle274", "(Ljava/lang/Object;)Ljava/lang/String;");
...
void AndroidImpl::Init()
{
    ...
    if (!AndroidImpl::_init())
    {
        if (::g::Uno::String::op_Inequality(AndroidImpl::_senderID(), ::STRINGS[0/*""*/]))
        {
            ...
            ::g::Uno::Platform2::Application::add_EnteringInteractive(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)AndroidImpl__OnEnteringInteractive_fn));
            ::g::Uno::Platform2::Application::add_ExitedInteractive(uDelegate::New(::TYPES[1/*Uno.Platform2.ApplicationStateTransitionHandler*/], (void*)AndroidImpl__OnExitedInteractive_fn));
        }
        else
...
void AndroidImpl::JInit()
{
    AndroidImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "JInit275", "()V");
...
void AndroidImpl::NoteInteractivity(bool isItInteractive)
{
    AndroidImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "NoteInteractivity280", "(Z)V");
...
// private static void NotificationFromJson(object listener, string _jsonStr, object _bundle) [static] :252
void AndroidImpl::NotificationFromJson(uObject* listener, uString* _jsonStr, uObject* _bundle)
{
    AndroidImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "NotificationFromJson281", "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)V");
        uObject* __ulistener=listener;
        jobject __listener = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(__ulistener);
...
// private static void OnEnteringInteractive(Uno.Platform2.ApplicationState newState) [static] :157
...
// private static void OnExitedInteractive(Uno.Platform2.ApplicationState newState) [static] :169
...
void AndroidImpl::OnRecieve(::g::Java::Object* bundle)
{
    ...
    if (::g::Uno::Platform2::Application::State() == 3)
    {
        uDelegate* x = AndroidImpl::ReceivedNotification1();
...
// private static void SpitOutNotification(object _listener, string title, string body, string sound, object _payload) [static] :285
void AndroidImpl::SpitOutNotification(uObject* _listener, uString* title, uString* body, uString* sound, uObject* _payload)
{
    AndroidImpl_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SpitOutNotification282", "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V");
        uObject* __u_listener=_listener;
        jobject ___listener = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(__u_listener);
        ...
        uObject* __u_payload=_payload;
        jobject ___payload = ::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::Box6(__u_payload);
...
// /usr/local/share/uno/Packages/Fuse.PushNotifications/0.38.6/$.uno
// -----------------------------------------------------------------
...
void PushNotify::ClearAllNotifications()
{
    PushNotify_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ClearAllNotifications283", "()V");
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd);
