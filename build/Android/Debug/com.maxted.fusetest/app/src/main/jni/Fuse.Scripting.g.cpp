...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[13/*"(function(o...*/], ::g::Uno::Delegate::op_Inequality(setProperty, NULL) ? ::STRINGS[14/*" set: setCa...*/] : ::STRINGS[15/*""*/]), ::STRINGS[16/*" enumerable...*/])), ::TYPES[17/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 6, obj, name, getProperty, setProperty, uBox(::TYPES[53/*bool*/], enumerable), uBox(::TYPES[53/*bool*/], configurable)));
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::STRINGS[17/*"(function(o...*/]), ::TYPES[17/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 5, obj, name, value, uBox(::TYPES[53/*bool*/], enumerable), uBox(::TYPES[53/*bool*/], configurable)));
}
...
{
    if (_parseJson == NULL)
        _parseJson = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[4/*"(Context)"*/], ::STRINGS[18/*"JSON.parse"*/]), ::TYPES[17/*Fuse.Scripting.Function*/]);
...
uObject* Context::Reflect(uObject* obj)
{
    ...
    if (sobj != NULL)
    {
        ...
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[19/*"external_ob...*/]), ::TYPES[24/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[20/*" (ScriptCla...*/]), ::STRINGS[21/*"(function(e...*/]), ::TYPES[17/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[22/*"(set-superc...*/], ::STRINGS[23/*"(function(c...*/]), ::TYPES[17/*Fuse.Scripting.Function*/]);
...
{
    return NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, uBox(::TYPES[52/*double*/], (double)v.X), uBox(::TYPES[52/*double*/], (double)v.Y)));
}

// private Fuse.Scripting.Array ToArray(float3 v) [instance] :680
::g::Fuse::Scripting::Array* Context::ToArray1(::g::Uno::Float3 v)
{
    return NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 3, uBox(::TYPES[52/*double*/], (double)v.X), uBox(::TYPES[52/*double*/], (double)v.Y), uBox(::TYPES[52/*double*/], (double)v.Z)));
}

// private Fuse.Scripting.Array ToArray(float4 v) [instance] :685
::g::Fuse::Scripting::Array* Context::ToArray2(::g::Uno::Float4 v)
{
    return NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 4, uBox(::TYPES[52/*double*/], (double)v.X), uBox(::TYPES[52/*double*/], (double)v.Y), uBox(::TYPES[52/*double*/], (double)v.Z), uBox(::TYPES[52/*double*/], (double)v.W)));
}
...
uObject* Context::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[35/*float*/]))
        return uBox(::TYPES[52/*double*/], (double)uUnbox<float>(::TYPES[35/*float*/], obj));

    if (uIs(obj, ::TYPES[36/*int*/]))
        return uBox(::TYPES[52/*double*/], (double)uUnbox<int>(::TYPES[36/*int*/], obj));

    if (uIs(obj, ::TYPES[37/*uint*/]))
        return uBox(::TYPES[52/*double*/], (double)uUnbox<uint32_t>(::TYPES[37/*uint*/], obj));
...
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[29/*"Promise"*/]), ::TYPES[17/*Fuse.Scripting.Function*/]);
...
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[28/*string*/]))
    {
        ...
        return ::g::Fuse::Scripting::JSFileSource::New1(uAs<uString*>(::g::Fuse::Scripting::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[45/*Fuse.Scripting.IObject*/]), ::STRINGS[30/*"path"*/]), ::TYPES[28/*string*/]));
...
static void JSCallback_build(uType* type)
{
    ...
    ::TYPES[50] = JSCallback__NumberConverter_typeof();
    type->SetPrecalc(
...
static void Json_build(uType* type)
{
    ...
    ::STRINGS[34] = uString::Const("Json.Stringify(): object can not contain cycles");
    ...
    ::STRINGS[41] = uString::Const("null");
    ::STRINGS[42] = uString::Const("true");
    ::STRINGS[43] = uString::Const("false");
    ::STRINGS[44] = uString::Const("\"");
    ::TYPES[51] = ::g::Uno::Collections::HashSet_typeof()->MakeType(uObject_typeof());
    ::TYPES[28] = ::g::Uno::String_typeof();
    ...
    ::TYPES[9] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[54] = ::g::Uno::String_typeof()->Array();
    ::TYPES[55] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[56] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[57] = ::g::Uno::Comparison_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[18] = ::g::Fuse::Scripting::Array_typeof();
}
...
uString* Json::Stringify(uObject* value, bool normalized)
{
    ...
    Json::Stringify1(value, normalized, sb, (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[51/*Uno.Collections.HashSet<object>*/]));
    return sb->ToString();
}
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    else if (uIs(value, ::TYPES[52/*double*/]))
        uPtr(sb)->Append2(Json::ToLiteral1(uUnbox<double>(::TYPES[52/*double*/], value)));
    ...
    else if (uIs(value, ::TYPES[53/*bool*/]))
        uPtr(sb)->Append2(Json::ToLiteral(uUnbox<bool>(::TYPES[53/*bool*/], value)));
    else if (uIs(value, ::TYPES[9/*Fuse.Scripting.Object*/]))
    {
        if ((::g::Uno::Collections::HashSet__Contains_fn(uPtr(visitedSet), value, &ret1), ret1))
            U_THROW(::g::Uno::Exception::New2(::STRINGS[34/*"Json.String...*/]));
        ...
        uArray* keys = uArray::New(::TYPES[54/*string[]*/], uPtr(uPtr(obj)->Keys())->Length());
        ::g::Uno::Array::Copy1(::TYPES[55/*Uno.Array.Copy<string>*/], obj->Keys(), keys, uPtr(obj->Keys())->Length());

        if (normalized)
            ::g::Uno::Array::Sort1(::TYPES[56/*Uno.Array.Sort<string>*/], keys, uDelegate::New(::TYPES[57/*Uno.Comparison<string>*/], (void*)::g::Uno::String__Compare_fn));
    ...
    else if (uIs(value, ::TYPES[18/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(sb)->Append2(::STRINGS[41/*"null"*/]);
}
...
{
    if (b)
        return ::STRINGS[42/*"true"*/];
    else
        return ::STRINGS[43/*"false"*/];
}
...
uString* Json::ToLiteral1(double s)
{
    ...
    return ::g::Uno::Double::ToString(s, ::TYPES[52/*double*/]);
}
...
{
    ctor_(c, obj, p);
    uPtr(c)->ObjectDefineProperty(obj, uPtr(p)->Name().ToString(::TYPES[58/*Uno.UX.Selector*/]), uDelegate::New(::TYPES[39/*Fuse.Scripting.Callback*/], (void*)LazyObservableProperty__Get_fn, this), NULL, false, false);
}
...
{
    Marshal::_converters_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[59/*Uno.Collections.List<Fuse.Scripting.Marshal.IConverter>*/]));
    Marshal::AddConverter((uObject*)::g::Fuse::Scripting::FileSourceConverter::New1());
}

static void Marshal_build(uType* type)
{
    ::STRINGS[45] = uString::Const("Unable to convert ");
    ::STRINGS[46] = uString::Const(" to bool");
    ::STRINGS[47] = uString::Const("Expected number was ");
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/scripting/$.uno");
    ::STRINGS[48] = uString::Const("#");
    ::STRINGS[49] = uString::Const(" to float4");
    ::STRINGS[50] = uString::Const("Unable to parse selector value: ");
    ::STRINGS[51] = uString::Const("%");
    ::STRINGS[52] = uString::Const("px");
    ::STRINGS[53] = uString::Const("pt");
    ::STRINGS[54] = uString::Const("Unable to parse size value: ");
    ::STRINGS[55] = uString::Const("Unable to parse size vector: ");
    ::STRINGS[56] = uString::Const("Unable to convert '");
    ::STRINGS[57] = uString::Const("' to type ");
    ::TYPES[59] = ::g::Uno::Collections::List_typeof()->MakeType(Marshal__IConverter_typeof());
    ::TYPES[60] = Marshal__IConverter_typeof();
    ::TYPES[53] = ::g::Uno::Bool_typeof();
    ::TYPES[28] = ::g::Uno::String_typeof();
    ::TYPES[52] = ::g::Uno::Double_typeof();
    ::TYPES[35] = ::g::Uno::Float_typeof();
    ::TYPES[36] = ::g::Uno::Int_typeof();
    ::TYPES[61] = ::g::Fuse::Scripting::IArray_typeof();
    ::TYPES[58] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[62] = ::g::Uno::UX::Size_typeof();
    ::TYPES[63] = ::g::Uno::UX::Size2_typeof();
    ::TYPES[64] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[1] = ::g::Uno::Type_typeof();
    type->SetPrecalc(
...
void Marshal__ToType_fn(uType* __type, uObject* o, uTRef __retval)
{
    ...
    if ((Marshal__TryConvertTo1_fn(__types[1], o, &value, &ret4), ret4))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[56/*"Unable to c...*/], o), ::STRINGS[57/*"' to type "*/]), __types[0])));
}
...
bool Marshal::CanConvertClass(uType* t)
{
    ...
    for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        if (Marshal__IConverter::CanConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret3), ret3)), ::TYPES[60/*Fuse.Scripting.Marshal.IConverter*/]), t))
            return true;
...
bool Marshal::ToBool(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[53/*bool*/]))
        return uUnbox<bool>(::TYPES[53/*bool*/], obj);
    else if (uIs(obj, ::TYPES[28/*string*/]))
        return ::g::Uno::Bool::Parse(uCast<uString*>(obj, ::TYPES[28/*string*/]));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[45/*"Unable to c...*/], obj), ::STRINGS[46/*" to bool"*/])));
}
...
double Marshal::ToDouble(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[52/*double*/]))
        return uUnbox<double>(::TYPES[52/*double*/], o);
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[47/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[7/*"/usr/local/...*/], 1016);
        return 0.0;
    }
}
...
{
    Marshal_typeof()->Init();
    float r = (::g::Fuse::Scripting::IArray::Length(uInterface(uPtr(values), ::TYPES[61/*Fuse.Scripting.IArray*/])) > 0) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(values), ::TYPES[61/*Fuse.Scripting.IArray*/]), 0)) : 0.0f;
    float g = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[61/*Fuse.Scripting.IArray*/])) > 1) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[61/*Fuse.Scripting.IArray*/]), 1)) : r;
    float b = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[61/*Fuse.Scripting.IArray*/])) > 2) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[61/*Fuse.Scripting.IArray*/]), 2)) : r;
    float a = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[61/*Fuse.Scripting.IArray*/])) > 3) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[61/*Fuse.Scripting.IArray*/]), 3)) : 1.0f;
...
{
    Marshal_typeof()->Init();
    uObject* aa = uAs<uObject*>(o, ::TYPES[61/*Fuse.Scripting.IArray*/]);
    ...
    if (uIs(o, ::TYPES[28/*string*/]))
    {
        ...
        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[48/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[45/*"Unable to c...*/], o), ::STRINGS[49/*" to float4"*/])));
}
...
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[58/*Uno.UX.Selector*/]))
        return uUnbox< ::g::Uno::UX::Selector>(::TYPES[58/*Uno.UX.Selector*/], o);
    else if (uIs(o, ::TYPES[28/*string*/]))
        return ::g::Uno::UX::Selector__op_Implicit(uCast<uString*>(o, ::TYPES[28/*string*/]));

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[50/*"Unable to p...*/], o)));
}
...
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[62/*Uno.UX.Size*/]))
        return uUnbox< ::g::Uno::UX::Size>(::TYPES[62/*Uno.UX.Size*/], o);
    ...
    if (uIs(o, ::TYPES[28/*string*/]))
    {
        ...
        else if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[51/*"%"*/]))
        ...
        else if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[53/*"pt"*/]))
...
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[63/*Uno.UX.Size2*/]))
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[63/*Uno.UX.Size2*/], o);
    ...
    if (uIs(o, ::TYPES[28/*string*/]))
    {
        ...
        uArray* parts = ::g::Uno::String::Split(uPtr(s), uArray::Init<int>(::TYPES[64/*char[]*/], 1, ','));
    ...
    if (uIs(o, ::TYPES[61/*Fuse.Scripting.IArray*/]))
    {
        uObject* a = (uObject*)o;
        return ::g::Uno::UX::Size2__New1(Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[61/*Fuse.Scripting.IArray*/]), 0)), Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[61/*Fuse.Scripting.IArray*/]), 1)));
    }
...
uObject* Marshal::TryConvertTo(uType* t, uObject* o)
{
    ...
    if (o == NULL)
        return NULL;
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[53/*bool*/]))
        return uBox(::TYPES[53/*bool*/], Marshal::ToBool(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[35/*float*/]))
        return uBox(::TYPES[35/*float*/], Marshal::ToFloat(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[52/*double*/]))
        return uBox(::TYPES[52/*double*/], Marshal::ToDouble(o));
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[58/*Uno.UX.Selector*/]))
        return uBox(::TYPES[58/*Uno.UX.Selector*/], Marshal::ToSelector(o));
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[62/*Uno.UX.Size*/]))
        return uBox(::TYPES[62/*Uno.UX.Size*/], Marshal::ToSize(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[63/*Uno.UX.Size2*/]))
        return uBox(::TYPES[63/*Uno.UX.Size2*/], Marshal::ToSize2(o));
        ...
        for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        {
            uObject* res = Marshal__IConverter::TryConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret5), ret5)), ::TYPES[60/*Fuse.Scripting.Marshal.IConverter*/]), t, o);
...
{
    ::STRINGS[25] = uString::Const(" (ScriptMethod)");
    ::STRINGS[58] = uString::Const("(function (cl, callback) { cl.prototype.");
    ::STRINGS[59] = uString::Const(" = function() { callback(this.external_object, Array.prototype.slice.call(arguments)); }})");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[17] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[39] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[24] = ::g::Fuse::Scripting::External_typeof();
...
void Context__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Scripting::Context* context)
{
    _m = m;
    _context = context;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(_context)->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[25/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[58/*"(function (...*/], uPtr(m)->Name), ::STRINGS[59/*" = function...*/])), ::TYPES[17/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[60] = uString::Const("exports");
    ::STRINGS[61] = uString::Const("disposed");
    ::STRINGS[62] = uString::Const("id");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[65] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetInterfaces(
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[60/*"exports"*/], c->NewObject());
    module->Item(::STRINGS[61/*"disposed"*/], c->NewArray(uArray::New(::TYPES[3/*object[]*/], 0)));
    ...
    {
        if (uIs(__t.Exception, ::TYPES[65/*Fuse.Scripting.ScriptException*/]))
        {
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[62/*"id"*/], id);
...
{
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[60/*"exports"*/]);
    return r;
}
// }
...
{
    ::STRINGS[61] = uString::Const("disposed");
    ::STRINGS[63] = uString::Const("(unknown module)");
    ::TYPES[66] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[67] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[68] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::EventArgs_typeof());
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[18] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[17] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[63/*"(unknown mo...*/], void();
}
...
{
    _invalidateCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[66/*Uno.Collections.List<Uno.Action>*/]));
    Context = context;
    Module = mod;
    Object = obj;
    Id = id;
    ...
    if (::g::Uno::String::op_Inequality(Id, NULL))
    {
        ...
        ::g::Uno::UX::Resource::AddGlobalKeyListener(uDelegate::New(::TYPES[67/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
    }

    if (uPtr(Module)->GetFile() != NULL)
    {
        uPtr(uPtr(Module)->GetFile())->add_DataChanged(uDelegate::New(::TYPES[68/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = true;
    }
}
...
void ModuleResult::Dispose()
{
    if (_fileListening)
    {
        uPtr(uPtr(Module)->GetFile())->remove_DataChanged(uDelegate::New(::TYPES[68/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = false;
    }

    if (_globalKeyListening)
    {
        ::g::Uno::UX::Resource::RemoveGlobalKeyListener(uDelegate::New(::TYPES[67/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
...
{
    if (uPtr(Object)->ContainsKey(::STRINGS[61/*"disposed"*/]))
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[61/*"disposed"*/]), ::TYPES[18/*Fuse.Scripting.Array*/]);
...
{
    ::TYPES[69] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array());
    ::TYPES[70] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2, uObject_typeof()->Array(), uObject_typeof());
    ::TYPES[71] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof());
...
{
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[69/*Uno.Collections.Queue<object[]>*/]));
...
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[70/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[71/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}
...
{
    ::STRINGS[64] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[60] = uString::Const("exports");
    ::TYPES[72] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
    ::TYPES[9] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[73] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof());
    ::TYPES[74] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[60/*"exports"*/]), ::TYPES[9/*Fuse.Scripting.Object*/]);

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[73/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
    {
        ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[73/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
        uPtr(m)->Create(obj, c);
    }

    if (__this->_func != NULL)
        uPtr(module)->Item(::STRINGS[60/*"exports"*/], uPtr(__this->_func)->CreateCallback());
...
{
    _members = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[72/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/]));
    ctor_();
}
...
{
    if (_isEvaluated)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[64/*"NativeModul...*/]));
...
void NativeModule::add_Evaluated(uDelegate* value)
{
    if (_isEvaluated)
        ...
        _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_evaluated, value), ::TYPES[74/*Uno.EventHandler*/]);
}

// public void remove_Evaluated(Uno.EventHandler value) [instance] :384
void NativeModule::remove_Evaluated(uDelegate* value)
{
    _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_evaluated, value), ::TYPES[74/*Uno.EventHandler*/]);
}
...
{
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_reset, value), ::TYPES[74/*Uno.EventHandler*/]);
}

// public void remove_Reset(Uno.EventHandler value) [instance] :393
void NativeModule::remove_Reset(uDelegate* value)
{
    _reset = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_reset, value), ::TYPES[74/*Uno.EventHandler*/]);
}
...
{
    ::TYPES[75] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[39] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[76] = NativePromise__ContextClosure_typeof();
    ::TYPES[77] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[78] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[39] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[79] = ::g::Uno::Func_typeof();
    ::TYPES[80] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[81] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof());
    ::TYPES[2] = ::g::Fuse::Scripting::IObserver_typeof();
    type->SetFields(2,
...
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this)
{
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[81/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
}
...
{
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[82] = ::g::Uno::Short_typeof();
    ::TYPES[36] = ::g::Uno::Int_typeof();
    ::TYPES[83] = ::g::Uno::Long_typeof();
    ::TYPES[35] = ::g::Uno::Float_typeof();
    ::TYPES[52] = ::g::Uno::Double_typeof();
    ::TYPES[41] = ::g::Uno::Exception_typeof();
    type->SetPrecalc(
...
{
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[82/*short*/]))
        return uBox<int16_t>(::TYPES[82/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[36/*int*/]))
        return uBox<int>(::TYPES[36/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[83/*long*/]))
        return uBox<int64_t>(::TYPES[83/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[35/*float*/]))
        return uBox(::TYPES[35/*float*/], (float)value);

    return uBox(::TYPES[52/*double*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[52/*double*/]))
        return uBox(::TYPES[52/*double*/], (double)value);
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[83/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[82/*short*/], value);
}
...
{
    if (uIs(value, ::TYPES[82/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[82/*short*/], value), targetType);

    if (uIs(value, ::TYPES[36/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[36/*int*/], value), targetType);

    if (uIs(value, ::TYPES[83/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[83/*long*/], value), targetType);

    if (uIs(value, ::TYPES[35/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[35/*float*/], value), targetType);

    if (uIs(value, ::TYPES[52/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[52/*double*/], value), targetType);
...
{
    ::TYPES[84] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[85] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[4] = ::g::Fuse::Scripting::ValueMirror_typeof();
    ::TYPES[86] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    type->SetInterfaces(
...
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_props), &ret4), ret4); enum1.MoveNext(::TYPES[85/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[85/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
        ::g::Fuse::Scripting::ValueMirror* d = uAs< ::g::Fuse::Scripting::ValueMirror*>(p.Value(::TYPES[86/*Uno.Collections.KeyValuePair<string, object>*/]), ::TYPES[4/*Fuse.Scripting.ValueMirror*/]);
...
{
    _props = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[84/*Uno.Collections.Dictionary<string, object>*/]));
    ctor_(obj);
...
{
    ::STRINGS[65] = uString::Const("addSubscriber");
    ::STRINGS[66] = uString::Const("set");
    ::STRINGS[67] = uString::Const("clear");
    ::STRINGS[68] = uString::Const("newAt");
    ::STRINGS[69] = uString::Const("newAll");
    ::STRINGS[70] = uString::Const("add");
    ::STRINGS[71] = uString::Const("removeAt");
    ::STRINGS[72] = uString::Const("insertAt");
    ::STRINGS[73] = uString::Const("removeRange");
    ::STRINGS[74] = uString::Const("insertAll");
    ::STRINGS[75] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[76] = uString::Const("removeSubscriber");
    ::TYPES[87] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[88] = ::g::Uno::Collections::List_typeof()->MakeType(Observable__Subscription_typeof());
    ::TYPES[39] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[9] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[28] = ::g::Uno::String_typeof();
    ::TYPES[89] = ::g::Fuse::Scripting::ArrayMirror_typeof();
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[4] = ::g::Fuse::Scripting::ValueMirror_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::IArray_typeof(), offsetof(::g::Fuse::Scripting::ListMirror_type, interface0));
...
{
    _values = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[87/*Uno.Collections.List<object>*/]));
    _observers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[88/*Uno.Collections.List<Fuse.Scripting.Observable.Subscription>*/]));
    ctor_1(obj);
    _context = context;
    _observable = obj;
    ...
    uPtr(obj)->CallMethod(::STRINGS[65/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[53/*bool*/], supressCallback)));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    if (::g::Uno::String::op_Equality(op, ::STRINGS[66/*"set"*/]))
    {
        int origin = -1;
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[67/*"clear"*/]))
    {
        int origin1 = -1;
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[68/*"newAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[69/*"newAll"*/]))
    {
        int origin2 = -1;
        ...
        uPtr(_context)->Enqueue(Observable__NewAll::New1(this, uCast< ::g::Fuse::Scripting::ArrayMirror*>(uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(2)), ::TYPES[89/*Fuse.Scripting.ArrayMirror*/]), origin2));
    }
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[70/*"add"*/]))
        uPtr(_context)->Enqueue(Observable__Add::New1(this, uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(2))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[71/*"removeAt"*/]))
        uPtr(_context)->Enqueue(Observable__RemoveAt::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(2))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[72/*"insertAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[73/*"removeRange"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[74/*"insertAll"*/]))
        uPtr(_context)->Enqueue(Observable__InsertAll::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(2)), uCast< ::g::Fuse::Scripting::ArrayMirror*>(uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(3)), ::TYPES[89/*Fuse.Scripting.ArrayMirror*/])));
    else
...
{
    uPtr(_observable)->CallMethod(::STRINGS[76/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
{
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[90] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof());
    type->SetInterfaces(
...
void ObservableProperty__UnoUXIPropertyListenerOnPropertyChanged_fn(ObservableProperty* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    uPtr(__this->_context)->Invoke(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)ObservableProperty__PushCapture__Run_fn, ObservableProperty__PushCapture::New1(uDelegate::New(::TYPES[90/*Uno.Action<object>*/], (void*)ObservableProperty__PushValue_fn, __this), uPtr(__this->_property)->GetAsObject())));
}
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[17] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[80] = ::g::Uno::Action1_typeof();
    ::TYPES[91] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetPrecalc(
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[91/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
static void Context__PropertyClosure_build(uType* type)
{
    ...
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[39] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[92] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetFields(0,
...
void Context__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[79/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[80/*"(function(c...*/], p->Name), ::STRINGS[81/*"', "*/]), ::STRINGS[35/*"{"*/]), ::STRINGS[82/*"get: functi...*/]), ::STRINGS[83/*"var obs = g...*/]), ::STRINGS[84/*"if ("*/]), rawField), ::STRINGS[85/*" != obs) {"*/]), rawField), ::STRINGS[86/*" = obs;"*/]), propField), ::STRINGS[87/*" = obs"*/]), p->Modifier), ::STRINGS[88/*";"*/]), ::STRINGS[38/*"}"*/]), ::STRINGS[89/*"return "*/]), propField), ::STRINGS[38/*"}"*/]), ::STRINGS[90/*"})"*/]), ::STRINGS[90/*"})"*/])), ::TYPES[17/*Fuse.Scripting.Function*/]);
...
{
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(::g::Fuse::Scripting::Context::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[92/*Uno.UX.PropertyObject*/]);
...
{
    ::STRINGS[91] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[92] = uString::Const(" provided");
    ::STRINGS[93] = uString::Const("require(): argument must be a string");
    ::STRINGS[94] = uString::Const("require(): module not found: ");
    ::STRINGS[95] = uString::Const("JavaScript error in ");
    ::STRINGS[96] = uString::Const(" was fixed!");
    ::STRINGS[97] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting/0.38.6/$.uno");
    ::STRINGS[98] = uString::Const("Require");
    ::STRINGS[99] = uString::Const(" line ");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[91/*"require(): ...*/], uBox<int>(::TYPES[36/*int*/], uPtr(args)->Length())), ::STRINGS[92/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[28/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[93/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[94/*"require(): ...*/], id)));
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[95/*"JavaScript ...*/], path), ::STRINGS[96/*" was fixed!"*/]), this, ::STRINGS[97/*"/usr/local/...*/], 204, ::STRINGS[98/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[95/*"JavaScript ...*/], path), ::STRINGS[99/*" line "*/]), uBox<int>(::TYPES[36/*int*/], uPtr(e)->LineNumber())), ::STRINGS[100/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[97/*"/usr/local/...*/], 214, ::STRINGS[98/*"Require"*/]);
    ...
    return uPtr(uPtr(module)->Object)->Item(::STRINGS[60/*"exports"*/]);
}
...
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[93/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[93] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ScriptClass_typeof());
    type->SetFields(0,
...
{
    ::STRINGS[101] = uString::Const("Name: ");
    ::STRINGS[102] = uString::Const("Error message: ");
    ::STRINGS[103] = uString::Const("File name: ");
    ::STRINGS[104] = uString::Const("Line number: ");
    ::STRINGS[105] = uString::Const("Source line: ");
    ::STRINGS[106] = uString::Const("JS stack trace: ");
    ::TYPES[36] = ::g::Uno::Int_typeof();
    type->SetFields(3,
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[105/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[106/*"JS stack tr...*/]);
...
{
    ::STRINGS[107] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/scripting/$.uno");
    ::STRINGS[108] = uString::Const("Call");
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[94] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[107/*"Cannot call...*/], __this, ::STRINGS[7/*"/usr/local/...*/], 2167, ::STRINGS[108/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[109/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[109] = uString::Const("require(): module contains an error: ");
    ::STRINGS[110] = uString::Const(".js");
    ::STRINGS[15] = uString::Const("");
    ::STRINGS[24] = uString::Const(".");
    ::STRINGS[111] = uString::Const("/");
    ::STRINGS[112] = uString::Const("..");
    ::STRINGS[113] = uString::Const("(function(");
    ::STRINGS[114] = uString::Const(") { ");
    ::STRINGS[115] = uString::Const("\n"
        " })");
    ::STRINGS[116] = uString::Const("Could not evaluate module '");
    ::STRINGS[117] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[60] = uString::Const("exports");
    ::STRINGS[118] = uString::Const("module, exports, require");
    ::STRINGS[119] = uString::Const("/index.js");
    ::TYPES[95] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[64] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[87] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof());
    ::TYPES[17] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[39] = ::g::Fuse::Scripting::Callback_typeof();
    ...
    ::TYPES[43] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[44] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[96] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof());
    ::TYPES[97] = ::g::Uno::UX::BundleFileSource_typeof();
    type->SetInterfaces(
...
{
    uArray* newlines = uArray::New(::TYPES[64/*char[]*/], __this->LineNumberOffset());

    for (int i = 0; i < __this->LineNumberOffset(); ++i)
        uPtr(newlines)->Item<uChar>(i) = 10;

    ::g::Uno::Collections::List* args = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[87/*Uno.Collections.List<object>*/]);
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[113/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[114/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[115/*"\n })"*/]);
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[116/*"Could not e...*/], __this->FileName()), ::STRINGS[117/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[60/*"exports"*/]));
    ...
    return *__retval = ::STRINGS[118/*"module, exp...*/], void();
}
...
{
    return uIs(obj, ::TYPES[95/*Fuse.Scripting.IModuleProvider*/]);
}

// public Uno.IO.Bundle get_Bundle() [instance] :34
::g::Uno::IO::Bundle* ScriptModule::Bundle()
{
    ::g::Uno::UX::BundleFileSource* bfs = uAs< ::g::Uno::UX::BundleFileSource*>(File(), ::TYPES[97/*Uno.UX.BundleFileSource*/]);
...
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[110/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[110/*".js"*/], ::STRINGS[15/*""*/]);
    ...
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[111/*"/"*/]))
    {
        *isFile = true;
...
uString* ScriptModule::GetSourcePath()
{
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[64/*char[]*/], 1, '/'));
    else
        return ::STRINGS[15/*""*/];
}
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[96/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[95/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[64/*char[]*/], 1, '/'));
    ...
    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[15/*""*/]))
            ...
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[112/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[111/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[110/*".js"*/])))
        return true;

    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[119/*"/index.js"*/])))
        return true;
...
{
    ::STRINGS[120] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[120/*"ScriptPrope...*/]));
...
{
    ::STRINGS[67] = uString::Const("clear");
    ::STRINGS[121] = uString::Const("replaceAllWithOrigin");
    ::STRINGS[122] = uString::Const("Unexpected null object");
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/scripting/$.uno");
    ::STRINGS[123] = uString::Const("SetExclusive");
    ::STRINGS[124] = uString::Const("setValueWithOrigin");
    ::STRINGS[125] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Scripting::IObserver_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[65] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetInterfaces(
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[67/*"clear"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[36/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uType* __type, uArray* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[121/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, sa, uBox<int>(::TYPES[36/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[122/*"Unexpected ...*/], this, ::STRINGS[7/*"/usr/local/...*/], 1490, ::STRINGS[123/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[124/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_context)->Unwrap(newValue), uBox<int>(::TYPES[36/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[65/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[125/*"Failed to s...*/], ex, this, ::STRINGS[7/*"/usr/local/...*/], 1502, ::STRINGS[123/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
{
    if (uIs(obj, ::TYPES[52/*double*/]))
        return uUnbox<double>(::TYPES[52/*double*/], obj);
