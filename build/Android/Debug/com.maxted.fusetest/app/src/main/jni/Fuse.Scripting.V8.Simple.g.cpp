...
{
    ::TYPES[2] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::Value_typeof());
    type->SetInterfaces(
...
uObject* ValueVector::GetEnumerator()
{
    ...
    return uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::V8::Simple::Value_typeof()), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_list), &ret3), ret3));
}
