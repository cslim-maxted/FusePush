...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.38.2/implementation/android/$.uno
// ------------------------------------------------------------------------------
...
{
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Byte_typeof()->Array());
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[2] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Byte_typeof()->Array());
    ::TYPES[3] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::Byte_typeof());
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.38.2/implementation/$.uno
// ----------------------------------------------------------------------
