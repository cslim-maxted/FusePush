...
// /usr/local/share/uno/Packages/FuseCore/0.38.6/input/$.uno
// ---------------------------------------------------------

// internal sealed class Capturer :921
// {
...
// public Capturer(Fuse.Visual n, object identity, Uno.Action lostCallback) :927
...
// public generated Fuse.Visual get_Visual() :923
void Capturer__get_Visual_fn(Capturer* __this, ::g::Fuse::Visual** __retval)
{
    *__retval = __this->Visual();
}

// private generated void set_Visual(Fuse.Visual value) :923
void Capturer__set_Visual_fn(Capturer* __this, ::g::Fuse::Visual* value)
{
    __this->Visual(value);
}

// public Capturer(Fuse.Visual n, object identity, Uno.Action lostCallback) [instance] :927
...
// public generated object get_Identity() [instance] :924
uObject* Capturer::Identity()
{
    return _Identity;
}

// private generated void set_Identity(object value) [instance] :924
void Capturer::Identity(uObject* value)
{
    _Identity = value;
}

// public bool get_IsSuitable() [instance] :939
bool Capturer::IsSuitable()
{
    return uPtr(Visual())->IsContextEnabled() && uPtr(Visual())->IsRootingCompleted();
}

// public generated Uno.Action get_LostCallback() [instance] :925
uDelegate* Capturer::LostCallback()
{
    return _LostCallback;
}

// private generated void set_LostCallback(Uno.Action value) [instance] :925
void Capturer::LostCallback(uDelegate* value)
{
    _LostCallback = value;
}

// public generated Fuse.Visual get_Visual() [instance] :923
::g::Fuse::Visual* Capturer::Visual()
{
    return _Visual;
}

// private generated void set_Visual(Fuse.Visual value) [instance] :923
void Capturer::Visual(::g::Fuse::Visual* value)
{
    _Visual = value;
}

// public Capturer New(Fuse.Visual n, object identity, Uno.Action lostCallback) [static] :927
...
// public abstract class CustomPointerEventArgs :785
// {
...
// protected CustomPointerEventArgs(Fuse.Input.PointerEventArgs args, Fuse.Visual visual) :787
...
// protected CustomPointerEventArgs(Fuse.Input.PointerEventArgs args, Fuse.Visual visual) [instance] :787
...
// private sealed class Pointer.DefaultPointerEventResponder :1412
// {
static void Pointer__DefaultPointerEventResponder_build(uType* type)
{
    ::TYPES[0] = ::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Input::PointerPressedArgs_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof()));
    type->SetInterfaces(
...
// public generated DefaultPointerEventResponder() :1412
void Pointer__DefaultPointerEventResponder__ctor__fn(Pointer__DefaultPointerEventResponder* __this)
{
    __this->ctor_();
}

// public generated DefaultPointerEventResponder New() :1412
...
// public void OnPointerMoved(Fuse.Input.PointerMovedArgs args) :1436
...
// public void OnPointerPressed(Fuse.Input.PointerPressedArgs args) :1414
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) :1453
...
// public generated DefaultPointerEventResponder() [instance] :1412
void Pointer__DefaultPointerEventResponder::ctor_()
{
}

// public void OnPointerMoved(Fuse.Input.PointerMovedArgs args) [instance] :1436
...
// public void OnPointerPressed(Fuse.Input.PointerPressedArgs args) [instance] :1414
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) [instance] :1453
...
// public generated DefaultPointerEventResponder New() [static] :1412
...
static void Focus_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[6] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Node_typeof());
...
static void FocusPrediction_build(uType* type)
{
    ...
    ::TYPES[9] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[10] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[11] = ::g::Uno::Predicate_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[12] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Visual_typeof(), ::g::Fuse::Visual_typeof());
}
...
{
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Platform::Key_typeof());
    type->SetFields(0,
...
// private enum Pointer.PELStatus :1360
...
// public partial static class Pointer :955
// {
// static Pointer() :959
...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/usr/local/share/uno/Packages/FuseCore/0.38.6/input/$.uno");
    ...
    ::TYPES[14] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof());
    ::TYPES[15] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof()));
    ::TYPES[16] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[17] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(Pointer__PELHolder_typeof()));
    ::TYPES[18] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[19] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[20] = ::g::Uno::Collections::List_typeof()->MakeType(Pointer__PELHolder_typeof());
    ::TYPES[21] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[22] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[23] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[24] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof());
    ::TYPES[25] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof());
    ::TYPES[26] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[5] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[27] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[28] = ::g::Fuse::Input::IPointerEventResponder_typeof();
    ::TYPES[29] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof()));
    ::TYPES[30] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof()));
    ::TYPES[31] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[32] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[33] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Input::Capturer_typeof());
    ::TYPES[34] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof());
    ::TYPES[35] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Input::Capturer_typeof());
    type->SetFields(0,
...
// public static void AddHandlers(Fuse.Visual node, [Fuse.Input.PointerPressedHandler pressed], [Fuse.Input.PointerMovedHandler moved], [Fuse.Input.PointerReleasedHandler released], [Fuse.Input.PointerEnteredHandler entered], [Fuse.Input.PointerLeftHandler left], [Fuse.Input.PointerWheelMovedHandler wheelMoved]) :978
...
// private static void CheckFocus(Fuse.Input.PointerPressedArgs args, Uno.Collections.IList<Fuse.Visual> nodes) :1390
void Pointer__CheckFocus_fn(::g::Fuse::Input::PointerPressedArgs* args, uObject* nodes)
{
    Pointer::CheckFocus(args, nodes);
}

// public static generated float2 get_Coord() :1046
void Pointer__get_Coord_fn(::g::Uno::Float2* __retval)
{
    *__retval = Pointer::Coord();
}

// private static generated void set_Coord(float2 value) :1046
void Pointer__set_Coord_fn(::g::Uno::Float2* value)
{
    Pointer::Coord(*value);
}

// public static Fuse.VisualEvent<Fuse.Input.PointerEnteredHandler, Fuse.Input.PointerEnteredArgs> get_Entered() :974
void Pointer__get_Entered_fn(::g::Fuse::VisualEvent** __retval)
{
    *__retval = Pointer::Entered();
}

// public static generated Fuse.Input.IPointerEventResponder get_EventResponder() :957
void Pointer__get_EventResponder_fn(uObject** __retval)
{
    *__retval = Pointer::EventResponder();
}

// public static generated void set_EventResponder(Fuse.Input.IPointerEventResponder value) :957
void Pointer__set_EventResponder_fn(uObject* value)
{
    Pointer::EventResponder(value);
}

// internal static Fuse.Input.Capturer GetHardCapturer(int pointIndex) :1161
...
// private static Uno.Collections.List<Fuse.Input.Pointer.PELHolder> GetLastHitList(int pointIndex) :1375
void Pointer__GetLastHitList_fn(int* pointIndex, ::g::Uno::Collections::List** __retval)
{
    *__retval = Pointer::GetLastHitList(*pointIndex);
}

// internal static Fuse.Input.Capturer GetSoftCapturer(int pointIndex) :1050
...
// internal static bool HardCapture(int pointIndex, Fuse.Visual node, object identity, Uno.Action lostCallback) :1176
...
// public static bool IsHardCaptured(int pointIndex) :1150
void Pointer__IsHardCaptured_fn(int* pointIndex, bool* __retval)
{
    *__retval = Pointer::IsHardCaptured(*pointIndex);
}

// public static bool IsHardCaptured(int pointIndex, object behavior) :1155
...
// public static Fuse.VisualEvent<Fuse.Input.PointerLeftHandler, Fuse.Input.PointerLeftArgs> get_Left() :975
void Pointer__get_Left_fn(::g::Fuse::VisualEvent** __retval)
{
    *__retval = Pointer::Left();
}

// private static void MarkAncestorHits(Fuse.Visual hitObject, Uno.Collections.List<Fuse.Input.Pointer.PELHolder> list) :1330
...
// public static Fuse.VisualEvent<Fuse.Input.PointerMovedHandler, Fuse.Input.PointerMovedArgs> get_Moved() :972
void Pointer__get_Moved_fn(::g::Fuse::VisualEvent** __retval)
{
    *__retval = Pointer::Moved();
}

// public static Fuse.VisualEvent<Fuse.Input.PointerPressedHandler, Fuse.Input.PointerPressedArgs> get_Pressed() :971
void Pointer__get_Pressed_fn(::g::Fuse::VisualEvent** __retval)
{
    *__retval = Pointer::Pressed();
}

// private static void ProcessPointerEnterLeave(Fuse.HitTestResult result, Fuse.Input.PointerEventData args) :1306
...
// internal static bool RaiseMoved(Fuse.Visual root, Fuse.Input.PointerEventData data) :1226
...
// internal static bool RaisePressed(Fuse.Visual root, Fuse.Input.PointerEventData data) :1218
...
// internal static bool RaiseReleased(Fuse.Visual root, Fuse.Input.PointerEventData data) :1234
...
// public static void ReleaseAllCaptures(object identity) :1127
void Pointer__ReleaseAllCaptures_fn(uObject* identity)
{
    Pointer::ReleaseAllCaptures(identity);
}

// public static Fuse.VisualEvent<Fuse.Input.PointerReleasedHandler, Fuse.Input.PointerReleasedArgs> get_Released() :973
void Pointer__get_Released_fn(::g::Fuse::VisualEvent** __retval)
{
    *__retval = Pointer::Released();
}

// public static void ReleaseHardCapture(int pointIndex) :1210
void Pointer__ReleaseHardCapture_fn(int* pointIndex)
{
    Pointer::ReleaseHardCapture(*pointIndex);
}

// public static void ReleaseSoftCapture(int pointIndex, object identity) :1111
void Pointer__ReleaseSoftCapture_fn(int* pointIndex, uObject* identity)
{
    Pointer::ReleaseSoftCapture(*pointIndex, identity);
}

// public static void RemoveHandlers(Fuse.Visual node, [Fuse.Input.PointerPressedHandler pressed], [Fuse.Input.PointerMovedHandler moved], [Fuse.Input.PointerReleasedHandler released], [Fuse.Input.PointerEnteredHandler entered], [Fuse.Input.PointerLeftHandler left], [Fuse.Input.PointerWheelMovedHandler wheelMoved]) :994
...
// private static Fuse.Visual RoutePointerEvent(Fuse.Input.PointerEventData plainEvent, Fuse.Visual root) :1260
...
// private static Fuse.Visual RouteToCapturer(Fuse.Input.PointerEventData args) :1282
...
// private static Fuse.Visual RouteToHit(Fuse.Input.PointerEventData args, Fuse.Visual root) :1290
...
// private static Fuse.Visual RouteToSoftCapturer(Fuse.Input.PointerEventData args) :1274
...
// internal static bool SoftCapture(int pointIndex, Fuse.Visual softCapturer, object identity, Uno.Action lostCallback) :1086
...
// public static Fuse.VisualEvent<Fuse.Input.PointerWheelMovedHandler, Fuse.Input.PointerWheelMovedArgs> get_WheelMoved() :976
...
// private static void CheckFocus(Fuse.Input.PointerPressedArgs args, Uno.Collections.IList<Fuse.Visual> nodes) [static] :1390
...
// internal static Fuse.Input.Capturer GetHardCapturer(int pointIndex) [static] :1161
...
// private static Uno.Collections.List<Fuse.Input.Pointer.PELHolder> GetLastHitList(int pointIndex) [static] :1375
...
// internal static Fuse.Input.Capturer GetSoftCapturer(int pointIndex) [static] :1050
...
// internal static bool HardCapture(int pointIndex, Fuse.Visual node, object identity, Uno.Action lostCallback) [static] :1176
bool Pointer::HardCapture(int pointIndex, ::g::Fuse::Visual* node, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"HardCapture...*/], 1, ::STRINGS[9/*"/usr/local/...*/], 1187);
        return false;
    }
...
// public static bool IsHardCaptured(int pointIndex) [static] :1150
...
// public static bool IsHardCaptured(int pointIndex, object behavior) [static] :1155
...
// public static bool IsPressed() [static] :1035
...
// public static bool IsPressed(int pointIndex) [static] :1040
...
// public static bool IsSoftCaptured(int pointIndex, object capturerIdentity) [static] :1075
...
// private static void MarkAncestorHits(Fuse.Visual hitObject, Uno.Collections.List<Fuse.Input.Pointer.PELHolder> list) [static] :1330
...
// private static void ProcessPointerEnterLeave(Fuse.HitTestResult result, Fuse.Input.PointerEventData args) [static] :1306
...
// internal static bool RaiseMoved(Fuse.Visual root, Fuse.Input.PointerEventData data) [static] :1226
...
// internal static bool RaisePressed(Fuse.Visual root, Fuse.Input.PointerEventData data) [static] :1218
...
// internal static bool RaiseReleased(Fuse.Visual root, Fuse.Input.PointerEventData data) [static] :1234
...
// public static void ReleaseAllCaptures(object identity) [static] :1127
...
// public static void ReleaseHardCapture(int pointIndex) [static] :1210
...
// public static void ReleaseSoftCapture(int pointIndex, object identity) [static] :1111
...
// private static Fuse.Visual RoutePointerEvent(Fuse.Input.PointerEventData plainEvent, Fuse.Visual root) [static] :1260
...
// private static Fuse.Visual RouteToCapturer(Fuse.Input.PointerEventData args) [static] :1282
...
// private static Fuse.Visual RouteToHit(Fuse.Input.PointerEventData args, Fuse.Visual root) [static] :1290
...
// private static Fuse.Visual RouteToSoftCapturer(Fuse.Input.PointerEventData args) [static] :1274
...
// internal static bool SoftCapture(int pointIndex, Fuse.Visual softCapturer, object identity, Uno.Action lostCallback) [static] :1086
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Visual* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[13/*"SoftCapture...*/], 1, ::STRINGS[9/*"/usr/local/...*/], 1096);
        return false;
    }
...
// public static generated float2 get_Coord() [static] :1046
...
// private static generated void set_Coord(float2 value) [static] :1046
...
// public static Fuse.VisualEvent<Fuse.Input.PointerEnteredHandler, Fuse.Input.PointerEnteredArgs> get_Entered() [static] :974
...
// public static generated Fuse.Input.IPointerEventResponder get_EventResponder() [static] :957
...
// public static generated void set_EventResponder(Fuse.Input.IPointerEventResponder value) [static] :957
...
// public static Fuse.VisualEvent<Fuse.Input.PointerLeftHandler, Fuse.Input.PointerLeftArgs> get_Left() [static] :975
...
// public static Fuse.VisualEvent<Fuse.Input.PointerMovedHandler, Fuse.Input.PointerMovedArgs> get_Moved() [static] :972
...
// public static Fuse.VisualEvent<Fuse.Input.PointerPressedHandler, Fuse.Input.PointerPressedArgs> get_Pressed() [static] :971
...
// public static Fuse.VisualEvent<Fuse.Input.PointerReleasedHandler, Fuse.Input.PointerReleasedArgs> get_Released() [static] :973
...
// public static Fuse.VisualEvent<Fuse.Input.PointerWheelMovedHandler, Fuse.Input.PointerWheelMovedArgs> get_WheelMoved() [static] :976
...
// public generated PointerEntered() :864
void PointerEntered__ctor_1_fn(PointerEntered* __this)
{
    __this->ctor_1();
}

// protected override sealed void Invoke(Fuse.Input.PointerEnteredHandler handler, object sender, Fuse.Input.PointerEnteredArgs args) :866
...
// public generated PointerEntered New() :864
void PointerEntered__New1_fn(PointerEntered** __retval)
{
    *__retval = PointerEntered::New1();
}

// public generated PointerEntered() [instance] :864
void PointerEntered::ctor_1()
{
    ctor_();
}

// public generated PointerEntered New() [static] :864
...
// public sealed class PointerEnteredArgs :856
// {
...
// public PointerEnteredArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) :858
...
// public PointerEnteredArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) :858
...
// public PointerEnteredArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) [instance] :858
void PointerEnteredArgs::ctor_3(::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    ctor_2(data, visual);
}

// public PointerEnteredArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) [static] :858
...
// public delegate void PointerEnteredHandler(object sender, Fuse.Input.PointerEnteredArgs args) :862
...
// public generated PointerLeft() :884
void PointerLeft__ctor_1_fn(PointerLeft* __this)
{
    __this->ctor_1();
}

// protected override sealed void Invoke(Fuse.Input.PointerLeftHandler handler, object sender, Fuse.Input.PointerLeftArgs args) :886
void PointerLeft__Invoke_fn(PointerLeft* __this, uDelegate* handler, uObject* sender, ::g::Fuse::Input::PointerLeftArgs* args)
{
    uPtr(handler)->Invoke(2, sender, args);
}

// public generated PointerLeft New() :884
void PointerLeft__New1_fn(PointerLeft** __retval)
{
    *__retval = PointerLeft::New1();
}

// public generated PointerLeft() [instance] :884
void PointerLeft::ctor_1()
{
    ctor_();
}

// public generated PointerLeft New() [static] :884
...
// public sealed class PointerLeftArgs :875
// {
...
// public PointerLeftArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) :877
void PointerLeftArgs__ctor_3_fn(PointerLeftArgs* __this, ::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    __this->ctor_3(data, visual);
}

// public PointerLeftArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) :877
...
// public PointerLeftArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) [instance] :877
void PointerLeftArgs::ctor_3(::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    ctor_2(data, visual);
}

// public PointerLeftArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) [static] :877
...
// public delegate void PointerLeftHandler(object sender, Fuse.Input.PointerLeftArgs args) :882
...
// internal sealed class PointerMoved :825
// {
...
// public generated PointerMoved() :825
void PointerMoved__ctor_1_fn(PointerMoved* __this)
{
    __this->ctor_1();
}

// protected override sealed void Invoke(Fuse.Input.PointerMovedHandler handler, object sender, Fuse.Input.PointerMovedArgs args) :827
void PointerMoved__Invoke_fn(PointerMoved* __this, uDelegate* handler, uObject* sender, ::g::Fuse::Input::PointerMovedArgs* args)
{
    uPtr(handler)->Invoke(2, sender, args);
}

// public generated PointerMoved New() :825
void PointerMoved__New1_fn(PointerMoved** __retval)
{
    *__retval = PointerMoved::New1();
}

// public generated PointerMoved() [instance] :825
void PointerMoved::ctor_1()
{
    ctor_();
}

// public generated PointerMoved New() [static] :825
...
// public sealed class PointerMovedArgs :816
// {
...
// public PointerMovedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) :818
void PointerMovedArgs__ctor_3_fn(PointerMovedArgs* __this, ::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    __this->ctor_3(data, visual);
}

// public PointerMovedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) :818
...
// public PointerMovedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) [instance] :818
void PointerMovedArgs::ctor_3(::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    ctor_2(data, visual);
}

// public PointerMovedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) [static] :818
...
// public delegate void PointerMovedHandler(object sender, Fuse.Input.PointerMovedArgs args) :823
...
// internal sealed class PointerPressed :805
// {
...
// public generated PointerPressed() :805
void PointerPressed__ctor_1_fn(PointerPressed* __this)
{
    __this->ctor_1();
}

// protected override sealed void Invoke(Fuse.Input.PointerPressedHandler handler, object sender, Fuse.Input.PointerPressedArgs args) :807
...
// public generated PointerPressed New() :805
void PointerPressed__New1_fn(PointerPressed** __retval)
{
    *__retval = PointerPressed::New1();
}

// public generated PointerPressed() [instance] :805
void PointerPressed::ctor_1()
{
    ctor_();
}

// public generated PointerPressed New() [static] :805
...
// public PointerPressedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) :798
void PointerPressedArgs__ctor_3_fn(PointerPressedArgs* __this, ::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    __this->ctor_3(data, visual);
}

// public PointerPressedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) :798
...
// public PointerPressedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) [instance] :798
void PointerPressedArgs::ctor_3(::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    ctor_2(data, visual);
}

// public PointerPressedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) [static] :798
...
// public delegate void PointerPressedHandler(object sender, Fuse.Input.PointerPressedArgs args) :803
...
// internal sealed class PointerReleased :845
// {
...
// public generated PointerReleased() :845
void PointerReleased__ctor_1_fn(PointerReleased* __this)
{
    __this->ctor_1();
}

// protected override sealed void Invoke(Fuse.Input.PointerReleasedHandler handler, object sender, Fuse.Input.PointerReleasedArgs args) :847
...
// public generated PointerReleased New() :845
void PointerReleased__New1_fn(PointerReleased** __retval)
{
    *__retval = PointerReleased::New1();
}

// public generated PointerReleased() [instance] :845
void PointerReleased::ctor_1()
{
    ctor_();
}

// public generated PointerReleased New() [static] :845
...
// public sealed class PointerReleasedArgs :836
// {
...
// public PointerReleasedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) :838
void PointerReleasedArgs__ctor_3_fn(PointerReleasedArgs* __this, ::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    __this->ctor_3(data, visual);
}

// public PointerReleasedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) :838
...
// public PointerReleasedArgs(Fuse.Input.PointerEventData data, Fuse.Visual visual) [instance] :838
void PointerReleasedArgs::ctor_3(::g::Fuse::Input::PointerEventData* data, ::g::Fuse::Visual* visual)
{
    ctor_2(data, visual);
}

// public PointerReleasedArgs New(Fuse.Input.PointerEventData data, Fuse.Visual visual) [static] :838
...
// public delegate void PointerReleasedHandler(object sender, Fuse.Input.PointerReleasedArgs args) :843
...
// internal sealed class PointerWheelMoved :904
// {
...
// public generated PointerWheelMoved() :904
void PointerWheelMoved__ctor_1_fn(PointerWheelMoved* __this)
{
    __this->ctor_1();
}

// protected override sealed void Invoke(Fuse.Input.PointerWheelMovedHandler handler, object sender, Fuse.Input.PointerWheelMovedArgs args) :906
...
// public generated PointerWheelMoved New() :904
void PointerWheelMoved__New1_fn(PointerWheelMoved** __retval)
{
    *__retval = PointerWheelMoved::New1();
}

// public generated PointerWheelMoved() [instance] :904
void PointerWheelMoved::ctor_1()
{
    ctor_();
}

// public generated PointerWheelMoved New() [static] :904
...
// public delegate void PointerWheelMovedHandler(object sender, Fuse.Input.PointerWheelMovedArgs args) :902
