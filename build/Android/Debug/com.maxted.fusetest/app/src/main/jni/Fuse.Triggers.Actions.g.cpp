...
// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :790
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/0.38.6/$.uno");
    ::STRINGS[5] = uString::Const("Perform");
    ::TYPES[13] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[14] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[15] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[17] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    type->SetFields(8,
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/0.38.6/$.uno");
    ::STRINGS[5] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    ::g::Fuse::Controls::Navigator* nav = (n == NULL) ? uCast< ::g::Fuse::Controls::Navigator*>(NULL, ::TYPES[18/*Fuse.Controls.Navigator*/]) : uAs< ::g::Fuse::Controls::Navigator*>(uPtr(n)->Parent(), ::TYPES[18/*Fuse.Controls.Navigator*/]);

    if ((v == NULL) || (nav == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Requires a ...*/], __this, ::STRINGS[7/*"/usr/local/...*/], 283, ::STRINGS[5/*"Perform"*/]);
        return;
    }
...
{
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[22] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Controls::WebView_typeof());
    type->SetFields(8);
}
