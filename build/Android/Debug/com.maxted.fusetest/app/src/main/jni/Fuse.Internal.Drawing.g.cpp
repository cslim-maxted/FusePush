...
void SolidRectangle::DrawElement(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* element, ::g::Fuse::Drawing::Brush* brush, float opacity)
{
    ...
    if (uIs(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))
    {
        ...
        ::g::Uno::Graphics::Texture2D* Texture_77a0ae88_14_6_9 = uPtr(uAs< ::g::Fuse::Drawing::ImageFill*>(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->GetTexture();
        ::g::Fuse::Drawing::ImageFill__DrawParams DP_77a0ae88_14_5_12 = uPtr(uAs< ::g::Fuse::Drawing::ImageFill*>(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->GetDrawParams(dc, element->ActualSize());
        ...
        _draw_77a0ae88.Const(0, Texture_77a0ae88_14_6_9 == NULL);
        _draw_77a0ae88.Use();
        _draw_77a0ae88.Attrib1(1, 2, DrawElement_VertexData_77a0ae88_7_2_1, 8, 0);
        _draw_77a0ae88.Uniform12(2, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[1/*Fuse.IRenderViewport*/])));
        _draw_77a0ae88.Uniform2(3, uPtr(element)->ActualSize());
        _draw_77a0ae88.Uniform2(4, DP_77a0ae88_14_5_12.Origin);
        _draw_77a0ae88.Uniform2(5, DP_77a0ae88_14_5_12.Size);
        _draw_77a0ae88.Uniform2(6, ::g::Uno::Float2__op_Subtraction2((ind1 = DP_77a0ae88_14_5_12.UVClip, ::g::Uno::Float2__New2(ind1.Z, ind1.W)), (ind2 = DP_77a0ae88_14_5_12.UVClip, ::g::Uno::Float2__New2(ind2.X, ind2.Y))));
        _draw_77a0ae88.Uniform2(7, (ind3 = DP_77a0ae88_14_5_12.UVClip, ::g::Uno::Float2__New2(ind3.X, ind3.Y)));
        _draw_77a0ae88.Uniform10(8, uPtr(uAs< ::g::Fuse::Drawing::ImageFill*>(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->Color());
        _draw_77a0ae88.Uniform(9, uPtr(uAs< ::g::Fuse::Drawing::ImageFill*>(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->Opacity());
        _draw_77a0ae88.Uniform(10, opacity);
        _draw_77a0ae88.Uniform12(11, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_77a0ae88_4_9_5, element->WorldTransform()) : LocalTransform_77a0ae88_4_9_5);
        _draw_77a0ae88.Sampler2(12, Texture_77a0ae88_14_6_9);
