...
// /usr/local/share/uno/Packages/Fuse.Drawing/0.38.6/$.uno
// -------------------------------------------------------
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/0.38.6/$.uno");
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.38.6/drawing/$.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Drawing/0.38.6/brushes/$.uno
// ---------------------------------------------------------------
...
static void LinearGradientDrawable_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Float2_typeof()->Array(), offsetof(::g::Fuse::Drawing::LinearGradientDrawable, FillBuffer_Vertices_ae3a1d65_1_0_9), 0,
