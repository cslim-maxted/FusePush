...
jint JNICALL callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet273(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
    JTRY
        int __result=::g::Fuse::PushNotifications::AndroidImpl::PLAY_SERVICES_RESOLUTION_REQUEST();
...
jobject JNICALL callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet277(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
    JTRY
        uString* __result=::g::Fuse::PushNotifications::AndroidImpl::_senderID();
...
void JNICALL callUno_Fuse_App_OnFrameCallback287(JNIEnv *env,jclass clazz,jobject jthis,jdouble currentTime,jdouble deltaTime)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError279(JNIEnv *env,jclass clazz,jobject message)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_message = JniHelper::JavaToUnoString((jstring)message);
    JTRY
        ::g::Fuse::PushNotifications::AndroidImpl::getRegistrationIdError(uCast<uString*>(uno_message, ::g::Uno::String_typeof()));
    JCATCH
}
void JNICALL callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess278(JNIEnv *env,jclass clazz,jobject regid)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_regid = JniHelper::JavaToUnoString((jstring)regid);
    JTRY
        ::g::Fuse::PushNotifications::AndroidImpl::getRegistrationIdSuccess(uCast<uString*>(uno_regid, ::g::Uno::String_typeof()));
    JCATCH
}
void JNICALL callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve276(JNIEnv *env,jclass clazz,jobject bundle,jlong bundlePtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_bundle = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(bundle, true);
    JTRY
        ::g::Fuse::PushNotifications::AndroidImpl::OnRecieve(uCast<::g::Java::Object*>(uno_bundle, ::g::Java::Object_typeof()));
    JCATCH
}
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet273", (char* const)"()I", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_PLAY_SERVICES_RESOLUTION_REQUESTGet273},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve276", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_OnRecieve276},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet277", (char* const)"()Ljava/lang/String;", (void *)&callUno_Fuse_PushNotifications_AndroidImpl__senderIDGet277},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess278", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdSuccess278},
    {(char* const)"callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError279", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_PushNotifications_AndroidImpl_getRegistrationIdError279},
    {(char* const)"callUno_Fuse_App_OnFrameCallback287", (char* const)"(Ljava/lang/Object;DD)V", (void *)&callUno_Fuse_App_OnFrameCallback287},
    };
    int funcCount = 80;
