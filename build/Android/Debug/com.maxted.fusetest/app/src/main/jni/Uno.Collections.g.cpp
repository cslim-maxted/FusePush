...
// /usr/local/share/uno/Packages/UnoCore/0.38.2/source/uno/collections/$.uno
// -------------------------------------------------------------------------
...
{
    uType* __types[] = {
        __type->Precalced(4/*Uno.Collections.Dictionary<TKey, TValue>.ValueCollection*/),
    };
...
// /usr/local/share/uno/Packages/Uno.Collections/0.38.0/extensions/$.uno
// ---------------------------------------------------------------------
...
static void EnumerableExtensions_build(uType* type)
{
    ...
    ::TYPES[12] = EnumerableExtensions__LinkedList_typeof();
    ::TYPES[0] = uObject_typeof()->Array();
    ::TYPES[13] = ::g::Uno::Collections::List_typeof();
    ::TYPES[14] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    type->SetPrecalc(
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::OfTypeEnumerable_typeof()->MakeType(type->U(0), type->U(1)),
        EnumerableExtensions_typeof()->MakeMethod(1, type->U(0)),
        ::g::Uno::Comparison_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::OrderByCompare_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::SelectEnumerable_typeof()->MakeType(type->U(0), type->U(1)),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(type->U(0)),
        EnumerableExtensions__LinkedList_typeof()->MakeType(type->U(0)),
        type->U(0)->Array(),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(type->U(0)),
        EnumerableExtensions__LinkedList_typeof()->MakeType(type->U(0)),
...
void EnumerableExtensions__IndexOf_fn(uType* __type, uObject* self, void* element, int* __retval)
{
    uType* __types[] = {
        __type->U(0),
        __type->Precalced(4/*Uno.Collections.IEnumerable<T>*/),
...
{
    uType* __types[] = {
        __type->Precalced(6/*Uno.Collections.OfTypeEnumerable<T, U>*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(7/*Uno.Collections.EnumerableExtensions.ToList<T>*/),
        __type->Precalced(8/*Uno.Comparison<T>*/),
        __type->Precalced(9/*Uno.Collections.OrderByCompare<T>*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(10/*Uno.Collections.SelectEnumerable<T, TRet>*/),
    };
...
uArray* EnumerableExtensions::ToArray(uType* __type, uObject* self)
{
    uType* __types[] = {
        __type->U(0),
        __type->Precalced(11/*Uno.Collections.IEnumerable<T>*/),
        __type->Precalced(12/*Uno.Collections.IEnumerator<T>*/),
        __type->Precalced(13/*Uno.Collections.EnumerableExtensions.LinkedList<T>*/),
        __type->Precalced(14/*T[]*/),
    };
...
::g::Uno::Collections::List* EnumerableExtensions::ToList(uType* __type, uObject* self)
{
    uType* __types[] = {
        __type->U(0),
        __type->Precalced(15/*Uno.Collections.IEnumerable<T>*/),
        __type->Precalced(16/*Uno.Collections.IEnumerator<T>*/),
        __type->Precalced(17/*Uno.Collections.EnumerableExtensions.LinkedList<T>*/),
        __type->Precalced(18/*Uno.Collections.List<T>*/),
        __type->Precalced(19/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<T>*/),
        __type->Precalced(20/*T[]*/),
    };
...
static void HashSet__Enumerator_build(uType* type)
{
    ...
    ::TYPES[15] = ::g::Uno::Collections::Dictionary__Bucket_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[16] = ::g::Uno::Collections::Dictionary_typeof();
    ::TYPES[17] = HashSet__Enumerator_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[18] = ::g::Uno::Collections::ICollection_typeof();
    ::TYPES[19] = ::g::Uno::Collections::IList_typeof();
    type->SetPrecalc(
        ::g::Uno::Collections::ICollection_typeof()->MakeType(type->U(0)),
        ::g::Uno::Collections::IList_typeof()->MakeType(type->U(0)));
}
...
static void LinkedList_build(uType* type)
{
    ...
    ::TYPES[20] = ::g::Uno::Collections::LinkedListNode_typeof();
    ::TYPES[21] = LinkedList__Enumerator_typeof();
    type->SetPrecalc(
...
{
    uType* __types[] = {
        __type->Precalced(1/*Uno.Collections.LinkedList<T>.Enumerator*/),
    };
...
static void List_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Uno::Collections::IEnumerator1_typeof();
    ::TYPES[1] = ::g::Uno::Generic_typeof();
    ::TYPES[22] = List__Enumerator_typeof();
    ::TYPES[23] = ::g::Uno::Array_typeof();
    type->SetPrecalc(
        type->T(0)->Array(),
...
// /usr/local/share/uno/Packages/Uno.Collections/0.38.0/$.uno
// ----------------------------------------------------------
...
static void ObservableList_build(uType* type)
{
    ...
    ::TYPES[13] = ::g::Uno::Collections::List_typeof();
    ::TYPES[22] = ::g::Uno::Collections::List__Enumerator_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[24] = ::g::Uno::Collections::OfTypeEnumerator_typeof();
    ::TYPES[5] = ::g::Uno::Collections::IEnumerable_typeof();
    type->SetPrecalc(
...
static void Queue_build(uType* type)
{
    ...
    ::TYPES[0] = uObject_typeof()->Array();
    ::TYPES[25] = Queue__Enumerator_typeof();
    type->SetPrecalc(
        type->T(0)->Array(),
...
{
    ::TYPES[26] = ::g::Uno::Collections::SelectEnumerator_typeof();
    ::TYPES[5] = ::g::Uno::Collections::IEnumerable_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[27] = Dictionary__ValueCollection__Enumerator_typeof();
    type->SetPrecalc(
