...
set -e
cd "`dirname "$0"`/com.maxted.fusetest/app/src/main"

##if #(JDK.Directory:IsSet)
export JAVA_HOME="/Library/Java/JavaVirtualMachines/jdk1.7.0_25.jdk/Contents/Home"
##endif
export SUPPORT_JAR="/Users/cslim/Library/Application Support/Fusetools/Fuse/Android/AndroidSDK/extras/android/support/v4/android-support-v4.jar"

##if #(Ant.Directory:IsSet)
PATH="/Users/cslim/Library/Application Support/Fusetools/Fuse/Android/Ant/bin:$PATH"
##endif

echo "## 1/2: libcommaxtedfusetest.so"
...
echo ""
echo "## 2/2: com.maxted.fusetest.apk"
...
cd "`dirname "$0"`"
ln -sf com.maxted.fusetest/app/src/main/bin/com.maxted.fusetest-debug.apk com.maxted.fusetest.apk
